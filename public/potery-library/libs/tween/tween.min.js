    ...
    (this.to = function (n, t) {
        ...
        (this.update = function (n) {
            ...
            for (f in i) {
                ...
                N instanceof Array
                    ? (t[f] = p(N, O))
                    : ('string' == typeof N && (N = m + parseFloat(N, 10)),
            ...
            In: function (n) {
                ...
                return 0 === n
                    ...
                    : 1 === n
                      ...
                      : (!r || 1 > r
                            ? ((r = 1), (t = i / 4))
                            : (t = (i * Math.asin(1 / r)) / (2 * Math.PI)),
                        -(
                            r *
                            Math.pow(2, 10 * (n -= 1)) *
                            Math.sin((2 * (n - t) * Math.PI) / i)
                        ));
            },
            Out: function (n) {
                var t,
    ...
    (TWEEN.Interpolation = {
        ...
        CatmullRom: function (n, t) {
            ...
            return n[0] === n[r]
                ...
                : 0 > t
                  ? n[0] - (o(n[0], n[0], n[1], n[1], -i) - n[0])
                  : t > 1
                    ? n[r] - (o(n[r], n[r], n[r - 1], n[r - 1], i - r) - n[r])
                    : o(
                          n[u ? u - 1 : 0],
                          n[u],
                          n[u + 1 > r ? r : u + 1],
