    ...
    function paletteTemplate(p, color, className, opts) {
        ...
        for (var i = 0; i < p.length; i++) {
            ...
            if (current) {
                ...
                var formattedString = tiny.toString(
                    opts.preferredFormat || 'rgb',
                );
        ...
        function initialize() {
            ...
            toggleButton.on('click.spectrum', function (e) {
                ...
                if (!opts.showPaletteOnly && !flat) {
                    container.css(
                        'left',
                        '-=' + (pickerContainer.outerWidth(true) + 5),
                    );
                }
                applyOptions();
            });
            ...
            draggable(
                ...
                function (dragX, dragY, e) {
                    ...
                    var setSaturation =
                        ...
                        shiftMovementDirection === 'x';
                    var setValue =
                        !shiftMovementDirection ||
                        shiftMovementDirection === 'y';
        ...
        function updateHelperLocations() {
            ...
            if (allowEmpty && isEmpty) {
                ...
                dragX = Math.max(
                    -dragHelperHeight,
                    Math.min(
                        dragWidth - dragHelperHeight,
                        dragX - dragHelperHeight,
                    ),
                );
                dragY = Math.max(
                    -dragHelperHeight,
                    Math.min(
                        dragHeight - dragHelperHeight,
                        dragY - dragHelperHeight,
                    ),
                );
                dragHelper.css({
                    top: dragY + 'px',
    ...
    function draggable(element, onmove, onstart, onstop) {
        ...
        function move(e) {
            if (dragging) {
                ...
                var dragX = Math.max(
                    0,
                    Math.min(pageX - offset.left, maxWidth),
                );
                var dragY = Math.max(
                    0,
                    Math.min(pageY - offset.top, maxHeight),
                );
    ...
    (function () {
        ...
        tinycolor.mostReadable = function (baseColor, colorList) {
            ...
            for (var i = 0; i < colorList.length; i++) {
                ...
                var readability = tinycolor.readability(
                    baseColor,
                    colorList[i],
                );
                var readable =
