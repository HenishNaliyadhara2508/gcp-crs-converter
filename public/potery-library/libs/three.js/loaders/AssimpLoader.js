    ...
    parse: function (buffer, path) {
        ...
        Virtulous.KeyFrameTrack = function () {
            ...
            this.setTime = function (time) {
                ...
                for (
                    var i = this.keySearchAccel(time);
                    i < this.keys.length;
                    i++
                ) {
        ...
        function aiMesh() {
            ...
            this.hookupSkeletons = function (scene) {
                ...
                for (var i = 0; i < this.mBones.length; i++) {
                    ...
                    if (bone) {
                        ...
                        offsetMatrix.push(
                            this.mBones[i].mOffsetMatrix.toTHREE(),
                        );
                    } else {
            ...
            this.toTHREE = function (scene) {
                ...
                if (
                    this.mTexCoordsBuffers[0] &&
                    this.mTexCoordsBuffers[0].length > 0
                )
                    geometry.setAttribute(
                        'uv',
                        new BufferAttribute(
                ...
                if (
                    this.mTexCoordsBuffers[1] &&
                    this.mTexCoordsBuffers[1].length > 0
                )
                    geometry.setAttribute(
                        'uv1',
                        new BufferAttribute(
                ...
                if (this.mBones.length > 0) {
                    ...
                    for (var i = 0; i < this.mBones.length; i++) {
                        for (
                            var j = 0;
                            j < this.mBones[i].mWeights.length;
                            j++
                        ) {
        ...
        function aiNodeAnim() {
            ...
            this.toTHREE = function (o) {
                ...
                if (o.nodeToBoneMap[this.mNodeName]) {
                    for (
                        var i = 0;
                        i < o.nodeToBoneMap[this.mNodeName].length;
                        i++
                    ) {
                        var t2 = track.clone();
