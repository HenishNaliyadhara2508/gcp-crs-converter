...
TDSLoader.prototype = Object.assign(Object.create(Loader.prototype), {
        ...
        if (
            ...
            while (next !== 0) {
                if (next === M3D_VERSION) {
                    ...
                    this.debugMessage(
                        'Unknown main chunk: ' + next.toString(16),
                    );
                }
    ...
    readNamedObject: function (data) {
        ...
        while (next !== 0) {
            if (next === N_TRI_OBJECT) {
                ...
                this.debugMessage(
                    'Unknown named object chunk: ' + next.toString(16),
                );
            }
    ...
    readMaterialEntry: function (data, path) {
        ...
        while (next !== 0) {
            if (next === MAT_NAME) {
                ...
                this.debugMessage(
                    '   Unknown material chunk: ' + next.toString(16),
                );
            }
    ...
    readMesh: function (data) {
        ...
        while (next !== 0) {
            if (next === POINT_ARRAY) {
                ...
                this.debugMessage(
                    '   Unknown mesh chunk: ' + next.toString(16),
                );
            }
    ...
    readMap: function (data, path) {
        ...
        while (next !== 0) {
            if (next === MAT_MAPNAME) {
                ...
                this.debugMessage(
                    '      Unknown map chunk: ' + next.toString(16),
                );
            }
    ...
    readColor: function (data) {
        ...
        if (chunk.id === COLOR_24 || chunk.id === LIN_COLOR_24) {
            ...
            this.debugMessage(
                '      Unknown color chunk: ' + chunk.toString(16),
            );
        }
