    ...
    parse: function (data) {
        ...
        function loadDocument(data) {
            ...
            for (var i = 0; i < modelPartNames.length; i++) {
                ...
                if (
                    xmlData.documentElement.nodeName.toLowerCase() !== 'model'
                ) {
                    console.error(
        ...
        function parseTextures2DGroupNode(texture2DGroupNode) {
            ...
            var tex2coordNodes =
                texture2DGroupNode.querySelectorAll('tex2coord');
        ...
        function parseMetallicDisplaypropertiesNode(
            ...
            for (var i = 0; i < metallicNodes.length; i++) {
                ...
                metallicData.push({
                    ...
                    metallicness: parseFloat(
                        metallicNode.getAttribute('metallicness'),
                    ), // required
                    roughness: parseFloat(
                        metallicNode.getAttribute('roughness'),
                    ), // required
                });
            }
        ...
        function parseBasematerialNode(basematerialNode) {
            ...
            basematerialData['displaypropertiesid'] =
                basematerialNode.getAttribute('displaypropertiesid');
        ...
        function parseResourcesNode(resourcesNode) {
            ...
            var basematerialsNodes =
                resourcesNode.querySelectorAll('basematerials');

            for (var i = 0; i < basematerialsNodes.length; i++) {
                var basematerialsNode = basematerialsNodes[i];
                var basematerialsData =
                    parseBasematerialsNode(basematerialsNode);
            ...
            for (var i = 0; i < colorGroupNodes.length; i++) {
                ...
                resourcesData['colorgroup'][colorGroupData['id']] =
                    colorGroupData;
            }
            ...
            var pbmetallicdisplaypropertiesNodes =
                resourcesNode.querySelectorAll('pbmetallicdisplayproperties');
            ...
            for (var i = 0; i < textures2DGroupNodes.length; i++) {
                ...
                var textures2DGroupData =
                    parseTextures2DGroupNode(textures2DGroupNode);
        ...
        function buildBasematerialsMeshes(
            ...
            for (var i = 0, l = keys.length; i < l; i++) {
                ...
                var basematerialData =
                    basematerials.basematerials[materialIndex];
                ...
                for (
                    var j = 0, jl = trianglePropertiesProps.length;
                    j < jl;
                    j++
                ) {
        ...
        function buildVertexColorMesh(
            ...
            for (var i = 0, l = triangleProperties.length; i < l; i++) {
                ...
                var p1 =
                    triangleProperty.p1 !== undefined
                        ...
                        : objectData.pindex;
                var p2 =
                    triangleProperty.p2 !== undefined
                        ? triangleProperty.p2
                        : p1;
                var p3 =
                    triangleProperty.p3 !== undefined
                        ? triangleProperty.p3
                        : p1;
            ...
            geometry.setAttribute(
                'color',
                new Float32BufferAttribute(colorData, 3),
            );
        ...
        function buildMeshes(
            ...
            for (var i = 0, il = keys.length; i < il; i++) {
                ...
                switch (resourceType) {
                    case 'material':
                        var basematerials =
                            modelData.resources.basematerials[resourceId];
                    ...
                    case 'vertexColors':
                        var colorgroup =
                            modelData.resources.colorgroup[resourceId];
                        meshes.push(
                    ...
                    default:
                        console.error(
                            'THREE.3MFLoader: Unsupported resource type.',
                        );
                }
            }
        ...
        function buildBasematerial(materialData, objects, modelData) {
            ...
            if (
                ...
                var metallicData =
                    pbmetallicdisplayproperty.data[materialData.index];
            ...
            if (displaycolor.length === 9) {
                material.opacity =
                    parseInt(
                        displaycolor.charAt(7) + displaycolor.charAt(8),
                        16,
                    ) / 255;
            }
            ...
            if (modelRels) {
                for (var i = 0, l = modelRels.length; i < l; i++) {
                    ...
                    if (data3mf.texture[textureKey]) {
                        textureData[modelRel.target] =
                            data3mf.texture[textureKey];
                    }
                }
            }
