    ...
    VRMLLoader.prototype = Object.assign(Object.create(Loader.prototype), {
        ...
        parse: function (data, path) {
            ...
            function createVisitor(BaseVRMLVisitor) {
                ...
                function processField(scope, ctx) {
                    ...
                    if (ctx.StringLiteral) {
                        ...
                        for (
                            var i = 0, l = ctx.StringLiteral.length;
                            i < l;
                            i++
                        ) {
                    ...
                    if (ctx.NumberLiteral) {
                        ...
                        for (
                            var i = 0, l = ctx.NumberLiteral.length;
                            i < l;
                            i++
                        ) {
                    ...
                    if (ctx.TrueLiteral) {
                        ...
                        for (
                            var i = 0, l = ctx.TrueLiteral.length;
                            i < l;
                            i++
                        ) {
                    ...
                    if (ctx.FalseLiteral) {
                        ...
                        for (
                            var i = 0, l = ctx.FalseLiteral.length;
                            i < l;
                            i++
                        ) {
                ...
                for (var i = 0, l = fields.length; i < l; i++) {
                    ...
                    switch (fieldName) {
                        case 'image':
                            ...
                            var useAlpha =
                                num_components === 2 || num_components === 4;
                            var textureType = getTextureType(num_components);

                            var size =
                                (useAlpha === true ? 4 : 3) * (width * height);
            ...
            function buildIndexedFaceSetNode(node) {
                ...
                var triangulatedCoordIndex = triangulateFaceIndex(
                    coordIndex,
                    ccw,
                );
                ...
                if (color) {
                    if (colorPerVertex === true) {
                        ...
                        if (colorIndex && colorIndex.length > 0) {
                            ...
                            var flattenFaceColors = flattenData(
                                color,
                                colorIndex,
                            );
                ...
                if (normal) {
                    if (normalPerVertex === true) {
                        ...
                        if (normalIndex && normalIndex.length > 0) {
                            ...
                            var flattenFaceNormals = flattenData(
                                normal,
                                normalIndex,
                            );
                ...
                if (color) {
                    if (colorPerVertex === true) {
                        ...
                        if (colorIndex.length > 0) {
                            ...
                            var flattenLineColors = flattenData(
                                color,
                                colorIndex,
            ...
            function buildConeNode(node) {
                ...
                var geometry = new ConeBufferGeometry(
                    radius,
                    height,
                    16,
                    1,
            ...
            function buildExtrusionNode(node) {
                ...
                if (beginCap === true || endCap === true) {
                    ...
                    for (var i = 0, l = crossSection.length; i < l; i += 2) {
                        contour.push(
                            new Vector2(crossSection[i], crossSection[i + 1]),
                        );
                    }
