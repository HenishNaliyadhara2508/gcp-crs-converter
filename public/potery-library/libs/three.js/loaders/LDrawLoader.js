            ...
            while (i < queue.length) {
                ...
                for (var i2 = 0, l2 = 3; i2 < l2; i2++) {
                    ...
                    if (otherTri) {
                        ...
                        if (
                            Math.abs(otherTri.faceNormal.dot(tri.faceNormal)) <
                            0.25
                        ) {
                            continue;
                        }
    ...
    LDrawLoader.prototype = Object.assign(Object.create(Loader.prototype), {
        ...
        newParseScopeLevel: function (materials) {
            ...
            var newParseScope = {
                ...
                mainColourCode: topParseScope
                    ? topParseScope.mainColourCode
                    : '16',
                ...
                switch (lineType) {
                    ...
                    case '0':
                        ...
                        if (meta) {
                            switch (meta) {
                                ...
                                case '!COLOUR':
                                    var material =
                                        this.parseColourMetaDirective(lp);
                                    if (material) {
                    ...
                    case '1':
                        ...
                        subobjects.push({
                            ...
                            inverted:
                                bfcInverted !== currentParseScope.inverted,
                    ...
                    case '5':
                        ...
                        var segment = {
                            material:
                                material.userData.edgeMaterial.userData
        ...
        processObject: function (text, onProcessed, subobject, url) {
            ...
            function finalizeObject() {
                if (scope.smoothNormals && parseScope.type === 'Part') {
                    smoothNormals(
                        parseScope.triangles,
                        parseScope.lineSegments,
                    );
                }
                ...
                if (
                    (scope.separateObjects &&
                        !isPrimitiveType(parseScope.type)) ||
                    isRoot
                ) {
                    ...
                    if (parseScope.conditionalSegments.length > 0) {
                        objGroup.add(
                            createObject(
                                parseScope.conditionalSegments,
                                2,
                                true,
                            ),
                        );
                    ...
                    var parentConditionalSegments =
                        parentParseScope.conditionalSegments;
                    ...
                    for (
                        var i = 0, l = conditionalSegments.length;
                        i < l;
                        i++
                    ) {
                    ...
                    for (var i = 0, l = triangles.length; i < l; i++) {
                        ...
                        if (separateObjects) {
                            tri.v0 = tri.v0
                                .clone()
                                .applyMatrix4(parseScope.matrix);
                            tri.v1 = tri.v1
                                .clone()
                                .applyMatrix4(parseScope.matrix);
                            tri.v2 = tri.v2
            ...
            function loadSubobject(subobject) {
                ...
                var cached =
                    scope.subobjectCache[
                        subobject.originalFileName.toLowerCase()
                    ];
                if (cached) {
                    scope.processObject(
                        cached,
                ...
                switch (subobject.locationState) {
                    ...
                    case LDrawLoader.FILE_LOCATION_TRY_ABSOLUTE:
                        if (subobject.triedLowerCase) {
                            // Try absolute path
                            newLocationState =
                                LDrawLoader.FILE_LOCATION_NOT_FOUND;
                        } else {
                            // Next attempt is lower case
                            subobject.fileName =
                                subobject.fileName.toLowerCase();
