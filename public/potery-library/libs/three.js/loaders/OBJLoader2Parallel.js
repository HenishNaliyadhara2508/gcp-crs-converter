    ...
    Object.create(OBJLoader2.prototype),
    {
        ...
        buildWorkerCode: function () {
            ...
            if (codeBuilderInstructions.isSupportsStandardWorker()) {
                ...
                const defaultWorkerPayloadHandler =
                    new DefaultWorkerPayloadHandler(this.parser);
        ...
        load: function (
            ...
            function interceptOnLoad(object3d, message) {
                if (object3d.name === 'OBJLoader2ParallelDummy') {
                    if (
                        scope.parser.logging.enabled &&
                        scope.parser.logging.debug
                    ) {
                        console.debug(
        ...
        parse: function (content) {
            if (this.executeParallel) {
                ...
                if (
                    !this.workerExecutionSupport.isWorkerLoaded(
                        this.preferJsmWorker,
                    )
                ) {
                    this.workerExecutionSupport.buildWorker(
                ...
                this.workerExecutionSupport.executeParallel({
                    params: {
                        ...
                        materialPerSmoothingGroup:
                            this.parser.materialPerSmoothingGroup,
