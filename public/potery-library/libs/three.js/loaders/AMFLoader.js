    ...
    parse: function (data) {
        function loadDocument(data) {
            ...
            if (magic === 'PK') {
                ...
                console.log(
                    'THREE.AMFLoader: Trying to load file asset: ' + file,
                );
        ...
        function loadMeshVolume(node) {
            ...
            while (currVolumeNode) {
                if (currVolumeNode.nodeName === 'metadata') {
                    ...
                    var v1 =
                        currVolumeNode.getElementsByTagName('v1')[0]
                            .textContent;
                    var v2 =
                        currVolumeNode.getElementsByTagName('v2')[0]
                            .textContent;
                    var v3 =
                        currVolumeNode.getElementsByTagName('v3')[0]
                            .textContent;
                ...
                if (currObjNode.nodeName === 'metadata') {
                    ...
                    while (currMeshNode) {
                        if (currMeshNode.nodeName === 'vertices') {
                            ...
                            mesh.normals = mesh.normals.concat(
                                loadedVertices.normals,
                            );
        ...
        for (var id in amfObjects) {
            ...
            for (i = 0; i < meshes.length; i++) {
                ...
                if (mesh.color) {
                    ...
                    objDefaultMaterial.color = new Color(
                        color.r,
                        color.g,
                        color.b,
                    );
