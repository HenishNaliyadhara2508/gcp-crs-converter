                ...
                function (require, module, exports) {
                    ...
                    function tinf_uncompress(e, t) {
                        ...
                        do {
                            switch (
                                ((n = tinf_getbit(i)),
                                (r = tinf_read_bits(i, 2, 0)))
                            ) {
                                case 0:
                                    s = tinf_inflate_uncompressed_block(i);
                                    break;
                                case 1:
                                    s = tinf_inflate_block_data(
                                        i,
                                        sltree,
                                        sdtree,
                                    );
                ...
                function (require, module, exports) {
                        ...
                        for (s = 0; s < e.glyphs.length; s += 1)
                            (l = e.glyphs.get(s)),
                                e.cffEncoding
                                    ...
                                    : e.glyphNames.names &&
                                      (l.name =
                                          e.glyphNames.glyphIndexToName(s));
                    }
                    ...
                    (DefaultEncoding.prototype.charToGlyphIndex = function (e) {
                        ...
                        (CmapEncoding.prototype.charToGlyphIndex = function (
                            ...
                            return (
                                this.cmap.glyphIndexMap[e.charCodeAt(0)] || 0
                            );
                        }),
                ...
                function (require, module, exports) {
                    ...
                    function Font(e) {
                        (e = e || {}),
                            ...
                            (this.encoding = new encoding.DefaultEncoding(
                                this,
                            )),
                ...
                function (require, module, exports) {
                    ...
                    (Glyph.prototype.bindConstructorValues = function (t) {
                        (this.index = t.index || 0),
                            ...
                            t.advanceWidth &&
                                (this.advanceWidth = t.advanceWidth),
                        ...
                        (Glyph.prototype.drawPoints = function (t, i, e, n) {
                            ...
                            for (
                                ...
                                void 0 !== y.x && o.push({ x: y.x, y: -y.y }),
                                    void 0 !== y.x1 &&
                                        r.push({ x: y.x1, y: -y.y1 }),
                                    void 0 !== y.x2 &&
                                        r.push({ x: y.x2, y: -y.y2 });
                            }
                            (t.fillStyle = 'blue'),
                                a(o, i, e, h),
                                (t.fillStyle = 'red'),
                ...
                function (require, module, exports) {
                    ...
                    function parseBuffer(e) {
                        ...
                        if (p === String.fromCharCode(0, 1, 0, 0))
                            ...
                            if ('wOFF' !== p)
                                throw new Error(
                                    'Unsupported OpenType signature ' + p,
                                );
                            ...
                            if (l === String.fromCharCode(0, 1, 0, 0))
                                ...
                                if ('OTTO' !== l)
                                    throw new Error(
                                        'Unsupported OpenType flavor ' + p,
                                    );
                                t.outlinesFormat = 'cff';
                            }
                            (s = parse.getUShort(n, 12)),
                                (o = parseWOFFTableEntries(n, s));
                        }
                        for (
                            var f, u, i, c, b, m, d, g, h, T, y = 0;
                            s > y;
                            y += 1
                        ) {
                            var v,
                            ...
                            switch (F.tag) {
                                case 'cmap':
                                    (v = uncompressTable(n, F)),
                                        (t.tables.cmap = cmap.parse(
                                            v.data,
                                            v.offset,
                                        )),
                                        (t.encoding = new encoding.CmapEncoding(
                                            t.tables.cmap,
                                        ));
                                    break;
                                case 'fvar':
                                ...
                                case 'head':
                                    (v = uncompressTable(n, F)),
                                        (t.tables.head = head.parse(
                                            v.data,
                                            v.offset,
                                        )),
                                        (t.unitsPerEm =
                                            t.tables.head.unitsPerEm),
                                        (a = t.tables.head.indexToLocFormat);
                                    break;
                                case 'hhea':
                                    (v = uncompressTable(n, F)),
                                        (t.tables.hhea = hhea.parse(
                                            v.data,
                                            v.offset,
                                        )),
                                        ...
                                        (t.numberOfHMetrics =
                                            t.tables.hhea.numberOfHMetrics);
                                    break;
                                case 'hmtx':
                                    m = F;
                                    break;
                                ...
                                case 'post':
                                    (v = uncompressTable(n, F)),
                                        (t.tables.post = post.parse(
                                            v.data,
                                            v.offset,
                                        )),
                                        (t.glyphNames = new encoding.GlyphNames(
                                            t.tables.post,
                                        ));
                                    break;
                                case 'glyf':
                ...
                function (require, module, exports) {
                    ...
                    (Parser.prototype.parseByte = function () {
                        ...
                        (Parser.prototype.parseLongDateTime = function () {
                            ...
                            return (
                                (t -= 2082844800), (this.relativeOffset += 8), t
                            );
                        }),
                        (Parser.prototype.parseVersion = function () {
                            ...
                            return (
                                (this.relativeOffset += 4), t + r / 4096 / 10
                            );
                        }),
            ...
            12: [
                function (require, module, exports) {
                    ...
                    (Substitution.prototype = Layout),
                        ...
                        (Substitution.prototype.getFeature = function (
                            t,
                            e,
                            r,
                        ) {
                    ...
                    function Coverage(e) {
                        1 === e.format
                            ? Table.call(
                                  ...
                                  ].concat(ushortList('glyph', e.glyphs)),
                              )
                            : check.assert(
                                  !1,
            ...
            14: [
                function (require, module, exports) {
                    ...
                    function parseOperand(e, t) {
                        ...
                        if (t >= 247 && 250 >= t)
                            return (
                                (a = e.parseByte()), 256 * (t - 247) + a + 108
                            );
                        if (t >= 251 && 254 >= t)
                            return (
                                (a = e.parseByte()), 256 * -(t - 251) - a - 108
                            );
                    ...
                    function parseCFFTable(e, t, a) {
                        ...
                        var h = new DataView(
                                new Uint8Array(s.objects[0]).buffer,
                            ),
                            f = parseCFFTopDict(h, i.objects);
                        a.tables.cff.topDict = f;
                        var p = t + f['private'][1],
                            u = parseCFFPrivateDict(
                                e,
                                p,
                                f['private'][0],
                                i.objects,
                    ...
                    function encodeString(e, t) {
                        ...
                        return (
                            ...
                            r >= 0
                                ...
                                : ((a =
                                      encoding.cffStandardStrings.length +
                                      t.length),
                                  t.push(e)),
                            a
                        );
                    ...
                    function glyphToOps(e) {
                        ...
                        return (
                            t.push({ name: 'endchar', type: 'OP', value: 14 }),
                            t
                        );
                    }
                    ...
                    function makeCFFTable(e, t) {
                        ...
                        return (
                            ...
                            (s.private[1] =
                                s.charStrings + r.charStringsIndex.sizeOf()),
                            (p = makeTopDict(s, f)),
                            (r.topDictIndex = makeTopDictIndex(p)),
                            r
                        );
            ...
            15: [
                function (require, module, exports) {
                    ...
                    function parseCmapTableFormat4(e, a, r, t, n) {
                        var s;
                        (e.length = a.parseUShort()),
                            (e.language = a.parseUShort());
                        var o;
                    ...
                    function makeCmapTable(e) {
                        ...
                        (s = r.segments.length),
                            ...
                            (r.searchRange =
                                ...
                                Math.pow(
                                    2,
                                    Math.floor(Math.log(s) / Math.log(2)),
                                )),
                            (r.entrySelector =
                                Math.log(r.searchRange / 2) / Math.log(2)),
                ...
                function (require, module, exports) {
                        ...
                        if (e.numberOfContours > 0) {
                            ...
                            for (a = [], s = 0; i > s; s += 1)
                                if (
                                    ...
                                    for (
                                        var h = o.parseByte(), l = 0;
                                        h > l;
                                        l += 1
                                    )
                                        a.push(n), (s += 1);
                            if (
                                (check.argument(a.length === i, 'Bad flags.'),
                                p.length > 0)
                            ) {
                                var u,
                                    c = [];
                    ...
                    function getContours(e) {
                        for (var r = [], t = [], o = 0; o < e.length; o += 1) {
                            var a = e[o];
                            t.push(a),
                                a.lastPointOfContour && (r.push(t), (t = []));
                        }
                        return (
                            check.argument(
                                0 === t.length,
                        ...
                        for (
                            ...
                            for (var h = n ? 1 : 0; h < s.length; h += 1) {
                                ...
                                if (u.onCurve && l.onCurve) r.lineTo(l.x, l.y);
                                    ...
                                    r.quadraticCurveTo(a.x, a.y, l.x, l.y),
                                        (a = null);
                                } else {
                                    var c = {
                                        x: (u.x + l.x) / 2,
                ...
                function (require, module, exports) {
                    ...
                    function parseHeadTable(e, a) {
                        ...
                        return (
                            ...
                            (t.fontRevision =
                                Math.round(1e3 * r.parseFixed()) / 1e3),
                    ...
                    function makeHeadTable(e) {
                        ...
                        return (
                            e.createdTimestamp &&
                                (t = e.createdTimestamp + 2082844800),
                            new table.Table(
                                'head',
                                [
                                    {
            ...
            22: [
                function (require, module, exports) {
                    ...
                    function parseHmtxTable(e, a, r, t, s) {
                        for (
                            var i, l, n = new parse.Parser(e, a), p = 0;
                            t > p;
                            p += 1
                        ) {
                            r > p &&
                                ((i = n.parseUShort()), (l = n.parseShort()));
                            var d = s.get(p);
                ...
                function (require, module, exports) {
                    ...
                    function getEncoding(e, a, r) {
                        switch (e) {
                            ...
                            case 1:
                                return (
                                    macLanguageEncodings[r] ||
                                    macScriptEncodings[a]
                                );
                            case 3:
                        ...
                        for (
                            ...
                            for (var f in d) {
                                ...
                                if (void 0 !== S) {
                                    ...
                                    u.push(
                                        makeNameRecord(3, 1, S, r, T.length, N),
                                    );
                                }
                            }
                        }
                    ...
                    function makeSfntTable(e) {
                        ...
                        for (
                            var t = [],
                                ...
                                i =
                                    a.sizeOf() +
                                    makeTableRecord().sizeOf() * a.numTables;
                            i % 4 !== 0;
                    ...
                    function fontToSfntTable(e) {
                        ...
                        var b = head.make({
                            ...
                            M = hhea.make({
                                ...
                                xMaxExtent:
                                    x.maxLeftSideBearing + (x.xMax - x.xMin),
                        ...
                        W.uniqueID ||
                            ...
                            W.preferredFamily ||
                                (W.preferredFamily = e.names.fontFamily),
                    ...
                    (encode.MACSTRING = function (e, n) {
                        ...
                        (encode.INDEX = function (e) {
                            ...
                            var i = [],
                                a =
                                    (1 +
                                        Math.floor(Math.log(t) / Math.log(2)) /
                                            8) |
                                    0,
                                f = [
                                    void 0,
