...
var OptionController = (function (_Controller) {
    ...
    function OptionController(object, property, opts) {
        ...
        var _this2 = possibleConstructorReturn(
            this,
            (
                OptionController.__proto__ ||
                Object.getPrototypeOf(OptionController)
            ).call(this, object, property),
        );
        var options = opts;
        var _this = _this2;
...
var StringController = (function (_Controller) {
    ...
    function StringController(object, property) {
        ...
        var _this2 = possibleConstructorReturn(
            this,
            (
                StringController.__proto__ ||
                Object.getPrototypeOf(StringController)
            ).call(this, object, property),
        );
        var _this = _this2;
        function onChange() {
...
var NumberController = (function (_Controller) {
    ...
    function NumberController(object, property, params) {
        ...
        var _this = possibleConstructorReturn(
            this,
            (
                NumberController.__proto__ ||
                Object.getPrototypeOf(NumberController)
            ).call(this, object, property),
        );
        var _params = params || {};
...
var ColorController = (function (_Controller) {
    ...
    function ColorController(object, property) {
        ...
        var _this2 = possibleConstructorReturn(
            this,
            (
                ColorController.__proto__ ||
                Object.getPrototypeOf(ColorController)
            ).call(this, object, property),
        );
        ...
        function setSV(e) {
            ...
            var s =
                (clientX - fieldRect.left) / (fieldRect.right - fieldRect.left);
            var v =
                1 -
...
Common.extend(GUI.prototype, {
    ...
    saveAs: function saveAs(presetName) {
        if (!this.load.remembered) {
            this.load.remembered = {};
            this.load.remembered[DEFAULT_DEFAULT_PRESET_NAME] =
    ...
    if (controller instanceof NumberControllerSlider) {
        ...
        var r = function r(returned) {
            if (
                ...
                var oldName =
                    controller.__li.firstElementChild.firstElementChild
                        .innerHTML;
                var wasListening =
