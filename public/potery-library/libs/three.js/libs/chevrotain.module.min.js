    ...
    return (function (t) {
            ...
            (e.END_OF_FILE = u.createTokenInstance(
                ...
                (function (t) {
                    (t[(t.INVALID_RULE_NAME = 0)] = 'INVALID_RULE_NAME'),
                        (t[(t.DUPLICATE_RULE_NAME = 1)] =
                            'DUPLICATE_RULE_NAME'),
                        (t[(t.INVALID_RULE_OVERRIDE = 2)] =
                            'INVALID_RULE_OVERRIDE'),
                        (t[(t.DUPLICATE_PRODUCTIONS = 3)] =
                            'DUPLICATE_PRODUCTIONS'),
                        (t[(t.UNRESOLVED_SUBRULE_REF = 4)] =
                            'UNRESOLVED_SUBRULE_REF'),
                        (t[(t.LEFT_RECURSION = 5)] = 'LEFT_RECURSION'),
                        (t[(t.NONE_LAST_EMPTY_ALT = 6)] =
                            'NONE_LAST_EMPTY_ALT'),
                        ...
                        (t[(t.INVALID_NESTED_RULE_NAME = 10)] =
                            'INVALID_NESTED_RULE_NAME'),
                        (t[(t.DUPLICATE_NESTED_NAME = 11)] =
                            'DUPLICATE_NESTED_NAME'),
                        (t[(t.NO_NON_EMPTY_LOOKAHEAD = 12)] =
                            'NO_NON_EMPTY_LOOKAHEAD'),
                        (t[(t.AMBIGUOUS_PREFIX_ALTS = 13)] =
                ...
                i = (function () {
                    ...
                    return (
                        (t.prototype.visit = function (t) {
                            ...
                            if (t instanceof r.Repetition)
                                return this.visitRepetition(t);
                            if (t instanceof r.Alternation)
                                return this.visitAlternation(t);
                            if (t instanceof r.Terminal)
                        ...
                        (t.prototype.visitRepetitionMandatory = function (
                            t,
                        ) {}),
                        (t.prototype.visitRepetitionMandatoryWithSeparator =
                            function (t) {}),
                        (t.prototype.visitRepetitionWithSeparator = function (
                            t,
                        ) {}),
                ...
                r.forEach(t, function (t) {
                    (t.categoryMatches = []),
                        r.forEach(t.categoryMatchesMap, function (n, r) {
                            t.categoryMatches.push(
                                e.tokenIdxToClass.get(r).tokenTypeIdx,
                            );
                        });
                });
            }
        ...
        function (t, e, n) {
            ...
            (e.isSequenceProd = function (t) {
                ...
                (e.getProductionDslName = function (t) {
                    ...
                    if (t instanceof a.RepetitionMandatory)
                        return 'AT_LEAST_ONE';
        ...
        function (t, e, n) {
            ...
            (e.defaultParserErrorProvider = {
                ...
                buildNotAllInputParsedMessage: function (t) {
                    ...
                    t.ruleName;
                    return (
                        'Redundant input, expecting EOF but found: ' + e.image
                    );
                },
                            ...
                            a.forEach(t, function (t) {
                                ...
                                a.forEach(a.values(o), function (r) {
                                    var i = a.map(r, function (t) {
                                        ...
                                        o = e.buildDuplicateNestedRuleNameError(
                                            t,
                                            i,
                                        );
                                    n.push({
                    ...
                    function (n, r) {
                        var i = o.dropRight(r.definition),
                            a = o.map(i, function (n, i) {
                                var a = h.nextPossibleTokensAfter(
                                    [n],
                                    [],
                                    null,
                                    1,
                                ...
                                l = (function (t, e, n, r) {
                                    ...
                                    return o.map(u, function (t) {
                                        var i = a.map(t.alts, function (t) {
                                            ...
                                            o =
                                                r.buildAlternationAmbiguityError(
                                                    {
                                                        topLevelRule: n,
                                                        alternation: e,
                                                        ambiguityIndices: i,
                    ...
                    a.forEach(t, function (t) {
                        ...
                        a.forEach(o, function (i) {
                            var o = p.getProdType(i),
                                u = i.idx,
                                c = p.getLookaheadPathsForOptionalProd(
                                    u,
                                    t,
                                    o,
                                    e,
                    ...
                    a.forEach(o, function (t) {
                        var u = t.idx,
                            ...
                            l = a.findAll(o, function (t) {
                                return (
                                    t.idx < u &&
                                    p.isStrictPrefixOfPath(t.path, c)
                                );
                            }),
        ...
        function (t, e, n) {
            ...
            !(function (t) {
                (t[(t.OPTION = 0)] = 'OPTION'),
                    ...
                    (t[(t.REPETITION_WITH_SEPARATOR = 4)] =
                ...
                (e.getProdType = function (t) {
                    ...
                    if (t instanceof p.RepetitionMandatory)
                ...
                (e.buildLookaheadFuncForOptionalProd = function (
                    t,
                    e,
                    n,
                    r,
                ...
                (e.buildSingleAlternativeLookaheadFunction = function (
                    t,
                    e,
                    n,
                ) {
            ...
            function m(t, e, n, r) {
                ...
                return d(
                    [
                        new p.Flat({ definition: o }),
                        new p.Flat({ definition: a }),
                    ],
                    r,
                );
            }
                    ...
                    a.find(t, function (t) {
                        return (
                            ...
                            a.every(e, function (e, n) {
                                return (
                                    e === t[n] ||
                                    t[n].categoryMatchesMap[e.tokenTypeIdx]
                                );
                            })
                        );
                    })
                ...
                (e.isStrictPrefixOfPath = function (t, e) {
                    return (
                        ...
                        a.every(t, function (t, n) {
                            var r = e[n];
                            return (
                                t === r || r.categoryMatchesMap[t.tokenTypeIdx]
                            );
                        })
                    );
                }),
        ...
        function (t, e, n) {
                ...
                p = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.walkProdRef = function (t, e, n) {
                            if (
                                t.referencedRule.name ===
                                    this.nextProductionName &&
                                t.idx === this.nextProductionOccurrence
                            ) {
                                var r = e.concat(n);
                                this.updateExpectedNext(),
                                    this.walk(t.referencedRule, r);
                            }
                        }),
                ...
                return (
                    ...
                    (e.prototype.walkTerminal = function (t, e, n) {
                        if (
                            ...
                            (this.possibleTokTypes = u.first(i)),
                                (this.found = !0);
                        }
                    }),
                    e
                ...
                return (
                    ...
                    (e.prototype.walkAtLeastOneSep = function (e, n, r) {
                        if (e.idx === this.occurrence) {
                            ...
                            t.prototype.walkAtLeastOneSep.call(this, e, n, r);
                    }),
                    e
                );
            })(h);
            ...
            (e.NextTerminalAfterAtLeastOneSepWalker = m),
                (e.possiblePathsFrom = function t(e, n, r) {
                    ...
                    return (
                        i.push({ partialPath: r, suffixDef: a.drop(e, o) }), i
                    );
                }),
                        ...
                        if ('EXIT_ALTERNATIVE' !== h) {
                            ...
                            if (!a.isEmpty(f)) {
                                ...
                                if ('EXIT_NONE_TERMINAL' === T) {
                                    ...
                                    T instanceof
                                    c.RepetitionMandatoryWithSeparator
                                ) {
                                    ...
                                    T instanceof c.RepetitionWithSeparator
                                ) {
                                    (A = {
                                        idx: d,
                                        def: a.drop(f),
        ...
        function (t, e, n) {
                ...
                o = (function () {
                    ...
                    return (
                        (t.prototype.walk = function (t, e) {
                            ...
                            void 0 === e && (e = []),
                                r.forEach(t.definition, function (o, a) {
                                    ...
                                    if (o instanceof i.NonTerminal)
                                        n.walkProdRef(o, s, e);
                                    else if (o instanceof i.Terminal)
                                        n.walkTerminal(o, s, e);
                                    else if (o instanceof i.Flat)
                                        n.walkFlat(o, s, e);
                                    else if (o instanceof i.Option)
                                        n.walkOption(o, s, e);
                                    else if (o instanceof i.RepetitionMandatory)
                                        n.walkAtLeastOne(o, s, e);
                                    else if (
                                        o instanceof
                                        i.RepetitionMandatoryWithSeparator
                                    )
                                        n.walkAtLeastOneSep(o, s, e);
                                    else if (
                                        o instanceof i.RepetitionWithSeparator
                                    )
                                        n.walkManySep(o, s, e);
                        ...
                        (t.prototype.walkAtLeastOne = function (t, e, n) {
                            var r = [
                                new i.Option({ definition: t.definition }),
                            ].concat(e, n);
                            this.walk(t, r);
                        }),
            ...
            function a(t, e, n) {
                return [
                    new i.Option({
                        definition: [
                            new i.Terminal({ terminalType: t.separator }),
                        ].concat(t.definition),
                    }),
                ].concat(e, n);
            }
        ...
        function (t, e, n) {
            ...
            !(function (t) {
                (t[(t.MISSING_PATTERN = 0)] = 'MISSING_PATTERN'),
                    ...
                    (t[(t.UNSUPPORTED_FLAGS_FOUND = 3)] =
                        'UNSUPPORTED_FLAGS_FOUND'),
                    (t[(t.DUPLICATE_PATTERNS_FOUND = 4)] =
                        'DUPLICATE_PATTERNS_FOUND'),
                    (t[(t.INVALID_GROUP_TYPE_FOUND = 5)] =
                        'INVALID_GROUP_TYPE_FOUND'),
                    (t[(t.PUSH_MODE_DOES_NOT_EXIST = 6)] =
                    ...
                    (t[
                        (t.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST = 9)
            ...
            var u = (function () {
                function t(t, e) {
                    ...
                    if (
                        ...
                        this.config.lineTerminatorsPattern ===
                            s.lineTerminatorsPattern)
                    )
                        this.config.lineTerminatorsPattern =
                            r.LineTerminatorOptimizedTester;
                    else if (
                        this.config.lineTerminatorCharacters ===
                        s.lineTerminatorCharacters
                    )
                        throw Error(
                    ...
                    if (
                        ...
                        !1 === this.trackStartLines &&
                            (this.computeNewColumn = i.IDENTITY),
                ...
                return (
                    ...
                    (t.prototype.createStartOnlyToken = function (
                        t,
                        e,
                        n,
                        r,
                    ...
                    (t.prototype.createFullToken = function (
                        t,
                        e,
                        n,
                        r,
                    ...
                    (t.prototype.addTokenUsingMemberAccess = function (
                        t,
                        e,
                        n,
                    ) {
                ...
                return (
                    ...
                    (e.prototype.collectNamedDSLMethod = function (t, e, n) {
                        if (!o.isUndefined(t.name)) {
                            ...
                            var i = [r],
                                a = s.getKeyForAutomaticLookahead(
                                    this.ruleIdx,
                                    n,
                                    t.idx,
                                );
                    ...
                    (o =
                        ...
                        typeof (r = function () {
                            ...
                            (t.prototype.saveState = function () {
                                ...
                                (t.prototype.characterClassEscape =
                                    function () {
                                        var t,
                                            e = !1;
                                        switch (this.popChar()) {
                                ...
                                (t.prototype.controlEscapeAtom = function () {
                                    ...
                                    return (
                                        u(t), { type: 'Character', value: t }
                                    );
                                }),
                                (t.prototype.controlLetterEscapeAtom =
                                    function () {
                                        this.consumeChar('c');
                                        var t = this.popChar();
                                        if (!1 === /[a-zA-Z]/.test(t))
                                ...
                                (t.prototype.hexEscapeSequenceAtom =
                                    function () {
                                        return (
                                            this.consumeChar('x'),
                                ...
                                (t.prototype.regExpUnicodeEscapeSequenceAtom =
                                    function () {
                                        return (
                                            this.consumeChar('u'),
                            ...
                            return (
                                ...
                                (h.prototype.visitDisjunction = function (
                                    t,
                                ) {}),
                                (h.prototype.visitAlternative = function (
                                    t,
                                ) {}),
                                (h.prototype.visitStartAnchor = function (
                                    t,
                                ) {}),
                                (h.prototype.visitEndAnchor = function (t) {}),
                                (h.prototype.visitWordBoundary = function (
                                    t,
                                ) {}),
                                (h.prototype.visitNonWordBoundary = function (
                                    t,
                                ) {}),
                                (h.prototype.visitLookahead = function (t) {}),
                                (h.prototype.visitNegativeLookahead = function (
                                    t,
                                ) {}),
                                (h.prototype.visitCharacter = function (t) {}),
                                (h.prototype.visitSet = function (t) {}),
                                (h.prototype.visitGroup = function (t) {}),
                                (h.prototype.visitGroupBackReference =
                                    function (t) {}),
        ...
        function (t, e, n) {
            ...
            function F(t, n, r, i, a) {
                ...
                if (!p)
                    throw Error(
                        'Separator Terminal Token name: ' + c + ' not found',
                    );
        ...
        function (t, e, n) {
            ...
            var p = (function () {
                ...
                return (
                    (t.prototype.initRecoverable = function (t) {
                        (this.firstAfterRepMap = new s.HashTable()),
                            ...
                            this.recoveryEnabled &&
                                (this.attemptInRepetitionRecovery = l);
                    }),
                    (t.prototype.getTokenToInsert = function (t) {
                        var e = r.createTokenInstance(
                            t,
                            '',
                            NaN,
                            NaN,
                    ...
                    (t.prototype.canTokenTypeBeInsertedInRecovery = function (
                        t,
                    ) {
                        return !0;
                    }),
                    (t.prototype.tryInRepetitionRecovery = function (
                        t,
                        e,
                        n,
                        r,
                        ...
                        for (
                            var a = this,
                                ...
                                f = function () {
                                    var t = a.LA(0),
                                        ...
                                        n = new o.MismatchedTokenException(
                                            e,
                                            l,
                                            a.LA(0),
                                        );
                                    (n.resyncedTokens = i.dropRight(c)),
                                        a.SAVE_ERROR(n);
                                };
                            !p;
                            ...
                            this.tokenMatcher(h, s)
                                ? (p = !0)
                                : ((h = this.SKIP_TOKEN()),
                                  this.addToResyncTokens(h, c));
                        }
                        this.importLexerState(u);
                    }),
                    (t.prototype.shouldInRepetitionRecoveryBeTried = function (
                        t,
                        e,
                    ) {
                        return (
                    ...
                    (t.prototype.canRecoverWithSingleTokenInsertion = function (
                        t,
                        e,
                    ) {
                        var n = this;
                        if (!this.canTokenTypeBeInsertedInRecovery(t))
                            return !1;
                    ...
                    (t.prototype.canRecoverWithSingleTokenDeletion = function (
                        t,
                    ) {
                        ...
                        return (
                            ...
                            i.map(n, function (i, o) {
                                return 0 === o
                                    ...
                                    : {
                                          ruleName:
                                              t.shortRuleNameToFullName(i),
                                          idxInCallingRule: r[o],
                                          inRule: t.shortRuleNameToFullName(
                                              n[o - 1],
                                          ),
                                      };
                            })
                    ...
                    (t.prototype.getFollowSetFromFollowKey = function (t) {
                        ...
                        var n =
                            t.ruleName + t.idxInCallingRule + a.IN + t.inRule;
                    ...
                    (t.prototype.getHumanReadableRuleStack = function () {
                        ...
                        return i.isEmpty(this.LAST_EXPLICIT_RULE_STACK)
                            ...
                            : i.map(
                                  this.LAST_EXPLICIT_RULE_STACK,
                                  function (e) {
                                      return t.shortRuleNameToFullName(
                                          t.RULE_STACK[e],
                                      );
                                  },
                              );
            ...
            var o = n(14),
                ...
                h = (function (t) {
                    function e(e) {
                        var n = t.call(this) || this;
                        return (
                            (n.topProd = e), (n.follows = new a.HashTable()), n
                        );
                    }
                    return (
                        i(e, t),
        ...
        function (t, e, n) {
                    ...
                    return (n = (n = (n = (n = (n = n.concat(i.errors)).concat(
                        (function (t) {
                            ...
                            return (e = (e = (e = (e = (e = e.concat(
                                E(n),
                            )).concat(T(n))).concat(v(n))).concat(g(n))).concat(
                                m(n),
                            ));
                        })(o),
            ...
            function R(t, e) {
                var n = u.filter(t, function (t) {
                    return (
                        void 0 !== t.PUSH_MODE && !u.contains(e, t.PUSH_MODE)
                    );
                });
                return u.map(n, function (t) {
                    return {
            ...
            function L(t, e) {
                ...
                if (u.isRegExp(t.PATTERN)) {
                    try {
                        ...
                        return {
                            issue: s.LexerDefinitionErrorType
                                .IDENTIFY_TERMINATOR,
                            errMsg: t.message,
                        };
                    }
                        ...
                        e &&
                            u.forEach(a, function (t) {
                                ...
                                if (!1 !== e) {
                                    ...
                                    u.has(t, 'LINE_BREAKS')
                                        ? !0 === t.LINE_BREAKS && (i = !0)
                                        : c.canMatchCharCode(p, t.PATTERN) &&
                                          (i = !0);
                            }),
                        e &&
                            !i &&
        ...
        function (t, e, n) {
                ...
                return (
                    a.forEach(t, function (t) {
                        ...
                        n.toUpperCase() !== n
                            ...
                            : n.toLowerCase() !== n &&
                              e.push(n.toLowerCase().charCodeAt(0));
                    }),
                    e
                );
            }
            ...
            function h(t) {
                return (
                    ...
                    (!!t.value &&
                        (a.isArray(t.value) ? a.every(t.value, h) : h(t.value)))
                );
            }
            ...
            var f = (function (t) {
                ...
                return (
                    ...
                    (e.prototype.visitCharacter = function (t) {
                        a.contains(this.targetCharCodes, t.value) &&
                            (this.found = !0);
                    }),
                    (e.prototype.visitSet = function (t) {
                        t.complement
                            ? void 0 === l(t, this.targetCharCodes) &&
                              (this.found = !0)
                            : void 0 !== l(t, this.targetCharCodes) &&
                              (this.found = !0);
                    }),
                ...
                return (
                    ...
                    (e.prototype.visitNonTerminal = function (t) {
                        ...
                        if (e) t.referencedRule = e;
                            ...
                            this.errors.push({
                                message: n,
                                type: o.ParserDefinitionErrorType
                                    .UNRESOLVED_SUBRULE_REF,
                ...
                s = (function () {
                    ...
                    return (
                        (t.prototype.initLooksAhead = function (t) {
                            (this.dynamicTokensEnabled = i.has(
                                t,
                                ...
                                (this.lookAheadFuncsCache =
                                    i.isES2015MapSupported() ? new Map() : []),
                                i.isES2015MapSupported()
                                    ? ((this.getLaFuncFromCache =
                                          this.getLaFuncFromMap),
                                      (this.setLaFuncCache =
                                          this.setLaFuncCacheUsingMap))
                                    : ((this.getLaFuncFromCache =
                                          this.getLaFuncFromObj),
                                      (this.setLaFuncCache =
                                          this.setLaFuncUsingObj));
                        }),
                        (t.prototype.lookAheadBuilderForOptional = function (
                            t,
                            e,
                            n,
                        ) {
                            return r.buildSingleAlternativeLookaheadFunction(
                                t,
                                e,
                                n,
                            );
                        }),
                        (t.prototype.lookAheadBuilderForAlternatives =
                            function (t, e, n, i) {
                                return r.buildAlternativesLookAheadFunc(
                                    t,
                                    e,
                                    n,
                                    i,
                        ...
                        (t.prototype.getKeyForAutomaticLookahead = function (
                            t,
                            e,
                        ) {
                        ...
                        (t.prototype.getLookaheadFuncForOption = function (
                            t,
                            e,
                        ) {
                        ...
                        (t.prototype.getLookaheadFuncForManySep = function (
                            t,
                            e,
                        ) {
                            return this.getLookaheadFuncFor(
                        ...
                        (t.prototype.getLookaheadFuncForAtLeastOne = function (
                            t,
                            e,
                        ) {
                            return this.getLookaheadFuncFor(
                        ...
                        (t.prototype.getLookaheadFuncFor = function (
                            t,
                            e,
                            n,
                            i,
            ...
            var r = n(16),
                ...
                u = (function () {
                    ...
                    return (
                        (t.prototype.initTreeBuilder = function (t) {
                            (this.LAST_EXPLICIT_RULE_STACK = []),
                                ...
                                this.outputCst ||
                                    ...
                                    (this.manyInternal =
                                        this.manyInternalNoCst),
                                    (this.orInternal = this.orInternalNoCst),
                                    (this.optionInternal =
                                        this.optionInternalNoCst),
                                    (this.atLeastOneInternal =
                                        this.atLeastOneInternalNoCst),
                                    (this.manySepFirstInternal =
                                        this.manySepFirstInternalNoCst),
                                    (this.atLeastOneSepFirstInternal =
                                        this.atLeastOneSepFirstInternalNoCst));
                        }),
                        (t.prototype.cstNestedInvocationStateUpdate = function (
                            t,
                            e,
                        ) {
                            this.CST_STACK.push({
                        ...
                        (t.prototype.cstInvocationStateUpdate = function (
                            t,
                            e,
                        ) {
                        ...
                        (t.prototype.getBaseCstVisitorConstructor =
                            function () {
                                if (
                                    i.isUndefined(
                                        this.baseCstVisitorConstructor,
                                    )
                                ) {
                                    var t =
                                        o.createBaseSemanticVisitorConstructor(
                                            this.className,
                                            this.allRuleNames,
                                        );
                                    return (
                                        (this.baseCstVisitorConstructor = t), t
                                    );
                                }
                        ...
                        (t.prototype.getBaseCstVisitorConstructorWithDefaults =
                            function () {
                                if (
                                    ...
                                    var t =
                                        o.createBaseVisitorConstructorWithDefaults(
                                            this.className,
                                            this.allRuleNames,
                        ...
                        (t.prototype.nestedRuleBeforeClause = function (t, e) {
                            ...
                            return void 0 !== t.NAME
                                ? ((n = t.NAME),
                                  this.nestedRuleInvocationStateUpdate(n, e),
                                  n)
                                : void 0;
                        }),
                        (t.prototype.nestedAltBeforeClause = function (
                            t,
                            e,
                            n,
                            r,
                        ...
                        (t.prototype.getLastExplicitRuleShortNameNoCst =
                            function () {
                                var t = this.RULE_STACK;
                                return t[t.length - 1];
                            }),
                        (t.prototype.getPreviousExplicitRuleShortName =
                            function () {
                                var t =
                                    this.LAST_EXPLICIT_RULE_STACK[
                        ...
                        (t.prototype.getPreviousExplicitRuleShortNameNoCst =
                            function () {
                                var t = this.RULE_STACK;
                                return t[t.length - 2];
                            }),
                        (t.prototype.getLastExplicitRuleOccurrenceIndex =
                            function () {
                                var t =
                                    this.LAST_EXPLICIT_RULE_STACK[
                                        this.LAST_EXPLICIT_RULE_STACK.length - 1
                        ...
                        (t.prototype.getLastExplicitRuleOccurrenceIndexNoCst =
                            function () {
                                var t = this.RULE_OCCURRENCE_STACK;
                                return t[t.length - 1];
                            }),
                        (t.prototype.nestedRuleInvocationStateUpdate =
                            function (t, e) {
                                this.RULE_OCCURRENCE_STACK.push(1),
                                    this.RULE_STACK.push(e),
                                    this.cstNestedInvocationStateUpdate(t, e);
                            }),
                        (t.prototype.nestedRuleFinallyStateUpdate =
                            function () {
                                this.RULE_STACK.pop(),
        ...
        function (t, e, n) {
            ...
            (e.defaultVisit = s),
                ...
                (e.createBaseVisitorConstructorWithDefaults = function (
                    t,
                    e,
                    n,
                ) {
            ...
            var r = n(0),
                ...
                p = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.getSerializedGastProductions =
                            function () {
                    ...
                    return (
                        ...
                        (t.prototype.defineRule = function (t, e, n) {
                            ...
                            var a,
                                ...
                                p =
                                    ...
                                    (i.BITS_FOR_METHOD_IDX +
                                        i.BITS_FOR_OCCURRENCE_IDX);
                            this.ruleShortNameIdx++,
                                    ...
                                    return (
                                        ...
                                        function (t) {
                                            try {
                                                ...
                                                var n =
                                                        1 ===
                                                        this.RULE_STACK.length,
                                                    r =
                                                        s &&
                                                        !this.isBackTracking() &&
                                                        this.recoveryEnabled;
                                                if (
                                                    o.isRecognitionException(t)
                                                ) {
                                                    if (r) {
                                                        var i,
                                                            a =
                                                                this.findReSyncTokenType();
                                                        if (
                        ...
                        (t.prototype.optionInternal = function (t, e) {
                            ...
                            try {
                                ...
                                void 0 !== r &&
                                    this.nestedRuleFinallyClause(n, r);
                            }
                        }),
                        ...
                        (t.prototype.atLeastOneInternalLogic = function (
                            t,
                            e,
                            n,
                        ) {
                        ...
                        (t.prototype.atLeastOneSepFirstInternal = function (
                            t,
                            e,
                        ) {
                            var n = this.getKeyForAutomaticLookahead(
                        ...
                        (t.prototype.atLeastOneSepFirstInternalNoCst =
                            function (t, e) {
                                var n = this.getKeyForAutomaticLookahead(
                                    i.AT_LEAST_ONE_SEP_IDX,
                                    t,
                        ...
                        (t.prototype.atLeastOneSepFirstInternalLogic =
                            function (t, e, n) {
                                var r = this,
                                    o = e.DEF,
                                    u = e.SEP;
                        ...
                        (t.prototype.manySepFirstInternalNoCst = function (
                            t,
                            e,
                        ) {
                            var n = this.getKeyForAutomaticLookahead(
                        ...
                        (t.prototype.manySepFirstInternalLogic = function (
                            t,
                            e,
                            n,
                        ) {
                            ...
                            if (
                                !0 ===
                                this.getLookaheadFuncForManySep(n, t).call(this)
                            ) {
                                o.call(this);
                                for (
                                    var u = function () {
                        ...
                        (t.prototype.orInternalNoCst = function (t, e) {
                            var n = r.isArray(t) ? t : t.DEF,
                                i = this.getLookaheadFuncForOr(e, n).call(
                                    this,
                                    n,
                                );
                        ...
                        (t.prototype.orInternal = function (t, e) {
                            ...
                            try {
                                var a = r.isArray(t) ? t : t.DEF,
                                    s = this.getLookaheadFuncForOr(e, a).call(
                                        this,
                                        a,
                                    );
                                if (void 0 !== s) {
                                    var u = a[s],
                                        c = this.nestedAltBeforeClause(
                                            u,
                                            e,
                                            i.OR_IDX,
                                            s,
                                ...
                                void 0 !== o &&
                                    this.nestedRuleFinallyClause(n, o);
                            }
                        }),
                        (t.prototype.ruleFinallyStateUpdate = function () {
                            if (
                                ...
                                this.SAVE_ERROR(
                                    new o.NotAllInputParsedException(e, t),
                                );
                            }
                        }),
                            ...
                            try {
                                ...
                                if (!0 !== this.tokenMatcher(i, t)) {
                                    ...
                                    throw (
                                        ...
                                        this.SAVE_ERROR(
                                            new o.MismatchedTokenException(
                                                a,
                                                i,
                                                s,
                                            ),
                        ...
                        (t.prototype.ruleInvocationStateUpdate = function (
                            t,
                            e,
                            n,
                        ) {
            ...
            var r = n(6),
                ...
                s = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.SAVE_ERROR = function (t) {
                            if (r.isRecognitionException(t))
                                return (
                                    (t.context = {
                                        ruleStack:
                                            this.getHumanReadableRuleStack(),
                                        ruleOccurrenceStack: i.cloneArr(
                                            this.RULE_OCCURRENCE_STACK,
                                        ),
                                    }),
                                    this._errors.push(t),
                        ...
                        (t.prototype.raiseEarlyExitException = function (
                            t,
                            e,
                            n,
                        ) {
        ...
        function (t, e, n) {
            ...
            function p(t, e) {
                ...
                return y(
                    e,
                    '$.CONSUME' + t.idx + '(this.tokensMap.' + n + ')' + a,
                );
            }
            function l(t, e) {
                return y(
                    e,
                    '$.SUBRULE' + t.idx + '($.' + t.nonTerminalName + ')' + a,
                );
            }
            function h(t, e) {
