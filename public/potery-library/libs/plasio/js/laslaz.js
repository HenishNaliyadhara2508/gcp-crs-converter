...
(function (scope) {
    ...
    scope.handleMessage = function (message_event) {
        ...
        setTimeout(function () {
            ...
            if (
                msg.hasOwnProperty('count') &&
                msg.hasOwnProperty('hasMoreData')
            ) {
            ...
            setTimeout(function () {
                ...
                if (skip <= 1) {
                    ...
                    res({
                        ...
                        count: count,
                        hasMoreData:
                            o.readOffset + count < o.header.pointsCount,
                    });
                    o.readOffset += count;
                } else {
                    ...
                    var buf = new Uint8Array(
                        bufferSize * o.header.pointsStructSize,
                    );
                    for (var i = 0; i < pointsToRead; i++) {
                        if (i % skip === 0) {
                            ...
                            buf.set(
                                src,
                                pointsRead * o.header.pointsStructSize,
                            );
                            pointsRead++;
                        }
    ...
    var LASFile = function (arraybuffer) {
        ...
        if (this.version > 12)
            throw new Error(
                'Only file versions <= 1.2 are supported at this time',
            );
