...
goog.addDependency(
    '../../../ol/ol/animation.js',
    ['ol.animation'],
    ['ol', 'ol.PreRenderFunction', 'ol.ViewHint', 'ol.coordinate', 'ol.easing'],
    false,
);
goog.addDependency(
    '../../../ol/ol/array.js',
    ['ol.array'],
    ['goog.array', 'goog.asserts'],
    false,
);
goog.addDependency(
    '../../../ol/ol/attribution.js',
    ['ol.Attribution'],
    ['goog.math', 'ol.TileRange'],
    false,
);
goog.addDependency(
    '../../../ol/ol/canvasfunction.js',
    ['ol.CanvasFunctionType'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/centerconstraint.js',
    ['ol.CenterConstraint', 'ol.CenterConstraintType'],
    ['ol.math'],
    false,
);
goog.addDependency(
    '../../../ol/ol/collection.js',
    ['ol.Collection', 'ol.CollectionEvent', 'ol.CollectionEventType'],
    ['goog.array', 'goog.events.Event', 'ol.Object'],
    false,
);
goog.addDependency(
    '../../../ol/ol/color/color.js',
    ['ol.Color', 'ol.color'],
    [
        'goog.asserts',
        'goog.color',
...
goog.addDependency(
    '../../../ol/ol/control/attributioncontrol.js',
...
goog.addDependency(
    '../../../ol/ol/control/control.js',
    ['ol.control.Control'],
    ['goog.dom', 'goog.events', 'ol', 'ol.MapEventType', 'ol.Object'],
    false,
);
goog.addDependency(
    '../../../ol/ol/control/controldefaults.js',
    ['ol.control'],
    [
        'ol',
        'ol.Collection',
...
goog.addDependency(
    '../../../ol/ol/control/mousepositioncontrol.js',
...
goog.addDependency(
    '../../../ol/ol/control/overviewmapcontrol.js',
...
goog.addDependency(
    '../../../ol/ol/control/rotatecontrol.js',
    ['ol.control.Rotate'],
    [
        'goog.dom',
        'goog.dom.classlist',
...
goog.addDependency(
    '../../../ol/ol/control/scalelinecontrol.js',
    [
...
goog.addDependency(
    '../../../ol/ol/control/zoomslidercontrol.js',
...
goog.addDependency(
    '../../../ol/ol/control/zoomtoextentcontrol.js',
...
goog.addDependency(
    '../../../ol/ol/coordinate.js',
    ['ol.Coordinate', 'ol.CoordinateFormatType', 'ol.coordinate'],
    ['goog.math', 'goog.string'],
    false,
);
goog.addDependency('../../../ol/ol/css.js', ['ol.css'], [], false);
goog.addDependency(
    '../../../ol/ol/deviceorientation.js',
    ['ol.DeviceOrientation', 'ol.DeviceOrientationProperty'],
    ['goog.events', 'ol', 'ol.Object', 'ol.has', 'ol.math'],
    false,
);
goog.addDependency(
    '../../../ol/ol/dom/dom.js',
    ['ol.dom', 'ol.dom.BrowserFeature'],
    ['goog.asserts', 'goog.dom', 'goog.userAgent', 'goog.vec.Mat4', 'ol'],
    false,
);
goog.addDependency('../../../ol/ol/easing.js', ['ol.easing'], [], false);
goog.addDependency(
    '../../../ol/ol/events/condition.js',
    ['ol.events.ConditionType', 'ol.events.condition'],
    [
        'goog.asserts',
        'goog.functions',
...
goog.addDependency(
    '../../../ol/ol/extent.js',
    ['ol.Extent', 'ol.extent', 'ol.extent.Corner', 'ol.extent.Relationship'],
    [
        'goog.asserts',
        'goog.vec.Mat4',
        'ol.Coordinate',
...
goog.addDependency(
    '../../../ol/ol/feature.js',
    ['ol.Feature', 'ol.FeatureStyleFunction'],
    [
        'goog.asserts',
        'goog.events',
        'goog.events.EventType',
...
goog.addDependency(
    '../../../ol/ol/featureloader.js',
    ['ol.FeatureLoader', 'ol.FeatureUrlFunction', 'ol.featureloader'],
    [
        'goog.asserts',
        'goog.events',
        'goog.net.EventType',
...
goog.addDependency(
    '../../../ol/ol/format/esrijsonformat.js',
    ['ol.format.EsriJSON'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/format/featureformat.js',
    ['ol.format.Feature'],
    ['ol.geom.Geometry', 'ol.proj'],
    false,
);
goog.addDependency(
    '../../../ol/ol/format/format.js',
    ['ol.format.FormatType'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/format/geojsonformat.js',
    ['ol.format.GeoJSON'],
    [
        'goog.asserts',
        'goog.object',
...
goog.addDependency(
    '../../../ol/ol/format/gml/gml2format.js',
    ['ol.format.GML2'],
    [
        'goog.asserts',
        'goog.dom.NodeType',
...
goog.addDependency(
    '../../../ol/ol/format/gml/gml3format.js',
...
goog.addDependency(
    '../../../ol/ol/format/gml/gmlbaseformat.js',
    ['ol.format.GMLBase'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/format/igcformat.js',
    ['ol.format.IGC', 'ol.format.IGCZ'],
    [
        'goog.asserts',
        'goog.string',
...
goog.addDependency(
    '../../../ol/ol/format/jsonfeatureformat.js',
    ['ol.format.JSONFeature'],
    ['goog.asserts', 'goog.json', 'ol.format.Feature', 'ol.format.FormatType'],
    false,
);
goog.addDependency(
    '../../../ol/ol/format/kmlformat.js',
    ['ol.format.KML'],
    [
        'goog.Uri',
        'goog.array',
...
goog.addDependency(
    '../../../ol/ol/format/polylineformat.js',
    ['ol.format.Polyline'],
    [
        'goog.asserts',
        'ol.Feature',
...
goog.addDependency(
    '../../../ol/ol/format/textfeatureformat.js',
    ['ol.format.TextFeature'],
    ['goog.asserts', 'ol.format.Feature', 'ol.format.FormatType'],
    false,
);
goog.addDependency(
    '../../../ol/ol/format/topojsonformat.js',
    ['ol.format.TopoJSON'],
    [
        'goog.asserts',
        'goog.object',
...
goog.addDependency(
    '../../../ol/ol/format/wmscapabilitiesformat.js',
...
goog.addDependency(
    '../../../ol/ol/format/wmsgetfeatureinfoformat.js',
...
goog.addDependency(
    '../../../ol/ol/format/wmtscapabilitiesformat.js',
...
goog.addDependency(
    '../../../ol/ol/format/xlinkformat.js',
    ['ol.format.XLink'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/format/xmlfeatureformat.js',
    ['ol.format.XMLFeature'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/format/xmlformat.js',
    ['ol.format.XML'],
    ['goog.asserts', 'ol.xml'],
    false,
);
goog.addDependency(
    '../../../ol/ol/format/xsdformat.js',
    ['ol.format.XSD'],
    ['goog.asserts', 'goog.string', 'ol', 'ol.xml'],
    false,
);
goog.addDependency(
    '../../../ol/ol/framestate.js',
    ['ol.PostRenderFunction', 'ol.PreRenderFunction'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/geolocation.js',
    ['ol.Geolocation', 'ol.GeolocationProperty'],
    [
        'goog.events',
        'goog.events.EventType',
        'ol.Coordinate',
...
goog.addDependency(
    '../../../ol/ol/geom/flat/areaflatgeom.js',
    ['ol.geom.flat.area'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/centerflatgeom.js',
    ['ol.geom.flat.center'],
    ['ol.extent'],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/closestflatgeom.js',
    ['ol.geom.flat.closest'],
    ['goog.asserts', 'goog.math', 'ol.math'],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/containsflatgeom.js',
    ['ol.geom.flat.contains'],
    ['goog.asserts', 'ol.extent'],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/deflateflatgeom.js',
    ['ol.geom.flat.deflate'],
    ['goog.asserts'],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/flipflatgeom.js',
    ['ol.geom.flat.flip'],
    ['goog.asserts'],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/geodesicflatgeom.js',
...
goog.addDependency(
    '../../../ol/ol/geom/flat/inflateflatgeom.js',
    ['ol.geom.flat.inflate'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/interiorpointflatgeom.js',
    ['ol.geom.flat.interiorpoint'],
    ['goog.asserts', 'ol.geom.flat.contains'],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/interpolateflatgeom.js',
    ['ol.geom.flat.interpolate'],
    ['goog.array', 'goog.asserts', 'goog.math'],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/intersectsextent.js',
...
goog.addDependency(
    '../../../ol/ol/geom/flat/lengthflatgeom.js',
    ['ol.geom.flat.length'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/orientflatgeom.js',
    ['ol.geom.flat.orient'],
    ['ol', 'ol.geom.flat.reverse'],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/reverseflatgeom.js',
    ['ol.geom.flat.reverse'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/segmentsflatgeom.js',
    ['ol.geom.flat.segments'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/simplifyflatgeom.js',
    ['ol.geom.flat.simplify'],
    ['ol.math'],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/flat/transformflatgeom.js',
    ['ol.geom.flat.transform'],
    ['goog.vec.Mat4'],
    false,
);
goog.addDependency(
    '../../../ol/ol/geom/geometry.js',
    ['ol.geom.Geometry', 'ol.geom.GeometryLayout', 'ol.geom.GeometryType'],
    [
        'goog.asserts',
        'goog.functions',
        'ol.Object',
...
goog.addDependency(
    '../../../ol/ol/geom/geometrycollection.js',
    ['ol.geom.GeometryCollection'],
    [
        'goog.events',
        'goog.events.EventType',
...
goog.addDependency(
    '../../../ol/ol/imagecanvas.js',
    ['ol.ImageCanvas'],
    ['goog.asserts', 'ol.ImageBase', 'ol.ImageState'],
    false,
);
goog.addDependency(
    '../../../ol/ol/imageloadfunction.js',
...
goog.addDependency(
    '../../../ol/ol/imageurlfunction.js',
    ['ol.ImageUrlFunction', 'ol.ImageUrlFunctionType'],
    ['ol.Size'],
    false,
);
goog.addDependency(
    '../../../ol/ol/interaction/doubleclickzoominteraction.js',
...
goog.addDependency(
    '../../../ol/ol/interaction/draganddropinteraction.js',
    ['ol.interaction.DragAndDrop', 'ol.interaction.DragAndDropEvent'],
    [
        'goog.asserts',
        'goog.events',
        'goog.events.Event',
...
goog.addDependency(
    '../../../ol/ol/interaction/dragboxinteraction.js',
    ['ol.DragBoxEvent', 'ol.interaction.DragBox'],
    [
        'goog.events.Event',
        'ol',
...
goog.addDependency(
    '../../../ol/ol/interaction/dragpaninteraction.js',
...
goog.addDependency(
    '../../../ol/ol/interaction/dragrotateandzoominteraction.js',
...
goog.addDependency(
    '../../../ol/ol/interaction/dragrotateinteraction.js',
...
goog.addDependency(
    '../../../ol/ol/interaction/dragzoominteraction.js',
...
goog.addDependency(
    '../../../ol/ol/interaction/drawinteraction.js',
    [
        'ol.interaction.Draw',
...
goog.addDependency(
    '../../../ol/ol/interaction/interaction.js',
    ['ol.interaction.Interaction', 'ol.interaction.InteractionProperty'],
    ['ol', 'ol.MapBrowserEvent', 'ol.Object', 'ol.animation', 'ol.easing'],
    false,
);
goog.addDependency(
    '../../../ol/ol/interaction/interactiondefaults.js',
    ['ol.interaction'],
    [
        'ol',
        'ol.Collection',
...
goog.addDependency(
    '../../../ol/ol/interaction/keyboardpaninteraction.js',
    ['ol.interaction.KeyboardPan'],
    [
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/interaction/keyboardzoominteraction.js',
    ['ol.interaction.KeyboardZoom'],
    [
        'goog.asserts',
        'goog.events.KeyHandler.EventType',
...
goog.addDependency(
    '../../../ol/ol/interaction/modifyinteraction.js',
    ['ol.interaction.Modify', 'ol.interaction.ModifyEvent'],
    [
        'goog.array',
        'goog.asserts',
        'goog.events',
...
goog.addDependency(
    '../../../ol/ol/interaction/mousewheelzoominteraction.js',
    ['ol.interaction.MouseWheelZoom'],
    [
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/interaction/pinchrotateinteraction.js',
    ['ol.interaction.PinchRotate'],
    [
        'goog.asserts',
        'goog.functions',
...
goog.addDependency(
    '../../../ol/ol/interaction/pinchzoominteraction.js',
    ['ol.interaction.PinchZoom'],
    [
        'goog.asserts',
        'goog.functions',
...
goog.addDependency(
    '../../../ol/ol/interaction/pointerinteraction.js',
    ['ol.interaction.Pointer'],
    [
        'goog.functions',
        'goog.object',
...
goog.addDependency(
    '../../../ol/ol/interaction/selectinteraction.js',
    [
...
goog.addDependency(
    '../../../ol/ol/interaction/snapinteraction.js',
    ['ol.interaction.Snap', 'ol.interaction.SnapProperty'],
    [
        'goog.asserts',
        'goog.events',
        'goog.events.EventType',
...
goog.addDependency(
    '../../../ol/ol/interaction/translateinteraction.js',
    ['ol.interaction.Translate', 'ol.interaction.TranslateEvent'],
    ['goog.events', 'goog.events.Event', 'ol.array', 'ol.interaction.Pointer'],
    false,
);
goog.addDependency(
    '../../../ol/ol/kinetic.js',
...
goog.addDependency(
    '../../../ol/ol/layer/layerbase.js',
    ['ol.layer.Base', 'ol.layer.LayerProperty', 'ol.layer.LayerState'],
    ['goog.object', 'ol', 'ol.Object', 'ol.math', 'ol.source.State'],
    false,
);
goog.addDependency(
    '../../../ol/ol/layer/layergroup.js',
    ['ol.layer.Group'],
    [
        'goog.asserts',
        'goog.events',
...
goog.addDependency(
    '../../../ol/ol/layer/tilelayer.js',
    ['ol.layer.Tile'],
    ['goog.object', 'ol', 'ol.layer.Layer'],
    false,
);
goog.addDependency(
    '../../../ol/ol/layer/vectorlayer.js',
    ['ol.layer.Vector'],
    ['goog.asserts', 'goog.object', 'ol', 'ol.layer.Layer', 'ol.style.Style'],
    false,
);
goog.addDependency(
    '../../../ol/ol/layer/vectortilelayer.js',
    ['ol.layer.VectorTile'],
    ['goog.object', 'ol.layer.Vector'],
    false,
);
goog.addDependency(
    '../../../ol/ol/loadingstrategy.js',
...
goog.addDependency(
    '../../../ol/ol/object.js',
    ['ol.Object', 'ol.ObjectEvent', 'ol.ObjectEventType'],
    ['goog.events', 'goog.events.Event', 'ol.Observable'],
    false,
);
goog.addDependency(
    '../../../ol/ol/observable.js',
    ['ol.Observable'],
    ['goog.events', 'goog.events.EventTarget', 'goog.events.EventType'],
    false,
);
goog.addDependency('../../../ol/ol/ol.js', ['ol'], [], false);
goog.addDependency(
    '../../../ol/ol/overlay.js',
    ['ol.Overlay', 'ol.OverlayPositioning', 'ol.OverlayProperty'],
    [
        'goog.asserts',
        'goog.dom',
        'goog.events',
...
goog.addDependency(
    '../../../ol/ol/pointer/eventsource.js',
    ['ol.pointer.EventSource'],
    ['goog.events.BrowserEvent'],
    false,
);
goog.addDependency(
    '../../../ol/ol/pointer/mousesource.js',
    ['ol.pointer.MouseSource'],
    ['ol.pointer.EventSource'],
    false,
);
goog.addDependency(
    '../../../ol/ol/pointer/mssource.js',
    ['ol.pointer.MsSource'],
    ['ol.pointer.EventSource'],
    false,
);
goog.addDependency(
    '../../../ol/ol/pointer/nativesource.js',
    ['ol.pointer.NativeSource'],
    ['ol.pointer.EventSource'],
    false,
);
goog.addDependency(
    '../../../ol/ol/pointer/pointerevent.js',
    ['ol.pointer.PointerEvent'],
    ['goog.events', 'goog.events.Event'],
    false,
);
goog.addDependency(
    '../../../ol/ol/pointer/pointereventhandler.js',
    ['ol.pointer.PointerEventHandler'],
    [
        'goog.dom',
        'goog.events',
        ...
        'ol.pointer.NativeSource',
        'ol.pointer.PointerEvent',
        'ol.pointer.TouchSource',
    ],
    false,
);
goog.addDependency(
    '../../../ol/ol/pointer/touchsource.js',
    ['ol.pointer.TouchSource'],
    [
        'goog.array',
        'goog.object',
...
goog.addDependency(
    '../../../ol/ol/proj/common.js',
    ['ol.proj.common'],
    ['ol.proj', 'ol.proj.EPSG3857', 'ol.proj.EPSG4326'],
    false,
);
goog.addDependency(
    '../../../ol/ol/proj/epsg3857projection.js',
    ['ol.proj.EPSG3857'],
    [
        'goog.asserts',
        'ol.math',
...
goog.addDependency(
    '../../../ol/ol/proj/epsg4326projection.js',
    ['ol.proj.EPSG4326'],
    ['ol.proj', 'ol.proj.Projection', 'ol.proj.Units'],
    false,
);
goog.addDependency(
    '../../../ol/ol/proj/proj.js',
...
goog.addDependency(
    '../../../ol/ol/raster/operation.js',
    ['ol.raster.Operation', 'ol.raster.OperationType'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/raster/pixel.js',
    ['ol.raster.Pixel'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/render/box.js',
    ['ol.render.Box'],
    ['goog.Disposable', 'goog.asserts', 'ol.geom.Polygon'],
    false,
);
goog.addDependency(
    '../../../ol/ol/render/canvas/canvas.js',
    ['ol.render.canvas'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/render/canvas/canvasimmediate.js',
...
goog.addDependency(
    '../../../ol/ol/render/canvas/canvasreplay.js',
    [
...
goog.addDependency(
    '../../../ol/ol/render/ireplay.js',
    ['ol.render.IReplayGroup'],
    ['ol.render.VectorContext'],
    false,
);
goog.addDependency(
    '../../../ol/ol/render/renderevent.js',
    ['ol.render.Event', 'ol.render.EventType'],
    ['goog.events.Event', 'ol.render.VectorContext'],
    false,
);
goog.addDependency(
    '../../../ol/ol/render/renderfeature.js',
    ['ol.render.Feature'],
    ['goog.asserts', 'goog.functions', 'ol.extent', 'ol.geom.GeometryType'],
    false,
);
goog.addDependency(
    '../../../ol/ol/render/vector.js',
    ['ol.renderer.vector'],
    [
        'goog.asserts',
        'ol.render.Feature',
...
goog.addDependency(
    '../../../ol/ol/render/vectorcontext.js',
    ['ol.render.VectorContext'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/render/webgl/webglimagedefaultshader.js',
    [
        'ol.render.webgl.imagereplay.shader.Default',
...
goog.addDependency(
    '../../../ol/ol/render/webgl/webglimmediate.js',
...
goog.addDependency(
    '../../../ol/ol/render/webgl/webglreplay.js',
    ['ol.render.webgl.ImageReplay', 'ol.render.webgl.ReplayGroup'],
    [
        'goog.asserts',
        'goog.functions',
        'goog.object',
...
goog.addDependency(
    '../../../ol/ol/renderer/canvas/canvasimagelayerrenderer.js',
...
goog.addDependency(
    '../../../ol/ol/renderer/canvas/canvaslayerrenderer.js',
    ['ol.renderer.canvas.Layer'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/renderer/canvas/canvasmaprenderer.js',
    ['ol.renderer.canvas.Map'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/renderer/canvas/canvastilelayerrenderer.js',
    ['ol.renderer.canvas.TileLayer'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/renderer/canvas/canvasvectorlayerrenderer.js',
    ['ol.renderer.canvas.VectorLayer'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/renderer/canvas/canvasvectortilelayerrenderer.js',
    ['ol.renderer.canvas.VectorTileLayer'],
    [
        'goog.asserts',
        'goog.events',
...
goog.addDependency(
    '../../../ol/ol/renderer/dom/domimagelayerrenderer.js',
    ['ol.renderer.dom.ImageLayer'],
    [
        'goog.asserts',
        'goog.dom',
        'goog.vec.Mat4',
...
goog.addDependency(
    '../../../ol/ol/renderer/dom/domlayerrenderer.js',
    ['ol.renderer.dom.Layer'],
    ['ol', 'ol.layer.Layer', 'ol.renderer.Layer'],
    false,
);
goog.addDependency(
    '../../../ol/ol/renderer/dom/dommaprenderer.js',
    ['ol.renderer.dom.Map'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/renderer/dom/domtilelayerrenderer.js',
    ['ol.renderer.dom.TileLayer'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/renderer/dom/domvectorlayerrenderer.js',
    ['ol.renderer.dom.VectorLayer'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    ...
    ['ol.RendererType', 'ol.renderer.Map'],
    [
        'goog.Disposable',
        'goog.asserts',
        'goog.dispose',
...
goog.addDependency(
    '../../../ol/ol/renderer/webgl/webglimagelayerrenderer.js',
...
goog.addDependency(
    '../../../ol/ol/renderer/webgl/webgllayerrenderer.js',
    ['ol.renderer.webgl.Layer'],
    [
        'goog.vec.Mat4',
        'goog.webgl',
...
goog.addDependency(
    '../../../ol/ol/renderer/webgl/webglmapdefaultshader.js',
    [
        'ol.renderer.webgl.map.shader.Default',
        'ol.renderer.webgl.map.shader.Default.Locations',
        'ol.renderer.webgl.map.shader.DefaultFragment',
...
goog.addDependency(
    '../../../ol/ol/renderer/webgl/webglmaprenderer.js',
    ['ol.renderer.webgl.Map'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/renderer/webgl/webgltilelayerrenderer.js',
    ['ol.renderer.webgl.TileLayer'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/renderer/webgl/webgltilelayershader.js',
    [
...
goog.addDependency(
    '../../../ol/ol/renderer/webgl/webglvectorlayerrenderer.js',
    ['ol.renderer.webgl.VectorLayer'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/reproj/image.js',
    ['ol.reproj.Image', 'ol.reproj.ImageFunctionType'],
    [
        'goog.asserts',
        'goog.events',
        'goog.events.EventType',
...
goog.addDependency(
    '../../../ol/ol/reproj/tile.js',
    ['ol.reproj.Tile', 'ol.reproj.TileFunctionType'],
    [
        'goog.asserts',
        'goog.events',
        'goog.events.EventType',
...
goog.addDependency(
    '../../../ol/ol/reproj/triangulation.js',
    ['ol.reproj.Triangulation'],
    ['goog.asserts', 'goog.math', 'ol.extent', 'ol.proj'],
    false,
);
goog.addDependency(
    '../../../ol/ol/resolutionconstraint.js',
    ['ol.ResolutionConstraint', 'ol.ResolutionConstraintType'],
    ['ol.array', 'ol.math'],
    false,
);
goog.addDependency(
    '../../../ol/ol/rotationconstraint.js',
    ['ol.RotationConstraint', 'ol.RotationConstraintType'],
    ['ol.math'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    '../../../ol/ol/source/bingmapssource.js',
    ['ol.source.BingMaps'],
    [
        'goog.Uri',
        'goog.asserts',
...
goog.addDependency(
    '../../../ol/ol/source/imagecanvassource.js',
    ['ol.source.ImageCanvas'],
    ['ol.CanvasFunctionType', 'ol.ImageCanvas', 'ol.extent', 'ol.source.Image'],
    false,
);
goog.addDependency(
    '../../../ol/ol/source/imagemapguidesource.js',
...
goog.addDependency(
    '../../../ol/ol/source/imagesource.js',
    ['ol.source.Image', 'ol.source.ImageEvent'],
    [
        'goog.array',
        'goog.asserts',
        'goog.events.Event',
...
goog.addDependency(
    '../../../ol/ol/source/imagestaticsource.js',
...
goog.addDependency(
    '../../../ol/ol/source/imagevectorsource.js',
    ['ol.source.ImageVector'],
    [
        'goog.asserts',
        'goog.events',
...
goog.addDependency(
    '../../../ol/ol/source/imagewmssource.js',
    ['ol.source.ImageWMS'],
    [
        'goog.asserts',
        'goog.events',
...
goog.addDependency(
    '../../../ol/ol/source/mapquestsource.js',
    ['ol.source.MapQuest'],
    ['goog.asserts', 'ol.Attribution', 'ol.source.OSM', 'ol.source.XYZ'],
    false,
);
goog.addDependency(
    '../../../ol/ol/source/osmsource.js',
    ['ol.source.OSM'],
    ['ol.Attribution', 'ol.source.XYZ'],
    false,
);
goog.addDependency(
    '../../../ol/ol/source/rastersource.js',
    ['ol.source.Raster', 'ol.source.RasterEvent', 'ol.source.RasterEventType'],
    [
        'goog.asserts',
        'goog.events',
        'goog.events.Event',
...
goog.addDependency(
    ...
    ['ol.source.Source', 'ol.source.State'],
    ['ol', 'ol.Attribution', 'ol.Object', 'ol.proj'],
    false,
);
goog.addDependency(
    '../../../ol/ol/source/stamensource.js',
    ['ol.source.Stamen'],
    ['goog.asserts', 'ol.Attribution', 'ol.source.OSM', 'ol.source.XYZ'],
    false,
);
goog.addDependency(
    '../../../ol/ol/source/tilearcgisrestsource.js',
...
goog.addDependency(
    '../../../ol/ol/source/tiledebugsource.js',
    ['ol.source.TileDebug'],
    [
        'ol.Tile',
        'ol.TileCoord',
...
goog.addDependency(
    '../../../ol/ol/source/tileimagesource.js',
    ['ol.source.TileImage'],
    [
        'goog.asserts',
        'goog.events',
...
goog.addDependency(
    '../../../ol/ol/source/tilejsonsource.js',
    ['ol.source.TileJSON', 'ol.tilejson'],
    [
        'goog.asserts',
        'goog.net.Jsonp',
        'ol.Attribution',
...
goog.addDependency(
    '../../../ol/ol/source/tilesource.js',
    ['ol.source.Tile', 'ol.source.TileEvent', 'ol.source.TileOptions'],
    [
        'goog.asserts',
        'goog.events.Event',
        'ol',
...
goog.addDependency(
    '../../../ol/ol/source/tileutfgridsource.js',
...
goog.addDependency(
    '../../../ol/ol/source/vectortilesource.js',
    ['ol.source.VectorTile'],
    [
        'goog.asserts',
        'goog.events',
...
goog.addDependency(
    '../../../ol/ol/source/wmssource.js',
    ['ol.source.wms', 'ol.source.wms.ServerType'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/source/wmtssource.js',
...
goog.addDependency(
    '../../../ol/ol/source/xyzsource.js',
    ['ol.source.XYZ'],
    ['ol.source.TileImage'],
    false,
);
goog.addDependency(
    '../../../ol/ol/source/zoomifysource.js',
    ['ol.source.Zoomify'],
    [
        'goog.asserts',
        'ol',
...
goog.addDependency(
    '../../../ol/ol/sphere/normal.js',
    ['ol.sphere.NORMAL'],
    ['ol.Sphere'],
    false,
);
goog.addDependency(
    '../../../ol/ol/sphere/sphere.js',
    ['ol.Sphere'],
    ['ol.math'],
    false,
);
goog.addDependency(
    '../../../ol/ol/sphere/wgs84sphere.js',
    ['ol.sphere.WGS84'],
    ['ol.Sphere'],
    false,
);
goog.addDependency(
    '../../../ol/ol/structs/checksum.js',
    ['ol.structs.IHasChecksum'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/structs/lrucache.js',
    ['ol.structs.LRUCache'],
    ['goog.asserts', 'goog.object'],
    false,
);
goog.addDependency(
    '../../../ol/ol/structs/priorityqueue.js',
    ['ol.structs.PriorityQueue'],
    ['goog.asserts', 'goog.object'],
    false,
);
goog.addDependency(
    '../../../ol/ol/structs/rbush.js',
    ['ol.structs.RBush'],
    ['goog.asserts', 'goog.object', 'ol.ext.rbush', 'ol.extent'],
    false,
);
goog.addDependency(
    '../../../ol/ol/style/atlasmanager.js',
    ['ol.style.Atlas', 'ol.style.AtlasManager'],
    ['goog.asserts', 'goog.dom', 'goog.functions', 'goog.object', 'ol'],
    false,
);
goog.addDependency(
    '../../../ol/ol/style/circlestyle.js',
    ['ol.style.Circle'],
    [
        'goog.asserts',
        'goog.dom',
...
goog.addDependency(
    '../../../ol/ol/style/fillstyle.js',
    ['ol.style.Fill'],
    ['ol.color', 'ol.structs.IHasChecksum'],
    false,
);
goog.addDependency(
    '../../../ol/ol/style/iconstyle.js',
    [
        'ol.style.Icon',
        'ol.style.IconAnchorUnits',
        'ol.style.IconImageCache',
...
goog.addDependency(
    '../../../ol/ol/style/imagestyle.js',
    ['ol.style.Image', 'ol.style.ImageState'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/style/regularshapestyle.js',
...
goog.addDependency(
    '../../../ol/ol/style/strokestyle.js',
    ['ol.style.Stroke'],
    ['goog.crypt', 'goog.crypt.Md5', 'ol.color', 'ol.structs.IHasChecksum'],
    false,
);
goog.addDependency(
    '../../../ol/ol/style/style.js',
    [
...
goog.addDependency(
    '../../../ol/ol/tilecache.js',
    ['ol.TileCache'],
    ['ol', 'ol.TileRange', 'ol.structs.LRUCache', 'ol.tilecoord'],
    false,
);
goog.addDependency(
    '../../../ol/ol/tilecoord.js',
...
goog.addDependency(
    '../../../ol/ol/tilegrid/wmtstilegrid.js',
    ['ol.tilegrid.WMTS'],
    ['goog.array', 'goog.asserts', 'ol.proj', 'ol.tilegrid.TileGrid'],
    false,
);
goog.addDependency(
    '../../../ol/ol/tileloadfunction.js',
    ['ol.TileLoadFunctionType', 'ol.TileVectorLoadFunctionType'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/tilequeue.js',
    ['ol.TilePriorityFunction', 'ol.TileQueue'],
    [
        'goog.events',
        'goog.events.EventType',
        'ol.Coordinate',
...
goog.addDependency(
    '../../../ol/ol/tilerange.js',
    ['ol.TileRange'],
    ['goog.asserts', 'ol.Size', 'ol.TileCoord'],
    false,
);
goog.addDependency(
    '../../../ol/ol/tileurlfunction.js',
    ['ol.TileUrlFunction', 'ol.TileUrlFunctionType'],
    ['goog.asserts', 'goog.math', 'ol.TileCoord', 'ol.tilecoord'],
    false,
);
goog.addDependency(
    '../../../ol/ol/transformfunction.js',
    ['ol.TransformFunction'],
    [],
    false,
);
goog.addDependency(
    '../../../ol/ol/vec/mat4.js',
    ['ol.vec.Mat4', 'ol.vec.Mat4.Number'],
    ['goog.vec.Mat4'],
    false,
);
goog.addDependency(
    '../../../ol/ol/vectortile.js',
    ['ol.VectorTile'],
    ['ol.Tile', 'ol.TileCoord', 'ol.TileLoadFunctionType', 'ol.TileState'],
    false,
);
goog.addDependency(
    '../../../ol/ol/view.js',
    ['ol.View', 'ol.ViewHint', 'ol.ViewProperty'],
    [
        'goog.asserts',
        'ol',
        'ol.CenterConstraint',
...
goog.addDependency(
    '../../../ol/ol/webgl/buffer.js',
    ['ol.webgl.Buffer'],
    ['goog.webgl', 'ol'],
    false,
);
goog.addDependency(
    '../../../ol/ol/webgl/context.js',
    ['ol.webgl.Context'],
    [
        'goog.asserts',
        'goog.events',
...
goog.addDependency(
    ...
    ['goog.functions', 'goog.webgl', 'ol.webgl'],
    false,
);
goog.addDependency(
    '../../../ol/ol/webgl/webgl.js',
...
goog.addDependency(
    'a11y/aria/announcer_test.js',
    ['goog.a11y.aria.AnnouncerTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Announcer',
        'goog.a11y.aria.LivePriority',
...
goog.addDependency(
    ...
    ['goog.a11y.aria.datatables'],
    ['goog.a11y.aria.State', 'goog.object'],
    false,
);
...
goog.addDependency(
    ...
    ['goog.debug.Error', 'goog.dom.NodeType', 'goog.string'],
    false,
);
goog.addDependency(
    'asserts/asserts_test.js',
    ['goog.assertsTest'],
    [
        'goog.asserts',
...
goog.addDependency(
    'async/animationdelay.js',
    ['goog.async.AnimationDelay'],
    ['goog.Disposable', 'goog.events', 'goog.functions'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'async/debouncer_test.js',
    ['goog.async.DebouncerTest'],
    [
        'goog.array',
        'goog.async.Debouncer',
        'goog.testing.MockClock',
...
goog.addDependency(
    ...
    ['goog.async.Delay', 'goog.testing.MockClock', 'goog.testing.jsunit'],
    false,
);
goog.addDependency('async/freelist.js', ['goog.async.FreeList'], [], false);
goog.addDependency(
    'async/freelist_test.js',
    ['goog.async.FreeListTest'],
    ['goog.async.FreeList', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'async/nexttick.js',
    ['goog.async.nextTick', 'goog.async.throwException'],
    [
...
goog.addDependency(
    'async/throttle_test.js',
    ['goog.async.ThrottleTest'],
    ['goog.async.Throttle', 'goog.testing.MockClock', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'async/workqueue.js',
    ['goog.async.WorkItem', 'goog.async.WorkQueue'],
    ['goog.asserts', 'goog.async.FreeList'],
    false,
);
goog.addDependency(
    'async/workqueue_test.js',
    ['goog.async.WorkQueueTest'],
    ['goog.async.WorkQueue', 'goog.testing.jsunit'],
    false,
);
...
goog.addDependency(
    ...
    ['goog.array', 'goog.color', 'goog.color.alpha', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'color/color.js',
    ['goog.color', 'goog.color.Hsl', 'goog.color.Hsv', 'goog.color.Rgb'],
    ['goog.color.names', 'goog.math'],
    false,
);
goog.addDependency(
    'color/color_test.js',
    ['goog.colorTest'],
    ['goog.array', 'goog.color', 'goog.color.names', 'goog.testing.jsunit'],
    false,
);
...
goog.addDependency(
    'crypt/aes.js',
    ['goog.crypt.Aes'],
    ['goog.asserts', 'goog.crypt.BlockCipher'],
    false,
);
goog.addDependency(
    'crypt/aes_test.js',
    ['goog.crypt.AesTest'],
    ['goog.crypt', 'goog.crypt.Aes', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'crypt/arc4.js',
...
goog.addDependency(
    'crypt/arc4_test.js',
    ['goog.crypt.Arc4Test'],
    ['goog.array', 'goog.crypt.Arc4', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'crypt/base64.js',
    ['goog.crypt.base64'],
    ['goog.asserts', 'goog.crypt', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'crypt/base64_test.js',
    ['goog.crypt.base64Test'],
    ['goog.crypt', 'goog.crypt.base64', 'goog.testing.jsunit'],
    false,
);
...
goog.addDependency(
    'crypt/blobhasher.js',
    ['goog.crypt.BlobHasher', 'goog.crypt.BlobHasher.EventType'],
    ['goog.asserts', 'goog.events.EventTarget', 'goog.fs', 'goog.log'],
    false,
);
goog.addDependency(
    'crypt/blobhasher_test.js',
...
goog.addDependency(
    'crypt/blockcipher.js',
    ['goog.crypt.BlockCipher'],
    [],
    false,
);
goog.addDependency(
    'crypt/bytestring_perf.js',
    ['goog.crypt.byteArrayToStringPerf'],
    ['goog.array', 'goog.dom', 'goog.testing.PerformanceTable'],
    false,
);
goog.addDependency(
    'crypt/cbc.js',
    ['goog.crypt.Cbc'],
    ['goog.array', 'goog.asserts', 'goog.crypt'],
    false,
);
goog.addDependency(
    'crypt/cbc_test.js',
    ['goog.crypt.CbcTest'],
    ['goog.crypt', 'goog.crypt.Aes', 'goog.crypt.Cbc', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'crypt/crypt.js',
...
goog.addDependency(
    'crypt/crypt_test.js',
    ['goog.cryptTest'],
    ['goog.crypt', 'goog.string', 'goog.testing.jsunit'],
    false,
);
...
goog.addDependency(
    'crypt/hash32_test.js',
    ['goog.crypt.hash32Test'],
    ['goog.crypt.hash32', 'goog.testing.TestCase', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'crypt/hashtester.js',
...
goog.addDependency(
    'crypt/sha2.js',
    ['goog.crypt.Sha2'],
    ['goog.array', 'goog.asserts', 'goog.crypt.Hash'],
    false,
);
goog.addDependency(
    'crypt/sha224.js',
...
goog.addDependency(
    ...
    ['goog.array', 'goog.asserts', 'goog.crypt.Hash', 'goog.math.Long'],
    false,
);
goog.addDependency(
    'crypt/sha2_64bit_test.js',
...
goog.addDependency(
    'cssom/iframe/style_test.js',
    ['goog.cssom.iframe.styleTest'],
    [
        'goog.cssom',
        'goog.cssom.iframe.style',
        'goog.dom',
...
goog.addDependency(
    'datasource/expr.js',
    ['goog.ds.Expr'],
    ['goog.ds.BasicNodeList', 'goog.ds.EmptyNodeList', 'goog.string'],
    false,
);
goog.addDependency(
    'datasource/expr_test.js',
    ['goog.ds.ExprTest'],
    [
        'goog.ds.DataManager',
        'goog.ds.Expr',
...
goog.addDependency(
    'datasource/fastdatanode_test.js',
...
goog.addDependency(
    'datasource/jsdatasource.js',
    ['goog.ds.JsDataSource', 'goog.ds.JsPropertyDataSource'],
    [
        'goog.ds.BaseDataNode',
        'goog.ds.BasicNodeList',
        'goog.ds.DataManager',
...
goog.addDependency(
    'datasource/jsxmlhttpdatasource.js',
...
goog.addDependency(
    'datasource/jsxmlhttpdatasource_test.js',
...
goog.addDependency(
    'datasource/xmldatasource.js',
    ['goog.ds.XmlDataSource', 'goog.ds.XmlHttpDataSource'],
    [
        'goog.Uri',
        'goog.dom.NodeType',
        'goog.dom.xml',
...
goog.addDependency(
    'date/duration.js',
    ['goog.date.duration'],
    ['goog.i18n.DateTimeFormat', 'goog.i18n.MessageFormat'],
    false,
);
goog.addDependency(
    'date/duration_test.js',
...
goog.addDependency(
    ...
    ['goog.i18n.DateTimeFormat', 'goog.i18n.DateTimePatterns'],
    false,
);
goog.addDependency(
    'date/relative_test.js',
...
goog.addDependency(
    'date/relativewithplurals_test.js',
...
goog.addDependency(
    ...
    ['goog.date', 'goog.date.Date', 'goog.date.DateTime', 'goog.date.Interval'],
    false,
);
goog.addDependency(
    'date/utcdatetime_test.js',
...
goog.addDependency(
    'db/db.js',
    ['goog.db', 'goog.db.BlockedCallback', 'goog.db.UpgradeNeededCallback'],
    [
        'goog.asserts',
        'goog.async.Deferred',
        'goog.db.Error',
...
goog.addDependency(
    'db/index.js',
    ['goog.db.Index'],
    ['goog.async.Deferred', 'goog.db.Cursor', 'goog.db.Error', 'goog.debug'],
    false,
);
goog.addDependency(
    'db/indexeddb.js',
...
goog.addDependency(
    'db/transaction.js',
    ['goog.db.Transaction', 'goog.db.Transaction.TransactionMode'],
    [
        'goog.async.Deferred',
        'goog.db.Error',
        'goog.db.ObjectStore',
...
goog.addDependency(
    'debug/console.js',
    ['goog.debug.Console'],
    ['goog.debug.LogManager', 'goog.debug.Logger', 'goog.debug.TextFormatter'],
    false,
);
goog.addDependency(
    'debug/console_test.js',
...
goog.addDependency(
    'debug/debugwindow_test.js',
    ['goog.debug.DebugWindowTest'],
    ['goog.debug.DebugWindow', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'debug/devcss/devcss.js',
    ['goog.debug.DevCss', 'goog.debug.DevCss.UserAgent'],
    [
        'goog.asserts',
        'goog.cssom',
        'goog.dom.classlist',
...
goog.addDependency(
    'debug/devcss/devcss_test.js',
    ['goog.debug.DevCssTest'],
    ['goog.debug.DevCss', 'goog.style', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'debug/devcss/devcssrunner.js',
...
goog.addDependency(
    'debug/enhanceerror_test.js',
    ['goog.debugEnhanceErrorTest'],
    ['goog.debug', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'debug/entrypointregistry.js',
    ['goog.debug.EntryPointMonitor', 'goog.debug.entryPointRegistry'],
    ['goog.asserts'],
    false,
);
goog.addDependency(
    'debug/entrypointregistry_test.js',
    ['goog.debug.entryPointRegistryTest'],
    [
        'goog.debug.ErrorHandler',
        'goog.debug.entryPointRegistry',
        'goog.testing.jsunit',
...
goog.addDependency(
    'debug/errorhandler_async_test.js',
    ['goog.debug.ErrorHandlerAsyncTest'],
    [
        'goog.Promise',
        'goog.debug.ErrorHandler',
...
goog.addDependency(
    'debug/errorhandler_test.js',
    ['goog.debug.ErrorHandlerTest'],
    [
        'goog.debug.ErrorHandler',
...
goog.addDependency(
    'debug/errorreporter.js',
    ['goog.debug.ErrorReporter', 'goog.debug.ErrorReporter.ExceptionEvent'],
    [
        'goog.asserts',
        'goog.debug',
        'goog.debug.Error',
...
goog.addDependency(
    'debug/errorreporter_test.js',
    ['goog.debug.ErrorReporterTest'],
    [
        'goog.debug.Error',
...
goog.addDependency(
    'debug/formatter_test.js',
    ['goog.debug.FormatterTest'],
    [
        'goog.debug.HtmlFormatter',
        'goog.debug.LogRecord',
        'goog.debug.Logger',
...
goog.addDependency(
    'debug/fpsdisplay_test.js',
    ['goog.debug.FpsDisplayTest'],
    [
        'goog.Timer',
        'goog.debug.FpsDisplay',
        'goog.testing.TestCase',
...
goog.addDependency(
    ...
    ['goog.asserts', 'goog.debug.LogRecord'],
    false,
);
goog.addDependency(
    'debug/logbuffer_test.js',
    ['goog.debug.LogBufferTest'],
    ['goog.debug.LogBuffer', 'goog.debug.Logger', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'debug/logger.js',
...
goog.addDependency(
    'debug/logger_test.js',
    ['goog.debug.LoggerTest'],
    ['goog.debug.LogManager', 'goog.debug.Logger', 'goog.testing.jsunit'],
    false,
);
goog.addDependency('debug/logrecord.js', ['goog.debug.LogRecord'], [], false);
goog.addDependency(
    'debug/logrecordserializer.js',
    ['goog.debug.logRecordSerializer'],
    ['goog.debug.LogRecord', 'goog.debug.Logger', 'goog.json', 'goog.object'],
    false,
);
goog.addDependency(
    'debug/logrecordserializer_test.js',
    ['goog.debug.logRecordSerializerTest'],
    [
        'goog.debug.LogRecord',
        'goog.debug.Logger',
        'goog.debug.logRecordSerializer',
...
goog.addDependency(
    'debug/tracer_test.js',
    ['goog.debug.TraceTest'],
    ['goog.debug.Trace', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'defineclass_test.js',
...
goog.addDependency(
    ...
    ['goog.Disposable', 'goog.dispose', 'goog.disposeAll'],
    ['goog.disposable.IDisposable'],
    false,
);
goog.addDependency(
    'disposable/disposable_test.js',
    ['goog.DisposableTest'],
    ['goog.Disposable', 'goog.testing.jsunit', 'goog.testing.recordFunction'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'dom/abstractmultirange.js',
    ['goog.dom.AbstractMultiRange'],
    ['goog.array', 'goog.dom', 'goog.dom.AbstractRange'],
    false,
);
goog.addDependency(
    'dom/abstractrange.js',
    ['goog.dom.AbstractRange', 'goog.dom.RangeIterator', 'goog.dom.RangeType'],
    [
        'goog.dom',
        'goog.dom.NodeType',
...
goog.addDependency(
    'dom/annotate.js',
    ['goog.dom.annotate', 'goog.dom.annotate.AnnotateFn'],
    [
        'goog.array',
        'goog.asserts',
        'goog.dom',
...
goog.addDependency(
    'dom/browserrange/abstractrange.js',
...
goog.addDependency(
    'dom/browserrange/browserrange.js',
    ['goog.dom.browserrange', 'goog.dom.browserrange.Error'],
    [
        'goog.dom',
        'goog.dom.BrowserFeature',
        'goog.dom.NodeType',
...
goog.addDependency(
    'dom/browserrange/browserrange_test.js',
...
goog.addDependency(
    'dom/browserrange/geckorange.js',
    ['goog.dom.browserrange.GeckoRange'],
    ['goog.dom.browserrange.W3cRange'],
    false,
);
goog.addDependency(
    'dom/browserrange/ierange.js',
    ['goog.dom.browserrange.IeRange'],
    [
        'goog.array',
        'goog.dom',
...
goog.addDependency(
    'dom/browserrange/operarange.js',
    ['goog.dom.browserrange.OperaRange'],
    ['goog.dom.browserrange.W3cRange'],
    false,
);
goog.addDependency(
    'dom/browserrange/w3crange.js',
    ['goog.dom.browserrange.W3cRange'],
    [
        'goog.array',
        'goog.dom',
...
goog.addDependency(
    'dom/browserrange/webkitrange.js',
    ['goog.dom.browserrange.WebKitRange'],
    [
        'goog.dom.RangeEndpoint',
        'goog.dom.browserrange.W3cRange',
...
goog.addDependency(
    'dom/bufferedviewportsizemonitor.js',
...
goog.addDependency(
    'dom/bufferedviewportsizemonitor_test.js',
...
goog.addDependency(
    ...
    ['goog.dom', 'goog.dom.TagName', 'goog.dom.classes', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'dom/classlist.js',
...
goog.addDependency(
    'dom/controlrange.js',
    ['goog.dom.ControlRange', 'goog.dom.ControlRangeIterator'],
    [
        'goog.array',
        'goog.dom',
        'goog.dom.AbstractMultiRange',
...
goog.addDependency(
    'dom/dataset.js',
    ['goog.dom.dataset'],
    ['goog.string', 'goog.userAgent.product'],
    false,
);
goog.addDependency(
    'dom/dataset_test.js',
    ['goog.dom.datasetTest'],
    ['goog.dom', 'goog.dom.dataset', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'dom/dom.js',
    ['goog.dom', 'goog.dom.Appendable', 'goog.dom.DomHelper'],
    [
        'goog.array',
        'goog.asserts',
        'goog.dom.BrowserFeature',
...
goog.addDependency(
    'dom/fontsizemonitor.js',
    ['goog.dom.FontSizeMonitor', 'goog.dom.FontSizeMonitor.EventType'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.events',
...
goog.addDependency(
    'dom/forms.js',
    ['goog.dom.forms'],
    ['goog.dom.InputType', 'goog.dom.TagName', 'goog.structs.Map'],
    false,
);
goog.addDependency(
    'dom/forms_test.js',
    ['goog.dom.formsTest'],
    ['goog.dom', 'goog.dom.forms', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'dom/fullscreen.js',
    ['goog.dom.fullscreen', 'goog.dom.fullscreen.EventType'],
    ['goog.dom', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'dom/fullscreen_test.js',
    ['goog.dom.fullscreen_test'],
    [
        'goog.dom.DomHelper',
        'goog.dom.fullscreen',
        'goog.testing.PropertyReplacer',
...
goog.addDependency(
    'dom/inputtype_test.js',
    ['goog.dom.InputTypeTest'],
    ['goog.dom.InputType', 'goog.object'],
    false,
);
goog.addDependency(
    'dom/iter.js',
    ...
    ['goog.iter.Iterator', 'goog.iter.StopIteration'],
    false,
);
goog.addDependency(
    'dom/iter_test.js',
...
goog.addDependency(
    'dom/multirange.js',
    ['goog.dom.MultiRange', 'goog.dom.MultiRangeIterator'],
    [
        'goog.array',
        'goog.dom.AbstractMultiRange',
        'goog.dom.AbstractRange',
...
goog.addDependency(
    'dom/nodeoffset.js',
    ['goog.dom.NodeOffset'],
    ['goog.Disposable', 'goog.dom.TagName'],
    false,
);
goog.addDependency(
    'dom/nodeoffset_test.js',
...
goog.addDependency(
    'dom/pattern/abstractpattern.js',
    ['goog.dom.pattern.AbstractPattern'],
    ['goog.dom.pattern.MatchType'],
    false,
);
goog.addDependency(
    'dom/pattern/allchildren.js',
    ['goog.dom.pattern.AllChildren'],
    ['goog.dom.pattern.AbstractPattern', 'goog.dom.pattern.MatchType'],
    false,
);
goog.addDependency(
    'dom/pattern/callback/callback.js',
    ['goog.dom.pattern.callback'],
    ['goog.dom', 'goog.dom.TagWalkType', 'goog.iter'],
    false,
);
goog.addDependency(
    'dom/pattern/callback/counter.js',
    ['goog.dom.pattern.callback.Counter'],
    [],
    false,
);
goog.addDependency(
    'dom/pattern/callback/test.js',
    ['goog.dom.pattern.callback.Test'],
    ['goog.iter.StopIteration'],
    false,
);
goog.addDependency(
    'dom/pattern/childmatches.js',
    ['goog.dom.pattern.ChildMatches'],
    ['goog.dom.pattern.AllChildren', 'goog.dom.pattern.MatchType'],
    false,
);
goog.addDependency(
    'dom/pattern/endtag.js',
    ['goog.dom.pattern.EndTag'],
    ['goog.dom.TagWalkType', 'goog.dom.pattern.Tag'],
    false,
);
goog.addDependency(
    'dom/pattern/fulltag.js',
...
goog.addDependency(
    'dom/pattern/matcher.js',
    ['goog.dom.pattern.Matcher'],
    ['goog.dom.TagIterator', 'goog.dom.pattern.MatchType', 'goog.iter'],
    false,
);
goog.addDependency(
    'dom/pattern/matcher_test.js',
...
goog.addDependency(
    'dom/pattern/nodetype.js',
    ['goog.dom.pattern.NodeType'],
    ['goog.dom.pattern.AbstractPattern', 'goog.dom.pattern.MatchType'],
    false,
);
goog.addDependency(
    'dom/pattern/pattern.js',
    ['goog.dom.pattern', 'goog.dom.pattern.MatchType'],
    [],
    false,
);
goog.addDependency(
    'dom/pattern/pattern_test.js',
...
goog.addDependency(
    'dom/savedrange.js',
    ['goog.dom.SavedRange'],
    ['goog.Disposable', 'goog.log'],
    false,
);
goog.addDependency(
    'dom/savedrange_test.js',
    ['goog.dom.SavedRangeTest'],
    ['goog.dom', 'goog.dom.Range', 'goog.testing.jsunit', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'dom/selection.js',
    ['goog.dom.selection'],
    ['goog.dom.InputType', 'goog.string', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'dom/selection_test.js',
...
goog.addDependency(
    'dom/tagiterator.js',
    ['goog.dom.TagIterator', 'goog.dom.TagWalkType'],
    [
        'goog.dom',
        'goog.dom.NodeType',
        'goog.iter.Iterator',
...
goog.addDependency(
    ...
    ['goog.dom.TagName', 'goog.object', 'goog.testing.jsunit'],
    false,
);
...
goog.addDependency(
    'dom/tags_test.js',
    ['goog.dom.tagsTest'],
    ['goog.dom.tags', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'dom/textrange.js',
...
goog.addDependency(
    'dom/viewportsizemonitor_test.js',
...
goog.addDependency(
    'dom/xml.js',
    ['goog.dom.xml'],
    ['goog.dom', 'goog.dom.NodeType', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'dom/xml_test.js',
...
goog.addDependency(
    'editor/clicktoeditwrapper_test.js',
...
goog.addDependency(
    'editor/contenteditablefield.js',
    ['goog.editor.ContentEditableField'],
    ['goog.asserts', 'goog.editor.Field', 'goog.log'],
    false,
);
goog.addDependency(
    'editor/contenteditablefield_test.js',
...
goog.addDependency(
    'editor/field.js',
    ['goog.editor.Field', 'goog.editor.Field.EventType'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.array',
...
goog.addDependency(
    ...
    ['goog.dom', 'goog.editor.BrowserFeature', 'goog.style', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'editor/icontent_test.js',
...
goog.addDependency(
    'editor/plugins/abstractbubbleplugin.js',
...
goog.addDependency(
    'editor/plugins/abstractbubbleplugin_test.js',
...
goog.addDependency(
    'editor/plugins/abstractdialogplugin.js',
    [
        'goog.editor.plugins.AbstractDialogPlugin',
...
goog.addDependency(
    'editor/plugins/abstractdialogplugin_test.js',
...
goog.addDependency(
    'editor/plugins/abstracttabhandler.js',
    ['goog.editor.plugins.AbstractTabHandler'],
    ['goog.editor.Plugin', 'goog.events.KeyCodes', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'editor/plugins/abstracttabhandler_test.js',
...
goog.addDependency(
    'editor/plugins/basictextformatter.js',
    [
...
goog.addDependency(
    'editor/plugins/basictextformatter_test.js',
...
goog.addDependency(
    'editor/plugins/blockquote_test.js',
...
goog.addDependency(
    'editor/plugins/emoticons_test.js',
...
goog.addDependency(
    'editor/plugins/enterhandler.js',
...
goog.addDependency(
    'editor/plugins/enterhandler_test.js',
...
goog.addDependency(
    'editor/plugins/firststrong_test.js',
...
goog.addDependency(
    'editor/plugins/headerformatter.js',
    ['goog.editor.plugins.HeaderFormatter'],
    ['goog.editor.Command', 'goog.editor.Plugin', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'editor/plugins/headerformatter_test.js',
...
goog.addDependency(
    'editor/plugins/linkbubble.js',
    ['goog.editor.plugins.LinkBubble', 'goog.editor.plugins.LinkBubble.Action'],
    [
        'goog.array',
        'goog.dom',
        'goog.dom.TagName',
...
goog.addDependency(
    'editor/plugins/linkbubble_test.js',
...
goog.addDependency(
    'editor/plugins/linkdialogplugin.js',
...
goog.addDependency(
    'editor/plugins/linkdialogplugin_test.js',
    ['goog.ui.editor.plugins.LinkDialogTest'],
    [
        'goog.dom',
        'goog.dom.DomHelper',
        'goog.dom.NodeType',
...
goog.addDependency(
    'editor/plugins/linkshortcutplugin.js',
    ['goog.editor.plugins.LinkShortcutPlugin'],
    ['goog.editor.Command', 'goog.editor.Plugin'],
    false,
);
goog.addDependency(
    'editor/plugins/linkshortcutplugin_test.js',
...
goog.addDependency(
    'editor/plugins/listtabhandler.js',
...
goog.addDependency(
    'editor/plugins/listtabhandler_test.js',
...
goog.addDependency(
    'editor/plugins/loremipsum_test.js',
...
goog.addDependency(
    'editor/plugins/removeformatting.js',
...
goog.addDependency(
    'editor/plugins/removeformatting_test.js',
...
goog.addDependency(
    'editor/plugins/spacestabhandler.js',
...
goog.addDependency(
    'editor/plugins/spacestabhandler_test.js',
...
goog.addDependency(
    'editor/plugins/tableeditor_test.js',
...
goog.addDependency(
    'editor/plugins/tagonenterhandler.js',
...
goog.addDependency(
    'editor/plugins/tagonenterhandler_test.js',
...
goog.addDependency(
    'editor/plugins/undoredo_test.js',
...
goog.addDependency(
    'editor/plugins/undoredomanager.js',
    [
        'goog.editor.plugins.UndoRedoManager',
...
goog.addDependency(
    'editor/plugins/undoredomanager_test.js',
...
goog.addDependency(
    'editor/plugins/undoredostate.js',
    ['goog.editor.plugins.UndoRedoState'],
    ['goog.events.EventTarget'],
    false,
);
goog.addDependency(
    'editor/plugins/undoredostate_test.js',
    ['goog.editor.plugins.UndoRedoStateTest'],
    ['goog.editor.plugins.UndoRedoState', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'editor/range.js',
    ['goog.editor.range', 'goog.editor.range.Point'],
    [
        'goog.array',
        'goog.dom',
        'goog.dom.NodeType',
...
goog.addDependency(
    'editor/table.js',
    ['goog.editor.Table', 'goog.editor.TableCell', 'goog.editor.TableRow'],
    [
        'goog.dom',
        'goog.dom.DomHelper',
        'goog.dom.NodeType',
...
goog.addDependency(
    'events/actioneventwrapper_test.js',
...
goog.addDependency(
    ...
    ['goog.events.BrowserEvent', 'goog.events.BrowserEvent.MouseButton'],
    [
...
goog.addDependency(
    'events/event.js',
    ['goog.events.Event', 'goog.events.EventLike'],
    ['goog.Disposable', 'goog.events.EventId'],
    false,
);
goog.addDependency(
    'events/event_test.js',
...
goog.addDependency(
    ...
    ['goog.events.EventHandler'],
    ['goog.Disposable', 'goog.events', 'goog.object'],
    false,
);
goog.addDependency(
    'events/eventhandler_test.js',
...
goog.addDependency(
    'events/eventtarget_via_googevents_test.js',
...
goog.addDependency(
    'events/eventtarget_via_w3cinterface_test.js',
...
goog.addDependency(
    'events/filedrophandler.js',
    ['goog.events.FileDropHandler', 'goog.events.FileDropHandler.EventType'],
    [
        'goog.array',
        'goog.dom',
        'goog.events.BrowserEvent',
...
goog.addDependency(
    'events/filedrophandler_test.js',
...
goog.addDependency(
    ...
    ['goog.events.FocusHandler', 'goog.events.FocusHandler.EventType'],
    [
        'goog.events',
        'goog.events.BrowserEvent',
        'goog.events.EventTarget',
...
goog.addDependency(
    ...
    ['goog.events.InputHandler', 'goog.events.InputHandler.EventType'],
    [
        'goog.Timer',
        'goog.dom.TagName',
        'goog.events.BrowserEvent',
...
goog.addDependency(
    ...
    ['goog.events.Listenable', 'goog.events.ListenableKey'],
    ['goog.events.EventId'],
    false,
);
goog.addDependency(
    'events/listenable_test.js',
    ['goog.events.ListenableTest'],
    ['goog.events.Listenable', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'events/listener.js',
...
goog.addDependency(
    ...
    ['goog.events.ListenerMap'],
    ['goog.array', 'goog.events.Listener', 'goog.object'],
    false,
);
goog.addDependency(
    'events/listenermap_test.js',
...
goog.addDependency(
    'events/mousewheelhandler_test.js',
...
goog.addDependency(
    'events/onlinehandler.js',
    ['goog.events.OnlineHandler', 'goog.events.OnlineHandler.EventType'],
    [
        'goog.Timer',
        'goog.events.BrowserFeature',
        'goog.events.EventHandler',
...
goog.addDependency(
    'events/wheelhandler_test.js',
    ['goog.events.WheelHandlerTest'],
    [
        'goog.dom',
        'goog.events',
        'goog.events.BrowserEvent',
...
goog.addDependency(
    'format/emailaddress.js',
    ['goog.format.EmailAddress'],
    ['goog.string'],
    false,
);
goog.addDependency(
    'format/emailaddress_test.js',
    ['goog.format.EmailAddressTest'],
    ['goog.array', 'goog.format.EmailAddress', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'format/format.js',
    ['goog.format'],
    ['goog.i18n.GraphemeBreak', 'goog.string', 'goog.userAgent'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'format/htmlprettyprinter.js',
    ['goog.format.HtmlPrettyPrinter', 'goog.format.HtmlPrettyPrinter.Buffer'],
    ['goog.dom.TagName', 'goog.object', 'goog.string.StringBuffer'],
    false,
);
goog.addDependency(
    'format/htmlprettyprinter_test.js',
...
goog.addDependency(
    'format/internationalizedemailaddress.js',
    ['goog.format.InternationalizedEmailAddress'],
    ['goog.format.EmailAddress', 'goog.string'],
    false,
);
goog.addDependency(
    'format/internationalizedemailaddress_test.js',
...
goog.addDependency(
    'format/jsonprettyprinter_test.js',
    ['goog.format.JsonPrettyPrinterTest'],
    ['goog.format.JsonPrettyPrinter', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'fs/entry.js',
...
goog.addDependency(
    'fs/error.js',
    ['goog.fs.Error', 'goog.fs.Error.ErrorCode'],
    ['goog.debug.Error', 'goog.object', 'goog.string'],
    false,
);
goog.addDependency(
    'fs/filereader.js',
...
goog.addDependency(
    ...
    ['goog.events.EventTarget', 'goog.fs.Error', 'goog.fs.ProgressEvent'],
    false,
);
goog.addDependency('fs/filesystem.js', ['goog.fs.FileSystem'], [], false);
goog.addDependency(
    'fs/filesystemimpl.js',
    ['goog.fs.FileSystemImpl'],
    ['goog.fs.DirectoryEntryImpl', 'goog.fs.FileSystem'],
    false,
);
goog.addDependency(
    'fs/filewriter.js',
    ['goog.fs.FileWriter'],
    ['goog.fs.Error', 'goog.fs.FileSaver'],
    false,
);
goog.addDependency(
    'fs/fs.js',
...
goog.addDependency(
    'fs/url_test.js',
    ['goog.urlTest'],
    ['goog.fs.url', 'goog.testing.PropertyReplacer', 'goog.testing.jsunit'],
    false,
);
goog.addDependency('functions/functions.js', ['goog.functions'], [], false);
goog.addDependency(
    'functions/functions_test.js',
    ['goog.functionsTest'],
    [
        'goog.array',
        'goog.functions',
...
goog.addDependency(
    'fx/anim/anim.js',
    ['goog.fx.anim', 'goog.fx.anim.Animated'],
    ['goog.async.AnimationDelay', 'goog.async.Delay', 'goog.object'],
    false,
);
goog.addDependency(
    'fx/anim/anim_test.js',
    ['goog.fx.animTest'],
    [
        'goog.async.AnimationDelay',
        'goog.async.Delay',
...
goog.addDependency(
    'fx/cssspriteanimation.js',
    ['goog.fx.CssSpriteAnimation'],
    ['goog.fx.Animation'],
    false,
);
goog.addDependency(
    'fx/cssspriteanimation_test.js',
...
goog.addDependency(
    'fx/dragdrop.js',
    ['goog.fx.DragDrop'],
    ['goog.fx.AbstractDragDrop', 'goog.fx.DragDropItem'],
    false,
);
goog.addDependency(
    'fx/dragdropgroup.js',
    ['goog.fx.DragDropGroup'],
    ['goog.dom', 'goog.fx.AbstractDragDrop', 'goog.fx.DragDropItem'],
    false,
);
goog.addDependency(
    'fx/dragdropgroup_test.js',
    ['goog.fx.DragDropGroupTest'],
    ['goog.events', 'goog.fx.DragDropGroup', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'fx/dragger.js',
    ['goog.fx.DragEvent', 'goog.fx.Dragger', 'goog.fx.Dragger.EventType'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.events',
...
goog.addDependency(
    'fx/easing_test.js',
    ['goog.fx.easingTest'],
    ['goog.fx.easing', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'fx/fx.js',
...
goog.addDependency(
    'fx/transition.js',
    ['goog.fx.Transition', 'goog.fx.Transition.EventType'],
    [],
    false,
);
goog.addDependency(
    'fx/transitionbase.js',
    ['goog.fx.TransitionBase', 'goog.fx.TransitionBase.State'],
    ['goog.events.EventTarget', 'goog.fx.Transition'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'graphics/canvasgraphics_test.js',
    ['goog.graphics.CanvasGraphicsTest'],
    [
        'goog.dom',
        'goog.graphics.CanvasGraphics',
        'goog.graphics.SolidFill',
...
goog.addDependency(
    'graphics/ellipseelement.js',
    ['goog.graphics.EllipseElement'],
    ['goog.graphics.StrokeAndFillElement'],
    false,
);
goog.addDependency(
    'graphics/ext/coordinates.js',
    ['goog.graphics.ext.coordinates'],
    ['goog.string'],
    false,
);
goog.addDependency(
    'graphics/ext/element.js',
...
goog.addDependency(
    'graphics/ext/group.js',
    ['goog.graphics.ext.Group'],
    ['goog.array', 'goog.graphics.ext.Element'],
    false,
);
goog.addDependency(
    'graphics/ext/image.js',
    ['goog.graphics.ext.Image'],
    ['goog.graphics.ext.Element'],
    false,
);
goog.addDependency(
    'graphics/ext/path.js',
    ['goog.graphics.ext.Path'],
    ['goog.graphics.AffineTransform', 'goog.graphics.Path', 'goog.math.Rect'],
    false,
);
goog.addDependency(
    'graphics/ext/rectangle.js',
    ['goog.graphics.ext.Rectangle'],
    ['goog.graphics.ext.StrokeAndFillElement'],
    false,
);
goog.addDependency(
    'graphics/ext/shape.js',
    ['goog.graphics.ext.Shape'],
    ['goog.graphics.ext.StrokeAndFillElement'],
    false,
);
goog.addDependency(
    'graphics/ext/strokeandfillelement.js',
    ['goog.graphics.ext.StrokeAndFillElement'],
    ['goog.graphics.ext.Element'],
    false,
);
...
goog.addDependency(
    'graphics/lineargradient.js',
    ['goog.graphics.LinearGradient'],
    ['goog.asserts', 'goog.graphics.Fill'],
    false,
);
goog.addDependency(
    'graphics/path.js',
    ['goog.graphics.Path', 'goog.graphics.Path.Segment'],
    ['goog.array', 'goog.math'],
    false,
);
goog.addDependency(
    'graphics/pathelement.js',
    ['goog.graphics.PathElement'],
    ['goog.graphics.StrokeAndFillElement'],
    false,
);
goog.addDependency(
    'graphics/paths.js',
    ['goog.graphics.paths'],
    ['goog.graphics.Path', 'goog.math.Coordinate'],
    false,
);
goog.addDependency(
    'graphics/rectelement.js',
    ['goog.graphics.RectElement'],
    ['goog.graphics.StrokeAndFillElement'],
    false,
);
goog.addDependency(
    'graphics/solidfill.js',
    ['goog.graphics.SolidFill'],
    ['goog.graphics.Fill'],
    false,
);
...
goog.addDependency(
    'graphics/strokeandfillelement.js',
    ['goog.graphics.StrokeAndFillElement'],
    ['goog.graphics.Element'],
    false,
);
...
goog.addDependency(
    'graphics/textelement.js',
    ['goog.graphics.TextElement'],
    ['goog.graphics.StrokeAndFillElement'],
    false,
);
goog.addDependency(
    'graphics/vmlelement.js',
    [
...
goog.addDependency(
    'history/event.js',
    ['goog.history.Event'],
    ['goog.events.Event', 'goog.history.EventType'],
    false,
);
goog.addDependency(
    'history/eventtype.js',
...
goog.addDependency(
    'history/history.js',
    ['goog.History', 'goog.History.Event', 'goog.History.EventType'],
    [
        'goog.Timer',
        'goog.asserts',
        'goog.dom',
...
goog.addDependency(
    'history/html5history.js',
    ['goog.history.Html5History', 'goog.history.Html5History.TokenTransformer'],
    [
        'goog.asserts',
        'goog.events',
        'goog.events.EventTarget',
...
goog.addDependency(
    'history/html5history_test.js',
    ['goog.history.Html5HistoryTest'],
    [
        'goog.Timer',
        'goog.events',
        'goog.events.EventType',
...
goog.addDependency(
    'html/flash.js',
    ['goog.html.flash'],
    ['goog.asserts', 'goog.html.SafeHtml'],
    false,
);
goog.addDependency(
    'html/flash_test.js',
...
goog.addDependency(
    'html/legacyconversions_test.js',
...
goog.addDependency(
    ...
    ['goog.asserts', 'goog.string.Const', 'goog.string.TypedString'],
    false,
);
goog.addDependency(
    'html/safescript_test.js',
    ['goog.html.safeScriptTest'],
    ['goog.html.SafeScript', 'goog.string.Const', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'html/safestyle.js',
...
goog.addDependency(
    'html/safestyle_test.js',
    ['goog.html.safeStyleTest'],
    ['goog.html.SafeStyle', 'goog.string.Const', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'html/safestylesheet_test.js',
    ['goog.html.safeStyleSheetTest'],
    [
        'goog.html.SafeStyleSheet',
        'goog.string',
        'goog.string.Const',
...
goog.addDependency(
    'html/silverlight_test.js',
    ['goog.html.silverlightTest'],
    [
        'goog.html.SafeHtml',
        'goog.html.TrustedResourceUrl',
        'goog.html.silverlight',
...
goog.addDependency(
    'html/trustedresourceurl_test.js',
...
goog.addDependency(
    'html/uncheckedconversions_test.js',
...
goog.addDependency(
    'i18n/bidi_test.js',
    ['goog.i18n.bidiTest'],
    ['goog.i18n.bidi', 'goog.i18n.bidi.Dir', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'i18n/bidiformatter.js',
...
goog.addDependency(
    'i18n/bidiformatter_test.js',
    ['goog.i18n.BidiFormatterTest'],
    [
        'goog.html.SafeHtml',
        'goog.i18n.BidiFormatter',
        'goog.i18n.bidi.Dir',
...
goog.addDependency(
    ...
    ['goog.array', 'goog.i18n.uChar'],
    false,
);
goog.addDependency(
    'i18n/charlistdecompressor_test.js',
    ['goog.i18n.CharListDecompressorTest'],
    ['goog.i18n.CharListDecompressor', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'i18n/charpickerdata.js',
...
goog.addDependency(
    'i18n/collation_test.js',
    ['goog.i18n.collationTest'],
    [
        'goog.i18n.collation',
        'goog.testing.ExpectedFailures',
        'goog.testing.jsunit',
...
goog.addDependency(
    'i18n/currency_test.js',
    ['goog.i18n.currencyTest'],
    [
...
goog.addDependency(
    'i18n/currencycodemap.js',
    ['goog.i18n.currencyCodeMap', 'goog.i18n.currencyCodeMapTier2'],
    [],
    false,
);
goog.addDependency(
    'i18n/datetimeformat.js',
    ['goog.i18n.DateTimeFormat', 'goog.i18n.DateTimeFormat.Format'],
    [
        'goog.asserts',
        'goog.date',
        'goog.i18n.DateTimeSymbols',
...
goog.addDependency(
    'i18n/datetimeformat_test.js',
    ['goog.i18n.DateTimeFormatTest'],
    [
        'goog.date.Date',
        'goog.date.DateTime',
        'goog.i18n.DateTimeFormat',
...
goog.addDependency(
    'i18n/datetimeparse.js',
    ['goog.i18n.DateTimeParse'],
    ['goog.date', 'goog.i18n.DateTimeFormat', 'goog.i18n.DateTimeSymbols'],
    false,
);
goog.addDependency(
    'i18n/datetimeparse_test.js',
    ['goog.i18n.DateTimeParseTest'],
    [
        'goog.date.Date',
        'goog.i18n.DateTimeFormat',
        'goog.i18n.DateTimeParse',
...
goog.addDependency(
    ...
    [
        ...
        'goog.i18n.DateTimeSymbols_bm_Latn',
        'goog.i18n.DateTimeSymbols_bm_Latn_ML',
        'goog.i18n.DateTimeSymbols_bn_BD',
        ...
        'goog.i18n.DateTimeSymbols_ca_ES_VALENCIA',
        ...
        'goog.i18n.DateTimeSymbols_eo_001',
        ...
        'goog.i18n.DateTimeSymbols_ky_Cyrl_KG',
        ...
        'goog.i18n.DateTimeSymbols_ug_Arab',
        'goog.i18n.DateTimeSymbols_ug_Arab_CN',
...
goog.addDependency(
    'i18n/graphemebreak.js',
    ['goog.i18n.GraphemeBreak'],
    ['goog.structs.InversionMap'],
    false,
);
goog.addDependency(
    'i18n/graphemebreak_test.js',
    ['goog.i18n.GraphemeBreakTest'],
    ['goog.i18n.GraphemeBreak', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'i18n/messageformat_test.js',
    ['goog.i18n.MessageFormatTest'],
    [
        'goog.i18n.MessageFormat',
...
goog.addDependency(
    'i18n/mime.js',
    ['goog.i18n.mime', 'goog.i18n.mime.encode'],
    ['goog.array'],
    false,
);
goog.addDependency(
    ...
    ['goog.i18n.mime.encode', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'i18n/numberformat.js',
    [
        'goog.i18n.NumberFormat',
...
goog.addDependency(
    'i18n/numberformat_test.js',
    ['goog.i18n.NumberFormatTest'],
    [
        'goog.i18n.CompactNumberFormatSymbols',
        'goog.i18n.CompactNumberFormatSymbols_de',
        'goog.i18n.CompactNumberFormatSymbols_en',
...
goog.addDependency(
    ...
    [
        ...
        'goog.i18n.NumberFormatSymbols_ca_ES_VALENCIA',
        ...
        'goog.i18n.NumberFormatSymbols_ky_Cyrl_KG',
...
goog.addDependency(
    ...
    [
        ...
        'goog.i18n.NumberFormatSymbols_bm_Latn_ML',
        ...
        'goog.i18n.NumberFormatSymbols_eo_001',
        ...
        'goog.i18n.NumberFormatSymbols_ug_Arab_CN',
...
goog.addDependency(
    'i18n/pluralrules_test.js',
    ['goog.i18n.pluralRulesTest'],
    ['goog.i18n.pluralRules', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'i18n/timezone.js',
    ['goog.i18n.TimeZone'],
    ['goog.array', 'goog.date.DateLike', 'goog.object', 'goog.string'],
    false,
);
goog.addDependency(
    'i18n/timezone_test.js',
    ['goog.i18n.TimeZoneTest'],
    ['goog.i18n.TimeZone', 'goog.testing.jsunit'],
    false,
);
goog.addDependency('i18n/uchar.js', ['goog.i18n.uChar'], [], false);
goog.addDependency(
    'i18n/uchar/localnamefetcher.js',
    ['goog.i18n.uChar.LocalNameFetcher'],
    ['goog.i18n.uChar.NameFetcher', 'goog.i18n.uCharNames', 'goog.log'],
    false,
);
goog.addDependency(
    'i18n/uchar/localnamefetcher_test.js',
...
goog.addDependency(
    'i18n/uchar/namefetcher.js',
    ['goog.i18n.uChar.NameFetcher'],
    [],
    false,
);
goog.addDependency(
    'i18n/uchar/remotenamefetcher.js',
...
goog.addDependency(
    'i18n/uchar/remotenamefetcher_test.js',
...
goog.addDependency(
    'i18n/uchar_test.js',
    ['goog.i18n.uCharTest'],
    ['goog.i18n.uChar', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'i18n/ucharnames.js',
...
goog.addDependency(
    'i18n/ucharnames_test.js',
    ['goog.i18n.uCharNamesTest'],
    ['goog.i18n.uCharNames', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'iter/iter.js',
    ...
    ['goog.array', 'goog.asserts', 'goog.functions', 'goog.math'],
    false,
);
goog.addDependency(
    'iter/iter_test.js',
...
goog.addDependency(
    'json/evaljsonprocessor.js',
    ['goog.json.EvalJsonProcessor'],
    ['goog.json', 'goog.json.Processor', 'goog.json.Serializer'],
    false,
);
goog.addDependency(
    'json/hybrid.js',
    ['goog.json.hybrid'],
    ['goog.asserts', 'goog.json'],
    false,
);
goog.addDependency(
    'json/hybrid_test.js',
...
goog.addDependency(
    'json/hybridjsonprocessor.js',
    ['goog.json.HybridJsonProcessor'],
    ['goog.json.Processor', 'goog.json.hybrid'],
    false,
);
goog.addDependency(
    'json/hybridjsonprocessor_test.js',
...
goog.addDependency(
    'json/json_test.js',
    ['goog.jsonTest'],
    ['goog.functions', 'goog.json', 'goog.testing.jsunit', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'json/nativejsonprocessor.js',
    ['goog.json.NativeJsonProcessor'],
    ['goog.asserts', 'goog.json.Processor'],
    false,
);
goog.addDependency(
    'json/processor.js',
    ['goog.json.Processor'],
    ['goog.string.Parser', 'goog.string.Stringifier'],
    false,
);
goog.addDependency(
    'json/processor_test.js',
...
goog.addDependency(
    'labs/dom/pagevisibilitymonitor.js',
    [
...
goog.addDependency(
    'labs/dom/pagevisibilitymonitor_test.js',
    ['goog.labs.dom.PageVisibilityMonitorTest'],
    [
        'goog.events',
        'goog.functions',
        'goog.labs.dom.PageVisibilityMonitor',
...
goog.addDependency(
    'labs/events/nondisposableeventtarget.js',
...
goog.addDependency(
    'labs/events/nondisposableeventtarget_test.js',
    ['goog.labs.events.NonDisposableEventTargetTest'],
    [
        'goog.events.Listenable',
        'goog.events.eventTargetTester',
        'goog.events.eventTargetTester.KeyType',
...
goog.addDependency(
    'labs/events/nondisposableeventtarget_via_googevents_test.js',
    ['goog.labs.events.NonDisposableEventTargetGoogEventsTest'],
    [
        'goog.events',
        'goog.events.eventTargetTester',
        'goog.events.eventTargetTester.KeyType',
...
goog.addDependency(
    'labs/events/touch.js',
    ['goog.labs.events.touch', 'goog.labs.events.touch.TouchData'],
    ['goog.array', 'goog.asserts', 'goog.events.EventType', 'goog.string'],
    false,
);
goog.addDependency(
    'labs/events/touch_test.js',
    ['goog.labs.events.touchTest'],
    ['goog.labs.events.touch', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'labs/format/csv.js',
...
goog.addDependency(
    'labs/format/csv_test.js',
    ['goog.labs.format.csvTest'],
    [
        'goog.labs.format.csv',
        'goog.labs.format.csv.ParseError',
        'goog.object',
...
goog.addDependency(
    'labs/html/attribute_rewriter.js',
    [
...
goog.addDependency(
    'labs/i18n/listformat_test.js',
    ['goog.labs.i18n.ListFormatTest'],
    [
        'goog.labs.i18n.GenderInfo',
        'goog.labs.i18n.ListFormat',
...
goog.addDependency(
    'labs/iterable/iterable.js',
    ['goog.labs.iterable'],
    [],
    true,
);
goog.addDependency(
    'labs/iterable/iterable_test.js',
    ['goog.labs.iterableTest'],
    [
        'goog.labs.iterable',
        'goog.testing.jsunit',
        'goog.testing.recordFunction',
...
goog.addDependency(
    'labs/mock/mock.js',
    ['goog.labs.mock', 'goog.labs.mock.VerificationError'],
    [
        'goog.array',
        'goog.asserts',
        'goog.debug',
...
goog.addDependency(
    'labs/net/webchannel.js',
    ['goog.net.WebChannel'],
    ['goog.events', 'goog.events.Event'],
    false,
);
goog.addDependency(
    'labs/net/webchannel/basetestchannel.js',
...
goog.addDependency(
    'labs/net/webchannel/channel.js',
    ['goog.labs.net.webChannel.Channel'],
    [],
    false,
);
goog.addDependency(
    'labs/net/webchannel/channelrequest.js',
    ['goog.labs.net.webChannel.ChannelRequest'],
    [
        'goog.Timer',
        'goog.async.Throttle',
...
goog.addDependency(
    'labs/net/webchannel/channelrequest_test.js',
    ['goog.labs.net.webChannel.channelRequestTest'],
    [
        'goog.Uri',
        'goog.functions',
        'goog.labs.net.webChannel.ChannelRequest',
...
goog.addDependency(
    'labs/net/webchannel/connectionstate.js',
    ['goog.labs.net.webChannel.ConnectionState'],
    [],
    false,
);
goog.addDependency(
    'labs/net/webchannel/forwardchannelrequestpool.js',
    ['goog.labs.net.webChannel.ForwardChannelRequestPool'],
    ['goog.array', 'goog.string', 'goog.structs.Set'],
    false,
);
goog.addDependency(
    'labs/net/webchannel/forwardchannelrequestpool_test.js',
    ['goog.labs.net.webChannel.forwardChannelRequestPoolTest'],
    [
        'goog.labs.net.webChannel.ChannelRequest',
        'goog.labs.net.webChannel.ForwardChannelRequestPool',
        'goog.testing.PropertyReplacer',
...
goog.addDependency(
    ...
    ['goog.Uri', 'goog.labs.net.webChannel.WebChannelDebug'],
    false,
);
goog.addDependency(
    ...
    ['goog.events.Event', 'goog.events.EventTarget'],
    false,
);
goog.addDependency(
    'labs/net/webchannel/webchannelbase.js',
...
goog.addDependency(
    'labs/net/webchannel/webchannelbase_test.js',
    ['goog.labs.net.webChannel.webChannelBaseTest'],
    [
        'goog.Timer',
        'goog.array',
        'goog.dom',
...
goog.addDependency(
    'labs/net/webchannel/webchannelbasetransport.js',
    ['goog.labs.net.webChannel.WebChannelBaseTransport'],
    [
        'goog.asserts',
        'goog.events.EventTarget',
...
goog.addDependency(
    'labs/net/webchannel/webchannelbasetransport_test.js',
    ['goog.labs.net.webChannel.webChannelBaseTransportTest'],
    [
        'goog.events',
        'goog.functions',
        'goog.labs.net.webChannel.ChannelRequest',
...
goog.addDependency(
    'labs/net/webchannel/webchanneldebug.js',
    ['goog.labs.net.webChannel.WebChannelDebug'],
    ['goog.json', 'goog.log'],
    false,
);
goog.addDependency(
    'labs/net/webchannel/wire.js',
    ['goog.labs.net.webChannel.Wire'],
    [],
    false,
);
goog.addDependency(
    'labs/net/webchannel/wirev8.js',
    ['goog.labs.net.webChannel.WireV8'],
    [
        'goog.asserts',
        'goog.json',
...
goog.addDependency(
    'labs/net/webchannel/wirev8_test.js',
    ['goog.labs.net.webChannel.WireV8Test'],
    ['goog.labs.net.webChannel.WireV8', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'labs/net/webchanneltransport.js',
    ['goog.net.WebChannelTransport'],
    [],
    false,
);
goog.addDependency(
    'labs/net/webchanneltransportfactory.js',
...
goog.addDependency(
    'labs/net/xhr_test.js',
    ['goog.labs.net.xhrTest'],
    [
        'goog.Promise',
        'goog.labs.net.xhr',
...
goog.addDependency(
    'labs/object/object_test.js',
    ['goog.labs.objectTest'],
    ['goog.labs.object', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'labs/pubsub/broadcastpubsub.js',
...
goog.addDependency(
    'labs/pubsub/broadcastpubsub_test.js',
    ['goog.labs.pubsub.BroadcastPubSubTest'],
    [
        'goog.array',
        'goog.debug.Logger',
        'goog.json',
...
goog.addDependency(
    'labs/storage/boundedcollectablestorage.js',
...
goog.addDependency(
    'labs/storage/boundedcollectablestorage_test.js',
    ['goog.labs.storage.BoundedCollectableStorageTest'],
    [
        'goog.labs.storage.BoundedCollectableStorage',
...
goog.addDependency(
    ...
    ['goog.array', 'goog.asserts', 'goog.labs.object', 'goog.object'],
    false,
);
goog.addDependency(
    'labs/structs/map_perf.js',
...
goog.addDependency(
    'labs/structs/map_test.js',
    ['goog.labs.structs.MapTest'],
    [
        'goog.labs.structs.Map',
        'goog.testing.PropertyReplacer',
        'goog.testing.jsunit',
...
goog.addDependency(
    'labs/structs/multimap.js',
    ['goog.labs.structs.Multimap'],
    ['goog.array', 'goog.labs.object', 'goog.labs.structs.Map'],
    false,
);
goog.addDependency(
    'labs/structs/multimap_test.js',
    ['goog.labs.structs.MultimapTest'],
    [
        'goog.labs.structs.Map',
        'goog.labs.structs.Multimap',
        'goog.testing.jsunit',
...
goog.addDependency(
    'labs/style/pixeldensitymonitor.js',
    [
...
goog.addDependency(
    'labs/style/pixeldensitymonitor_test.js',
    ['goog.labs.style.PixelDensityMonitorTest'],
    [
        'goog.array',
        'goog.dom.DomHelper',
        'goog.events',
...
goog.addDependency(
    'labs/testing/assertthat.js',
    ['goog.labs.testing.MatcherError', 'goog.labs.testing.assertThat'],
    ['goog.debug.Error'],
    false,
);
goog.addDependency(
    'labs/testing/assertthat_test.js',
...
goog.addDependency(
    'labs/testing/decoratormatcher.js',
    ['goog.labs.testing.AnythingMatcher'],
    ['goog.labs.testing.Matcher'],
    false,
);
goog.addDependency(
    'labs/testing/decoratormatcher_test.js',
...
goog.addDependency(
    'labs/testing/dictionarymatcher.js',
    [
    ...
    ['goog.asserts', 'goog.labs.testing.Matcher', 'goog.object'],
    false,
);
goog.addDependency(
    'labs/testing/dictionarymatcher_test.js',
...
goog.addDependency(
    'labs/testing/environment_test.js',
...
goog.addDependency(
    'labs/testing/environment_usage_test.js',
    ['goog.labs.testing.environmentUsageTest'],
    ['goog.labs.testing.Environment'],
    false,
);
goog.addDependency(
    'labs/testing/logicmatcher.js',
    [
        'goog.labs.testing.AllOfMatcher',
        'goog.labs.testing.AnyOfMatcher',
        'goog.labs.testing.IsNotMatcher',
    ],
    ['goog.array', 'goog.labs.testing.Matcher'],
    false,
);
goog.addDependency(
    'labs/testing/logicmatcher_test.js',
...
goog.addDependency(
    'labs/testing/matcher.js',
    ['goog.labs.testing.Matcher'],
    [],
    false,
);
goog.addDependency(
    'labs/testing/numbermatcher.js',
    [
    ...
    ['goog.asserts', 'goog.labs.testing.Matcher'],
    false,
);
goog.addDependency(
    'labs/testing/numbermatcher_test.js',
...
goog.addDependency(
    'labs/testing/objectmatcher_test.js',
...
goog.addDependency(
    ...
    ['goog.asserts', 'goog.labs.testing.Matcher', 'goog.string'],
    false,
);
goog.addDependency(
    'labs/testing/stringmatcher_test.js',
...
goog.addDependency(
    ...
    ['goog.labs.userAgent.browser'],
    ['goog.array', 'goog.labs.userAgent.util', 'goog.object', 'goog.string'],
    false,
);
goog.addDependency(
    'labs/useragent/browser_test.js',
    ['goog.labs.userAgent.browserTest'],
    [
        'goog.labs.userAgent.browser',
...
goog.addDependency(
    'labs/useragent/device.js',
    ['goog.labs.userAgent.device'],
    ['goog.labs.userAgent.util'],
    false,
);
goog.addDependency(
    'labs/useragent/device_test.js',
    ['goog.labs.userAgent.deviceTest'],
    [
        'goog.labs.userAgent.device',
        'goog.labs.userAgent.testAgents',
        'goog.labs.userAgent.util',
...
goog.addDependency(
    ...
    ['goog.labs.userAgent.engine'],
    ['goog.array', 'goog.labs.userAgent.util', 'goog.string'],
    false,
);
goog.addDependency(
    'labs/useragent/engine_test.js',
    ['goog.labs.userAgent.engineTest'],
    [
        'goog.labs.userAgent.engine',
        'goog.labs.userAgent.testAgents',
        'goog.labs.userAgent.util',
...
goog.addDependency(
    ...
    ['goog.labs.userAgent.platform'],
    ['goog.labs.userAgent.util', 'goog.string'],
    false,
);
goog.addDependency(
    'labs/useragent/platform_test.js',
    ['goog.labs.userAgent.platformTest'],
    [
        'goog.labs.userAgent.platform',
        'goog.labs.userAgent.testAgents',
        'goog.labs.userAgent.util',
...
goog.addDependency(
    'labs/useragent/util_test.js',
    ['goog.labs.userAgent.utilTest'],
    [
        'goog.functions',
        'goog.labs.userAgent.testAgents',
        'goog.labs.userAgent.util',
...
goog.addDependency(
    'locale/countrylanguagenames_test.js',
    ['goog.locale.countryLanguageNamesTest'],
    ['goog.locale', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'locale/genericfontnames.js',
    ['goog.locale.genericFontNames'],
    [],
    false,
);
goog.addDependency(
    'locale/genericfontnames_test.js',
    ['goog.locale.genericFontNamesTest'],
    ['goog.locale.genericFontNames', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'locale/timezonedetection.js',
    ['goog.locale.timeZoneDetection'],
    ['goog.locale.TimeZoneFingerprint'],
    false,
);
goog.addDependency(
    'locale/timezonedetection_test.js',
    ['goog.locale.timeZoneDetectionTest'],
    ['goog.locale.timeZoneDetection', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'locale/timezonefingerprint.js',
    ['goog.locale.TimeZoneFingerprint'],
    [],
    false,
);
goog.addDependency(
    'locale/timezonelist.js',
    ['goog.locale.TimeZoneList'],
    ['goog.locale'],
    false,
);
goog.addDependency(
    'locale/timezonelist_test.js',
    ['goog.locale.TimeZoneListTest'],
    ['goog.locale', 'goog.locale.TimeZoneList', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'log/log.js',
    ['goog.log', 'goog.log.Level', 'goog.log.LogRecord', 'goog.log.Logger'],
    [
        'goog.debug',
        'goog.debug.LogManager',
        'goog.debug.LogRecord',
...
goog.addDependency(
    'math/affinetransform.js',
    ['goog.math.AffineTransform'],
    ['goog.math'],
    false,
);
goog.addDependency(
    'math/affinetransform_test.js',
...
goog.addDependency(
    'math/bezier.js',
    ['goog.math.Bezier'],
    ['goog.math', 'goog.math.Coordinate'],
    false,
);
goog.addDependency(
    'math/bezier_test.js',
...
goog.addDependency(
    'math/box_test.js',
    ['goog.math.BoxTest'],
    ['goog.math.Box', 'goog.math.Coordinate', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/coordinate.js',
...
goog.addDependency(
    'math/coordinate3_test.js',
    ['goog.math.Coordinate3Test'],
    ['goog.math.Coordinate3', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/coordinate_test.js',
    ['goog.math.CoordinateTest'],
    ['goog.math.Coordinate', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/exponentialbackoff.js',
    ['goog.math.ExponentialBackoff'],
    ['goog.asserts'],
    false,
);
goog.addDependency(
    'math/exponentialbackoff_test.js',
    ['goog.math.ExponentialBackoffTest'],
    ['goog.math.ExponentialBackoff', 'goog.testing.jsunit'],
    false,
);
goog.addDependency('math/integer.js', ['goog.math.Integer'], [], false);
goog.addDependency(
    'math/integer_test.js',
    ['goog.math.IntegerTest'],
    ['goog.math.Integer', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/interpolator/interpolator1.js',
    ['goog.math.interpolator.Interpolator1'],
    [],
    false,
);
goog.addDependency(
    'math/interpolator/linear1.js',
...
goog.addDependency(
    'math/interpolator/linear1_test.js',
    ['goog.math.interpolator.Linear1Test'],
    ['goog.math.interpolator.Linear1', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/interpolator/pchip1.js',
    ['goog.math.interpolator.Pchip1'],
    ['goog.math', 'goog.math.interpolator.Spline1'],
    false,
);
goog.addDependency(
    'math/interpolator/pchip1_test.js',
    ['goog.math.interpolator.Pchip1Test'],
    ['goog.math.interpolator.Pchip1', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/interpolator/spline1.js',
...
goog.addDependency(
    'math/interpolator/spline1_test.js',
    ['goog.math.interpolator.Spline1Test'],
    ['goog.math.interpolator.Spline1', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/line.js',
...
goog.addDependency(
    'math/line_test.js',
    ['goog.math.LineTest'],
    ['goog.math.Coordinate', 'goog.math.Line', 'goog.testing.jsunit'],
    false,
);
...
goog.addDependency(
    'math/long_test.js',
    ['goog.math.LongTest'],
    ['goog.math.Long', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/math.js',
...
goog.addDependency(
    'math/math_test.js',
    ['goog.mathTest'],
    ['goog.math', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/matrix.js',
    ['goog.math.Matrix'],
    ['goog.array', 'goog.math', 'goog.math.Size', 'goog.string'],
    false,
);
goog.addDependency(
    'math/matrix_test.js',
    ['goog.math.MatrixTest'],
    ['goog.math.Matrix', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/path.js',
    ['goog.math.Path', 'goog.math.Path.Segment'],
    ['goog.array', 'goog.math'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'math/paths.js',
    ['goog.math.paths'],
    ['goog.math.Coordinate', 'goog.math.Path'],
    false,
);
goog.addDependency(
    'math/paths_test.js',
    ['goog.math.pathsTest'],
    ['goog.math.Coordinate', 'goog.math.paths', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/range.js',
...
goog.addDependency(
    'math/range_test.js',
    ['goog.math.RangeTest'],
    ['goog.math.Range', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/rangeset.js',
...
goog.addDependency(
    'math/size_test.js',
    ['goog.math.SizeTest'],
    ['goog.math.Size', 'goog.testing.jsunit'],
    false,
);
...
goog.addDependency(
    'math/tdma_test.js',
    ['goog.math.tdmaTest'],
    ['goog.math.tdma', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/vec2.js',
...
goog.addDependency(
    'math/vec2_test.js',
    ['goog.math.Vec2Test'],
    ['goog.math.Vec2', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'math/vec3.js',
    ['goog.math.Vec3'],
    ['goog.math', 'goog.math.Coordinate3'],
    false,
);
goog.addDependency(
    'math/vec3_test.js',
    ['goog.math.Vec3Test'],
    ['goog.math.Coordinate3', 'goog.math.Vec3', 'goog.testing.jsunit'],
    false,
);
goog.addDependency('memoize/memoize.js', ['goog.memoize'], [], false);
goog.addDependency(
    'memoize/memoize_test.js',
    ['goog.memoizeTest'],
    ['goog.memoize', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'messaging/abstractchannel.js',
...
goog.addDependency(
    'messaging/abstractchannel_test.js',
...
goog.addDependency(
    'messaging/bufferedchannel_test.js',
...
goog.addDependency(
    'messaging/deferredchannel.js',
    ['goog.messaging.DeferredChannel'],
    ['goog.Disposable', 'goog.messaging.MessageChannel'],
    false,
);
goog.addDependency(
    'messaging/deferredchannel_test.js',
...
goog.addDependency(
    'messaging/loggerclient_test.js',
...
goog.addDependency(
    'messaging/loggerserver.js',
    ['goog.messaging.LoggerServer'],
    ['goog.Disposable', 'goog.log', 'goog.log.Level'],
    false,
);
goog.addDependency(
    'messaging/loggerserver_test.js',
...
goog.addDependency(
    'messaging/messaging_test.js',
    ['goog.testing.messaging.MockMessageChannelTest'],
    [
        'goog.messaging',
        'goog.testing.MockControl',
        'goog.testing.jsunit',
...
goog.addDependency(
    'messaging/multichannel_test.js',
...
goog.addDependency(
    'messaging/portnetwork.js',
    ['goog.messaging.PortNetwork'],
    [],
    false,
);
goog.addDependency(
    'messaging/portoperator.js',
...
goog.addDependency(
    'messaging/portoperator_test.js',
...
goog.addDependency(
    'messaging/respondingchannel.js',
    ['goog.messaging.RespondingChannel'],
    ['goog.Disposable', 'goog.log', 'goog.messaging.MultiChannel'],
    false,
);
goog.addDependency(
    'messaging/respondingchannel_test.js',
...
goog.addDependency(
    'messaging/testdata/portchannel_worker.js',
    ['goog.messaging.testdata.portchannel_worker'],
    ['goog.messaging.PortChannel'],
    false,
);
goog.addDependency(
    'messaging/testdata/portnetwork_worker1.js',
    ['goog.messaging.testdata.portnetwork_worker1'],
    ['goog.messaging.PortCaller', 'goog.messaging.PortChannel'],
    false,
);
goog.addDependency(
    'messaging/testdata/portnetwork_worker2.js',
    ['goog.messaging.testdata.portnetwork_worker2'],
    ['goog.messaging.PortCaller', 'goog.messaging.PortChannel'],
    false,
);
goog.addDependency(
    'module/abstractmoduleloader.js',
    ['goog.module.AbstractModuleLoader'],
    ['goog.module'],
    false,
);
goog.addDependency(
    'module/basemodule.js',
    ['goog.module.BaseModule'],
    ['goog.Disposable', 'goog.module'],
    false,
);
goog.addDependency(
    'module/loader.js',
...
goog.addDependency(
    'module/moduleloadcallback.js',
    ['goog.module.ModuleLoadCallback'],
    ['goog.debug.entryPointRegistry', 'goog.module'],
    false,
);
goog.addDependency(
    'module/moduleloadcallback_test.js',
...
goog.addDependency(
    'module/testdata/modA_1.js',
    ['goog.module.testdata.modA_1'],
    [],
    false,
);
goog.addDependency(
    'module/testdata/modA_2.js',
    ['goog.module.testdata.modA_2'],
    ['goog.module.ModuleManager'],
    false,
);
goog.addDependency(
    'module/testdata/modB_1.js',
...
goog.addDependency(
    'net/channelrequest.js',
    ['goog.net.ChannelRequest', 'goog.net.ChannelRequest.Error'],
    [
        'goog.Timer',
        'goog.async.Throttle',
        'goog.dom.TagName',
...
goog.addDependency(
    'net/corsxmlhttpfactory.js',
    ['goog.net.CorsXmlHttpFactory', 'goog.net.IeCorsXhrAdapter'],
    [
        'goog.net.HttpStatus',
        'goog.net.XhrLike',
        'goog.net.XmlHttp',
...
goog.addDependency(
    'net/corsxmlhttpfactory_test.js',
...
goog.addDependency(
    'net/fetchxmlhttpfactory.js',
    ['goog.net.FetchXmlHttp', 'goog.net.FetchXmlHttpFactory'],
    [
        'goog.asserts',
        'goog.events.EventTarget',
        'goog.functions',
...
goog.addDependency(
    'net/fetchxmlhttpfactory_test.js',
    ['goog.net.FetchXmlHttpFactoryTest'],
    [
...
goog.addDependency(
    'net/filedownloader.js',
    ['goog.net.FileDownloader', 'goog.net.FileDownloader.Error'],
    [
        'goog.Disposable',
        'goog.asserts',
        'goog.async.Deferred',
...
goog.addDependency(
    'net/iframeio_different_base_test.js',
...
goog.addDependency(
    'net/ipaddress.js',
    ['goog.net.IpAddress', 'goog.net.Ipv4Address', 'goog.net.Ipv6Address'],
    ['goog.array', 'goog.math.Integer', 'goog.object', 'goog.string'],
    false,
);
goog.addDependency(
    'net/ipaddress_test.js',
...
goog.addDependency(
    'net/networkstatusmonitor.js',
    ['goog.net.NetworkStatusMonitor'],
    ['goog.events.Listenable'],
    false,
);
goog.addDependency(
    'net/networktester.js',
    ['goog.net.NetworkTester'],
    ['goog.Timer', 'goog.Uri', 'goog.log'],
    false,
);
goog.addDependency(
    'net/networktester_test.js',
...
goog.addDependency(
    'net/streams/nodereadablestream.js',
    ['goog.net.streams.NodeReadableStream'],
    [],
    false,
);
goog.addDependency(
    'net/streams/streamfactory.js',
    ['goog.net.streams.createNodeReadableStream'],
    ['goog.asserts', 'goog.net.XhrIo', 'goog.net.streams.NodeReadableStream'],
    false,
);
goog.addDependency(
    'net/testdata/jsloader_test1.js',
    ['goog.net.testdata.jsloader_test1'],
    [],
    false,
);
goog.addDependency(
    'net/testdata/jsloader_test2.js',
    ['goog.net.testdata.jsloader_test2'],
    [],
    false,
);
goog.addDependency(
    'net/testdata/jsloader_test3.js',
    ['goog.net.testdata.jsloader_test3'],
    [],
    false,
);
goog.addDependency(
    'net/testdata/jsloader_test4.js',
...
goog.addDependency(
    'net/tmpnetwork.js',
    ['goog.net.tmpnetwork'],
    ['goog.Uri', 'goog.net.ChannelDebug'],
    false,
);
goog.addDependency(
    'net/websocket.js',
...
goog.addDependency(
    'net/wrapperxmlhttpfactory.js',
    ['goog.net.WrapperXmlHttpFactory'],
    ['goog.net.XhrLike', 'goog.net.XmlHttpFactory'],
    false,
);
goog.addDependency(
    'net/xhrio.js',
    ['goog.net.XhrIo', 'goog.net.XhrIo.ResponseType'],
    [
        'goog.Timer',
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    'net/xhriopool.js',
    ['goog.net.XhrIoPool'],
    ['goog.net.XhrIo', 'goog.structs.PriorityPool'],
    false,
);
goog.addDependency(
    'net/xhriopool_test.js',
    ['goog.net.XhrIoPoolTest'],
    ['goog.net.XhrIoPool', 'goog.structs.Map', 'goog.testing.jsunit'],
    false,
);
...
goog.addDependency(
    'net/xmlhttpfactory.js',
    ['goog.net.XmlHttpFactory'],
    ['goog.net.XhrLike'],
    false,
);
goog.addDependency(
    'net/xpc/crosspagechannel.js',
    ['goog.net.xpc.CrossPageChannel'],
    [
        'goog.Uri',
        'goog.async.Deferred',
...
goog.addDependency(
    'net/xpc/crosspagechannel_test.js',
...
goog.addDependency(
    'net/xpc/crosspagechannelrole.js',
    ['goog.net.xpc.CrossPageChannelRole'],
    [],
    false,
);
goog.addDependency(
    'net/xpc/directtransport.js',
    ['goog.net.xpc.DirectTransport'],
    [
        'goog.Timer',
        'goog.async.Deferred',
...
goog.addDependency(
    'net/xpc/directtransport_test.js',
...
goog.addDependency(
    'net/xpc/frameelementmethodtransport.js',
    ['goog.net.xpc.FrameElementMethodTransport'],
    [
        'goog.log',
        'goog.net.xpc',
...
goog.addDependency(
    'net/xpc/iframepollingtransport.js',
    [
        'goog.net.xpc.IframePollingTransport',
...
goog.addDependency(
    'net/xpc/iframepollingtransport_test.js',
...
goog.addDependency(
    'net/xpc/iframerelaytransport.js',
    ['goog.net.xpc.IframeRelayTransport'],
    [
        'goog.dom',
        'goog.dom.TagName',
...
goog.addDependency(
    'net/xpc/nativemessagingtransport.js',
    ['goog.net.xpc.NativeMessagingTransport'],
    [
        'goog.Timer',
        'goog.asserts',
...
goog.addDependency(
    'net/xpc/nativemessagingtransport_test.js',
...
goog.addDependency(
    'net/xpc/transport.js',
    ['goog.net.xpc.Transport'],
    ['goog.Disposable', 'goog.dom', 'goog.net.xpc.TransportNames'],
    false,
);
goog.addDependency(
    'net/xpc/xpc.js',
...
goog.addDependency(
    'positioning/absoluteposition.js',
...
goog.addDependency(
    'positioning/anchoredposition_test.js',
...
goog.addDependency(
    'positioning/anchoredviewportposition_test.js',
...
goog.addDependency(
    'positioning/clientposition_test.js',
...
goog.addDependency(
    ...
    ['goog.positioning.AnchoredViewportPosition', 'goog.positioning.Overflow'],
    false,
);
goog.addDependency(
    'positioning/menuanchoredposition_test.js',
...
goog.addDependency(
    'positioning/positioning_test.js',
...
goog.addDependency(
    'positioning/viewportclientposition_test.js',
...
goog.addDependency(
    'positioning/viewportposition.js',
...
goog.addDependency(
    'proto/serializer_test.js',
    ['goog.protoTest'],
    ['goog.proto', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'proto2/descriptor.js',
    ['goog.proto2.Descriptor', 'goog.proto2.Metadata'],
    ['goog.array', 'goog.asserts', 'goog.object', 'goog.string'],
    false,
);
goog.addDependency(
    'proto2/descriptor_test.js',
    ['goog.proto2.DescriptorTest'],
    ['goog.proto2.Descriptor', 'goog.proto2.Message', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'proto2/fielddescriptor.js',
    ['goog.proto2.FieldDescriptor'],
    ['goog.asserts', 'goog.string'],
    false,
);
goog.addDependency(
    'proto2/fielddescriptor_test.js',
    ['goog.proto2.FieldDescriptorTest'],
    [
        'goog.proto2.FieldDescriptor',
        'goog.proto2.Message',
        'goog.testing.jsunit',
...
goog.addDependency(
    'proto2/lazydeserializer.js',
    ['goog.proto2.LazyDeserializer'],
    ['goog.asserts', 'goog.proto2.Message', 'goog.proto2.Serializer'],
    false,
);
goog.addDependency(
    'proto2/message.js',
    ['goog.proto2.Message'],
    ['goog.asserts', 'goog.proto2.Descriptor', 'goog.proto2.FieldDescriptor'],
    false,
);
goog.addDependency(
    'proto2/message_test.js',
    ['goog.proto2.MessageTest'],
    [
        'goog.testing.jsunit',
        'proto2.TestAllTypes',
...
goog.addDependency(
    'proto2/objectserializer_test.js',
    ['goog.proto2.ObjectSerializerTest'],
    [
        'goog.proto2.ObjectSerializer',
        'goog.proto2.Serializer',
        'goog.testing.PropertyReplacer',
...
goog.addDependency(
    ...
    ['goog.proto2.Message', 'proto2.TestAllTypes'],
    false,
);
goog.addDependency(
    'proto2/pbliteserializer.js',
...
goog.addDependency(
    'proto2/pbliteserializer_test.js',
    ['goog.proto2.PbLiteSerializerTest'],
    [
        'goog.proto2.PbLiteSerializer',
        'goog.testing.jsunit',
        'proto2.TestAllTypes',
...
goog.addDependency(
    'proto2/textformatserializer.js',
...
goog.addDependency(
    'proto2/textformatserializer_test.js',
...
goog.addDependency(
    'pubsub/pubsub.js',
    ['goog.pubsub.PubSub'],
    ['goog.Disposable', 'goog.array'],
    false,
);
goog.addDependency(
    'pubsub/pubsub_test.js',
    ['goog.pubsub.PubSubTest'],
    ['goog.array', 'goog.pubsub.PubSub', 'goog.testing.jsunit'],
    false,
);
goog.addDependency('pubsub/topicid.js', ['goog.pubsub.TopicId'], [], false);
goog.addDependency(
    'pubsub/typedpubsub.js',
    ['goog.pubsub.TypedPubSub'],
    ['goog.Disposable', 'goog.pubsub.PubSub'],
    false,
);
goog.addDependency(
    'pubsub/typedpubsub_test.js',
...
goog.addDependency(
    'result/deferredadaptor.js',
    ['goog.result.DeferredAdaptor'],
    ['goog.async.Deferred', 'goog.result', 'goog.result.Result'],
    false,
);
goog.addDependency(
    'result/dependentresult.js',
    ['goog.result.DependentResult'],
    ['goog.result.Result'],
    false,
);
goog.addDependency(
    'result/result_interface.js',
    ['goog.result.Result'],
    ['goog.Thenable'],
    false,
);
goog.addDependency(
    'result/resultutil.js',
    ['goog.result'],
    [
        'goog.array',
        'goog.result.DependentResult',
...
goog.addDependency(
    'result/simpleresult.js',
    ['goog.result.SimpleResult', 'goog.result.SimpleResult.StateError'],
    ['goog.Promise', 'goog.Thenable', 'goog.debug.Error', 'goog.result.Result'],
    false,
);
goog.addDependency(
    'soy/data.js',
...
goog.addDependency(
    'soy/data_test.js',
    ['goog.soy.dataTest'],
    ['goog.html.SafeHtml', 'goog.soy.testHelper', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'soy/renderer.js',
    ['goog.soy.InjectedDataSupplier', 'goog.soy.Renderer'],
    [
        'goog.asserts',
        'goog.dom',
        'goog.soy',
...
goog.addDependency(
    'spell/spellcheck.js',
    ['goog.spell.SpellCheck', 'goog.spell.SpellCheck.WordChangedEvent'],
    [
        'goog.Timer',
        'goog.events.Event',
        'goog.events.EventTarget',
...
goog.addDependency(
    'spell/spellcheck_test.js',
    ['goog.spell.SpellCheckTest'],
    ['goog.spell.SpellCheck', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'stats/basicstat.js',
...
goog.addDependency(
    'stats/basicstat_test.js',
    ['goog.stats.BasicStatTest'],
    [
        'goog.array',
        'goog.stats.BasicStat',
        'goog.string.format',
...
goog.addDependency(
    'storage/collectablestorage_test.js',
    ['goog.storage.CollectableStorageTest'],
    [
        'goog.storage.CollectableStorage',
        'goog.storage.collectableStorageTester',
        'goog.storage.storage_test',
...
goog.addDependency(
    'storage/collectablestoragetester.js',
    ['goog.storage.collectableStorageTester'],
    ['goog.testing.asserts'],
    false,
);
goog.addDependency(
    'storage/encryptedstorage.js',
...
goog.addDependency(
    'storage/encryptedstorage_test.js',
    ['goog.storage.EncryptedStorageTest'],
    [
        'goog.json',
        'goog.storage.EncryptedStorage',
        'goog.storage.ErrorCode',
...
goog.addDependency(
    'storage/errorcode.js',
    ['goog.storage.ErrorCode'],
    [],
    false,
);
goog.addDependency(
    'storage/expiringstorage.js',
    ['goog.storage.ExpiringStorage'],
    ['goog.storage.RichStorage'],
    false,
);
goog.addDependency(
    'storage/expiringstorage_test.js',
    ['goog.storage.ExpiringStorageTest'],
    [
        'goog.storage.ExpiringStorage',
        'goog.storage.storage_test',
        'goog.testing.MockClock',
...
goog.addDependency(
    'storage/mechanism/errorcode.js',
    ['goog.storage.mechanism.ErrorCode'],
    [],
    false,
);
goog.addDependency(
    'storage/mechanism/errorhandlingmechanism.js',
    ['goog.storage.mechanism.ErrorHandlingMechanism'],
    ['goog.storage.mechanism.Mechanism'],
    false,
);
goog.addDependency(
    'storage/mechanism/errorhandlingmechanism_test.js',
    ['goog.storage.mechanism.ErrorHandlingMechanismTest'],
    [
        'goog.storage.mechanism.ErrorHandlingMechanism',
        'goog.testing.jsunit',
        'goog.testing.recordFunction',
...
goog.addDependency(
    'storage/mechanism/html5localstorage.js',
    ['goog.storage.mechanism.HTML5LocalStorage'],
    ['goog.storage.mechanism.HTML5WebStorage'],
    false,
);
goog.addDependency(
    'storage/mechanism/html5localstorage_test.js',
    ['goog.storage.mechanism.HTML5LocalStorageTest'],
    [
        'goog.storage.mechanism.HTML5LocalStorage',
...
goog.addDependency(
    'storage/mechanism/html5sessionstorage.js',
    ['goog.storage.mechanism.HTML5SessionStorage'],
    ['goog.storage.mechanism.HTML5WebStorage'],
    false,
);
goog.addDependency(
    'storage/mechanism/html5sessionstorage_test.js',
    ['goog.storage.mechanism.HTML5SessionStorageTest'],
    [
        'goog.storage.mechanism.HTML5SessionStorage',
        'goog.storage.mechanism.mechanismSeparationTester',
        'goog.storage.mechanism.mechanismSharingTester',
...
goog.addDependency(
    'storage/mechanism/html5webstorage.js',
    ['goog.storage.mechanism.HTML5WebStorage'],
    [
        'goog.asserts',
        'goog.iter.Iterator',
...
goog.addDependency(
    'storage/mechanism/html5webstorage_test.js',
    [
        'goog.storage.mechanism.HTML5MockStorage',
        'goog.storage.mechanism.HTML5WebStorageTest',
...
goog.addDependency(
    'storage/mechanism/ieuserdata.js',
...
goog.addDependency(
    'storage/mechanism/ieuserdata_test.js',
    ['goog.storage.mechanism.IEUserDataTest'],
    [
        'goog.storage.mechanism.IEUserData',
        'goog.storage.mechanism.mechanismSeparationTester',
        'goog.storage.mechanism.mechanismSharingTester',
...
goog.addDependency(
    'storage/mechanism/iterablemechanism.js',
    ['goog.storage.mechanism.IterableMechanism'],
    [
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    'storage/mechanism/iterablemechanismtester.js',
...
goog.addDependency(
    'storage/mechanism/mechanism.js',
    ['goog.storage.mechanism.Mechanism'],
    [],
    false,
);
goog.addDependency(
    'storage/mechanism/mechanismfactory.js',
...
goog.addDependency(
    'storage/mechanism/mechanismfactory_test.js',
    ['goog.storage.mechanism.mechanismfactoryTest'],
    ['goog.storage.mechanism.mechanismfactory', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'storage/mechanism/mechanismseparationtester.js',
    ['goog.storage.mechanism.mechanismSeparationTester'],
    [
        'goog.iter.StopIteration',
        'goog.storage.mechanism.mechanismTestDefinition',
...
goog.addDependency(
    'storage/mechanism/mechanismsharingtester.js',
    ['goog.storage.mechanism.mechanismSharingTester'],
    [
        'goog.iter.StopIteration',
        'goog.storage.mechanism.mechanismTestDefinition',
...
goog.addDependency(
    'storage/mechanism/mechanismtestdefinition.js',
    ['goog.storage.mechanism.mechanismTestDefinition'],
    [],
    false,
);
goog.addDependency(
    'storage/mechanism/mechanismtester.js',
...
goog.addDependency(
    'storage/mechanism/prefixedmechanism.js',
    ['goog.storage.mechanism.PrefixedMechanism'],
    ['goog.iter.Iterator', 'goog.storage.mechanism.IterableMechanism'],
    false,
);
goog.addDependency(
    'storage/mechanism/prefixedmechanism_test.js',
    ['goog.storage.mechanism.PrefixedMechanismTest'],
    [
        'goog.storage.mechanism.HTML5LocalStorage',
        'goog.storage.mechanism.PrefixedMechanism',
        'goog.storage.mechanism.mechanismSeparationTester',
...
goog.addDependency(
    'storage/richstorage.js',
    ['goog.storage.RichStorage', 'goog.storage.RichStorage.Wrapper'],
    ['goog.storage.ErrorCode', 'goog.storage.Storage'],
    false,
);
goog.addDependency(
    'storage/richstorage_test.js',
    ['goog.storage.RichStorageTest'],
    [
        'goog.storage.ErrorCode',
        'goog.storage.RichStorage',
        'goog.storage.storage_test',
...
goog.addDependency(
    'storage/storage.js',
    ['goog.storage.Storage'],
    ['goog.json', 'goog.storage.ErrorCode'],
    false,
);
goog.addDependency(
    'storage/storage_test.js',
    ['goog.storage.storage_test'],
    ['goog.structs.Map', 'goog.testing.asserts'],
    false,
);
goog.addDependency(
    'string/const.js',
...
goog.addDependency(
    'string/const_test.js',
    ['goog.string.constTest'],
    ['goog.string.Const', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'string/linkify.js',
...
goog.addDependency(
    'string/linkify_test.js',
    ['goog.string.linkifyTest'],
    [
        'goog.dom.TagName',
        'goog.string',
        'goog.string.linkify',
...
goog.addDependency(
    'string/newlines.js',
    ['goog.string.newlines', 'goog.string.newlines.Line'],
    ['goog.array'],
    false,
);
goog.addDependency(
    'string/newlines_test.js',
    ['goog.string.newlinesTest'],
    ['goog.string.newlines', 'goog.testing.jsunit'],
    false,
);
...
goog.addDependency(
    'string/path.js',
    ['goog.string.path'],
    ['goog.array', 'goog.string'],
    false,
);
goog.addDependency(
    'string/path_test.js',
    ['goog.string.pathTest'],
    ['goog.string.path', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'string/string.js',
...
goog.addDependency(
    'string/stringbuffer_test.js',
    ['goog.string.StringBufferTest'],
    ['goog.string.StringBuffer', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'string/stringformat_test.js',
    ['goog.string.formatTest'],
    ['goog.string.format', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'string/stringifier.js',
...
goog.addDependency(
    'structs/avltree.js',
    ['goog.structs.AvlTree', 'goog.structs.AvlTree.Node'],
    ['goog.structs.Collection'],
    false,
);
goog.addDependency(
    'structs/avltree_test.js',
    ['goog.structs.AvlTreeTest'],
    ['goog.array', 'goog.structs.AvlTree', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'structs/circularbuffer.js',
    ['goog.structs.CircularBuffer'],
    [],
    false,
);
goog.addDependency(
    'structs/circularbuffer_test.js',
    ['goog.structs.CircularBufferTest'],
    ['goog.structs.CircularBuffer', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'structs/collection_test.js',
    ['goog.structs.CollectionTest'],
    ['goog.structs.AvlTree', 'goog.structs.Set', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'structs/heap.js',
    ['goog.structs.Heap'],
    ['goog.array', 'goog.object', 'goog.structs.Node'],
    false,
);
goog.addDependency(
    'structs/heap_test.js',
    ['goog.structs.HeapTest'],
    ['goog.structs', 'goog.structs.Heap', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'structs/inversionmap.js',
    ['goog.structs.InversionMap'],
    ['goog.array'],
    false,
);
goog.addDependency(
    'structs/inversionmap_test.js',
    ['goog.structs.InversionMapTest'],
    ['goog.structs.InversionMap', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'structs/linkedmap.js',
    ['goog.structs.LinkedMap'],
    ['goog.structs.Map'],
    false,
);
goog.addDependency(
    'structs/linkedmap_test.js',
...
goog.addDependency(
    'structs/map.js',
    ['goog.structs.Map'],
    ['goog.iter.Iterator', 'goog.iter.StopIteration', 'goog.object'],
    false,
);
goog.addDependency(
    'structs/map_test.js',
    ['goog.structs.MapTest'],
    ['goog.iter', 'goog.structs', 'goog.structs.Map', 'goog.testing.jsunit'],
    false,
);
...
goog.addDependency(
    'structs/pool.js',
    ['goog.structs.Pool'],
    ['goog.Disposable', 'goog.structs.Queue', 'goog.structs.Set'],
    false,
);
goog.addDependency(
    'structs/pool_test.js',
    ['goog.structs.PoolTest'],
    ['goog.structs.Pool', 'goog.testing.MockClock', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'structs/prioritypool.js',
    ['goog.structs.PriorityPool'],
    ['goog.structs.Pool', 'goog.structs.PriorityQueue'],
    false,
);
goog.addDependency(
    'structs/prioritypool_test.js',
...
goog.addDependency(
    'structs/priorityqueue_test.js',
    ['goog.structs.PriorityQueueTest'],
    ['goog.structs', 'goog.structs.PriorityQueue', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'structs/quadtree.js',
...
goog.addDependency(
    'structs/quadtree_test.js',
    ['goog.structs.QuadTreeTest'],
    ['goog.structs', 'goog.structs.QuadTree', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'structs/queue.js',
...
goog.addDependency(
    'structs/queue_test.js',
    ['goog.structs.QueueTest'],
    ['goog.structs.Queue', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'structs/set.js',
    ['goog.structs.Set'],
    ['goog.structs', 'goog.structs.Collection', 'goog.structs.Map'],
    false,
);
goog.addDependency(
    'structs/set_test.js',
    ['goog.structs.SetTest'],
    ['goog.iter', 'goog.structs', 'goog.structs.Set', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'structs/stringset.js',
    ['goog.structs.StringSet'],
    ['goog.asserts', 'goog.iter'],
    false,
);
goog.addDependency(
    'structs/stringset_test.js',
...
goog.addDependency(
    ...
    ['goog.array', 'goog.asserts', 'goog.structs.Node'],
    false,
);
goog.addDependency(
    'structs/treenode_test.js',
    ['goog.structs.TreeNodeTest'],
    ['goog.structs.TreeNode', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'structs/trie.js',
    ['goog.structs.Trie'],
    ['goog.object', 'goog.structs'],
    false,
);
goog.addDependency(
    'structs/trie_test.js',
    ['goog.structs.TrieTest'],
    ['goog.object', 'goog.structs', 'goog.structs.Trie', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'structs/weak/weak.js',
    ['goog.structs.weak'],
    ['goog.userAgent'],
    false,
);
goog.addDependency(
    'structs/weak/weak_test.js',
    ['goog.structs.weakTest'],
    ['goog.array', 'goog.structs.weak', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'style/bidi.js',
    ['goog.style.bidi'],
    ['goog.dom', 'goog.style', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'style/bidi_test.js',
...
goog.addDependency(
    'style/cursor_test.js',
    ['goog.style.cursorTest'],
    ['goog.style.cursor', 'goog.testing.jsunit', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'style/style.js',
...
goog.addDependency(
    'style/style_document_scroll_test.js',
...
goog.addDependency(
    'style/style_webkit_scrollbars_test.js',
    ['goog.style.webkitScrollbarsTest'],
    [
        'goog.asserts',
        'goog.style',
...
goog.addDependency(
    ...
    ['goog.styleScrollbarTester'],
    ['goog.dom', 'goog.dom.TagName', 'goog.style', 'goog.testing.asserts'],
    false,
);
goog.addDependency(
    'style/transform.js',
...
goog.addDependency(
    'style/transform_test.js',
    ['goog.style.transformTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.style.transform',
...
goog.addDependency(
    'style/transition.js',
    ['goog.style.transition', 'goog.style.transition.Css3Property'],
    [
        'goog.array',
        'goog.asserts',
        'goog.dom.TagName',
...
goog.addDependency(
    'style/transition_test.js',
    ['goog.style.transitionTest'],
    [
        'goog.style',
        'goog.style.transition',
        'goog.testing.jsunit',
...
goog.addDependency(
    'testing/async/mockcontrol_test.js',
    ['goog.testing.async.MockControlTest'],
    [
        'goog.async.Deferred',
        'goog.testing.MockControl',
        'goog.testing.asserts',
...
goog.addDependency(
    ...
    ['goog.testing.TestCase', 'goog.testing.asserts'],
    false,
);
goog.addDependency(
    'testing/asynctestcase_async_test.js',
    ['goog.testing.AsyncTestCaseAsyncTest'],
    ['goog.testing.AsyncTestCase', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'testing/asynctestcase_noasync_test.js',
    ['goog.testing.AsyncTestCaseSyncTest'],
    ['goog.testing.AsyncTestCase', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'testing/asynctestcase_test.js',
...
goog.addDependency(
    'testing/continuationtestcase.js',
    [
...
goog.addDependency(
    'testing/continuationtestcase_test.js',
...
goog.addDependency(
    'testing/editor/dom_test.js',
    ['goog.testing.editor.domTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.functions',
...
goog.addDependency(
    'testing/editor/testhelper_test.js',
...
goog.addDependency(
    'testing/events/eventobserver.js',
    ['goog.testing.events.EventObserver'],
    ['goog.array'],
    false,
);
goog.addDependency(
    'testing/events/eventobserver_test.js',
...
goog.addDependency(
    ...
    ['goog.testing.events', 'goog.testing.events.Event'],
    [
        'goog.Disposable',
        'goog.asserts',
        'goog.dom.NodeType',
...
goog.addDependency(
    'testing/events/matchers.js',
    ['goog.testing.events.EventMatcher'],
    ['goog.events.Event', 'goog.testing.mockmatchers.ArgumentMatcher'],
    false,
);
goog.addDependency(
    'testing/events/matchers_test.js',
...
goog.addDependency(
    'testing/events/onlinehandler.js',
    ['goog.testing.events.OnlineHandler'],
    ['goog.events.EventTarget', 'goog.net.NetworkStatusMonitor'],
    false,
);
goog.addDependency(
    'testing/events/onlinehandler_test.js',
...
goog.addDependency(
    'testing/expectedfailures_test.js',
...
goog.addDependency(
    'testing/fs/blob_test.js',
    ['goog.testing.fs.BlobTest'],
    ['goog.testing.fs.Blob', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'testing/fs/directoryentry_test.js',
...
goog.addDependency(
    'testing/fs/filesystem.js',
    ['goog.testing.fs.FileSystem'],
    ['goog.fs.FileSystem', 'goog.testing.fs.DirectoryEntry'],
    false,
);
goog.addDependency(
    'testing/fs/filewriter.js',
    ['goog.testing.fs.FileWriter'],
    [
        'goog.Timer',
        'goog.events.EventTarget',
...
goog.addDependency(
    'testing/fs/integration_test.js',
...
goog.addDependency(
    ...
    ['goog.graphics.Path', 'goog.testing.asserts'],
    false,
);
goog.addDependency(
    'testing/i18n/asserts.js',
    ['goog.testing.i18n.asserts'],
    ['goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'testing/i18n/asserts_test.js',
    ['goog.testing.i18n.assertsTest'],
    ['goog.testing.ExpectedFailures', 'goog.testing.i18n.asserts'],
    false,
);
goog.addDependency(
    'testing/jstdtestcaseadapter.js',
    ['goog.testing.JsTdTestCaseAdapter'],
    ['goog.async.run', 'goog.testing.TestCase', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'testing/jsunit.js',
    ['goog.testing.jsunit'],
    ['goog.dom.TagName', 'goog.testing.TestCase', 'goog.testing.TestRunner'],
    false,
);
goog.addDependency(
    'testing/loosemock.js',
    ['goog.testing.LooseExpectationCollection', 'goog.testing.LooseMock'],
    ['goog.array', 'goog.structs.Map', 'goog.testing.Mock'],
    false,
);
goog.addDependency(
    'testing/loosemock_test.js',
...
goog.addDependency(
    'testing/messaging/mockmessagechannel.js',
    ['goog.testing.messaging.MockMessageChannel'],
    ['goog.messaging.AbstractChannel', 'goog.testing.asserts'],
    false,
);
goog.addDependency(
    'testing/messaging/mockmessageevent.js',
...
goog.addDependency(
    'testing/messaging/mockmessageport.js',
    ['goog.testing.messaging.MockMessagePort'],
    ['goog.events.EventTarget'],
    false,
);
goog.addDependency(
    'testing/messaging/mockportnetwork.js',
    ['goog.testing.messaging.MockPortNetwork'],
    ['goog.messaging.PortNetwork', 'goog.testing.messaging.MockMessageChannel'],
    false,
);
goog.addDependency(
    'testing/mock.js',
    ['goog.testing.Mock', 'goog.testing.MockExpectation'],
    [
        'goog.array',
        'goog.object',
        'goog.testing.JsUnitException',
...
goog.addDependency(
    'testing/mockclassfactory.js',
    ['goog.testing.MockClassFactory', 'goog.testing.MockClassRecord'],
    [
        'goog.array',
        'goog.object',
        'goog.testing.LooseMock',
...
goog.addDependency(
    'testing/mockclassfactory_test.js',
    ['fake.BaseClass', 'fake.ChildClass', 'goog.testing.MockClassFactoryTest'],
    ['goog.testing', 'goog.testing.MockClassFactory', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'testing/mockcontrol_test.js',
    ['goog.testing.MockControlTest'],
    ['goog.testing.Mock', 'goog.testing.MockControl', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    ...
    ['goog.array', 'goog.dom', 'goog.testing.asserts'],
    false,
);
goog.addDependency(
    'testing/mockmatchers_test.js',
...
goog.addDependency(
    'testing/mockrandom.js',
    ['goog.testing.MockRandom'],
    ['goog.Disposable'],
    false,
);
goog.addDependency(
    'testing/mockrandom_test.js',
    ['goog.testing.MockRandomTest'],
    ['goog.testing.MockRandom', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'testing/mockrange.js',
    ['goog.testing.MockRange'],
    ['goog.dom.AbstractRange', 'goog.testing.LooseMock'],
    false,
);
goog.addDependency(
    'testing/mockrange_test.js',
    ['goog.testing.MockRangeTest'],
    ['goog.testing.MockRange', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'testing/mockstorage.js',
    ['goog.testing.MockStorage'],
    ['goog.structs.Map'],
    false,
);
goog.addDependency(
    'testing/mockstorage_test.js',
    ['goog.testing.MockStorageTest'],
    ['goog.testing.MockStorage', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'testing/mockuseragent.js',
    ['goog.testing.MockUserAgent'],
    [
        'goog.Disposable',
        'goog.labs.userAgent.util',
...
goog.addDependency(
    'testing/multitestrunner.js',
    ['goog.testing.MultiTestRunner', 'goog.testing.MultiTestRunner.TestFrame'],
    [
        'goog.Timer',
        'goog.array',
        'goog.asserts',
...
goog.addDependency(
    'testing/net/xhrio_test.js',
    ['goog.testing.net.XhrIoTest'],
    [
        'goog.dom.xml',
        'goog.events',
        'goog.events.Event',
...
goog.addDependency(
    'testing/net/xhriopool.js',
    ['goog.testing.net.XhrIoPool'],
    ['goog.net.XhrIoPool', 'goog.testing.net.XhrIo'],
    false,
);
goog.addDependency(
    'testing/objectpropertystring.js',
    ['goog.testing.ObjectPropertyString'],
    [],
    false,
);
goog.addDependency(
    'testing/performancetable.js',
    ['goog.testing.PerformanceTable'],
    ['goog.dom', 'goog.dom.TagName', 'goog.testing.PerformanceTimer'],
    false,
);
goog.addDependency(
    'testing/performancetimer.js',
    ['goog.testing.PerformanceTimer', 'goog.testing.PerformanceTimer.Task'],
    ['goog.array', 'goog.async.Deferred', 'goog.math'],
    false,
);
goog.addDependency(
    'testing/performancetimer_test.js',
...
goog.addDependency(
    ...
    ['goog.testing.PropertyReplacer'],
    ['goog.testing.ObjectPropertyString', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'testing/propertyreplacer_test.js',
...
goog.addDependency(
    'testing/proto2/proto2_test.js',
    ['goog.testing.proto2Test'],
    ['goog.testing.jsunit', 'goog.testing.proto2', 'proto2.TestAllTypes'],
    false,
);
goog.addDependency(
    'testing/pseudorandom.js',
    ['goog.testing.PseudoRandom'],
    ['goog.Disposable'],
    false,
);
goog.addDependency(
    'testing/pseudorandom_test.js',
    ['goog.testing.PseudoRandomTest'],
    ['goog.testing.PseudoRandom', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'testing/recordfunction.js',
    [
...
goog.addDependency(
    'testing/recordfunction_test.js',
...
goog.addDependency(
    'testing/shardingtestcase.js',
    ['goog.testing.ShardingTestCase'],
    ['goog.asserts', 'goog.testing.TestCase'],
    false,
);
goog.addDependency(
    'testing/shardingtestcase_test.js',
...
goog.addDependency(
    'testing/singleton.js',
    ['goog.testing.singleton'],
    [],
    false,
);
goog.addDependency(
    'testing/singleton_test.js',
    ['goog.testing.singletonTest'],
    ['goog.testing.asserts', 'goog.testing.jsunit', 'goog.testing.singleton'],
    false,
);
goog.addDependency(
    'testing/stacktrace.js',
    ['goog.testing.stacktrace', 'goog.testing.stacktrace.Frame'],
    [],
    false,
);
goog.addDependency(
    'testing/stacktrace_test.js',
...
goog.addDependency(
    'testing/storage/fakemechanism.js',
    ['goog.testing.storage.FakeMechanism'],
    ['goog.storage.mechanism.IterableMechanism', 'goog.structs.Map'],
    false,
);
goog.addDependency(
    'testing/strictmock.js',
    ['goog.testing.StrictMock'],
    ['goog.array', 'goog.testing.Mock'],
    false,
);
goog.addDependency(
    'testing/strictmock_test.js',
    ['goog.testing.StrictMockTest'],
    ['goog.testing.StrictMock', 'goog.testing.jsunit'],
    false,
);
goog.addDependency(
    'testing/style/layoutasserts.js',
    ['goog.testing.style.layoutasserts'],
    ['goog.style', 'goog.testing.asserts', 'goog.testing.style'],
    false,
);
goog.addDependency(
    'testing/style/layoutasserts_test.js',
...
goog.addDependency(
    'testing/style/style.js',
    ['goog.testing.style'],
    ['goog.dom', 'goog.math.Rect', 'goog.style'],
    false,
);
goog.addDependency(
    'testing/style/style_test.js',
...
goog.addDependency(
    'testing/testcase_test.js',
    ['goog.testing.TestCaseTest'],
    [
        'goog.Promise',
        'goog.string',
        'goog.testing.MockRandom',
...
goog.addDependency(
    ...
    ['goog.testing.TestRunner'],
    ['goog.dom.TagName', 'goog.testing.TestCase'],
    false,
);
goog.addDependency(
    'testing/testsuite.js',
    ['goog.testing.testSuite'],
    ['goog.labs.testing.Environment', 'goog.testing.TestCase'],
    false,
);
goog.addDependency(
    'testing/ui/rendererasserts.js',
    ['goog.testing.ui.rendererasserts'],
    ['goog.testing.asserts', 'goog.ui.ControlRenderer'],
    false,
);
goog.addDependency(
    'testing/ui/rendererasserts_test.js',
    ['goog.testing.ui.rendererassertsTest'],
    [
        'goog.testing.asserts',
        'goog.testing.jsunit',
        'goog.testing.ui.rendererasserts',
...
goog.addDependency(
    'testing/ui/style_test.js',
    ['goog.testing.ui.styleTest'],
    ['goog.dom', 'goog.testing.jsunit', 'goog.testing.ui.style'],
    false,
);
...
goog.addDependency(
    'timer/timer.js',
    ['goog.Timer'],
    ['goog.Promise', 'goog.events.EventTarget'],
    false,
);
goog.addDependency(
    'timer/timer_test.js',
...
goog.addDependency(
    ...
    ['goog.array', 'goog.asserts', 'goog.log', 'goog.object'],
    false,
);
goog.addDependency(
    'tweak/entries_test.js',
...
goog.addDependency(
    'tweak/tweak.js',
    ['goog.tweak', 'goog.tweak.ConfigParams'],
    [
        'goog.asserts',
        'goog.tweak.BaseSetting',
        'goog.tweak.BooleanGroup',
...
goog.addDependency(
    'tweak/tweakui.js',
    ['goog.tweak.EntriesPanel', 'goog.tweak.TweakUi'],
    [
        'goog.array',
        'goog.asserts',
        'goog.dom',
...
goog.addDependency(
    'ui/ac/arraymatcher.js',
    ['goog.ui.ac.ArrayMatcher'],
    ['goog.string'],
    false,
);
goog.addDependency(
    'ui/ac/arraymatcher_test.js',
    ['goog.ui.ac.ArrayMatcherTest'],
    ['goog.testing.jsunit', 'goog.ui.ac.ArrayMatcher'],
    false,
);
goog.addDependency(
    'ui/ac/autocomplete.js',
    ['goog.ui.ac.AutoComplete', 'goog.ui.ac.AutoComplete.EventType'],
    [
        'goog.array',
        'goog.asserts',
        'goog.events',
...
goog.addDependency(
    'ui/ac/autocomplete_test.js',
    ['goog.ui.ac.AutoCompleteTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.dom',
...
goog.addDependency(
    'ui/ac/cachingmatcher_test.js',
    ['goog.ui.ac.CachingMatcherTest'],
    [
        'goog.testing.MockControl',
        'goog.testing.jsunit',
        'goog.testing.mockmatchers',
...
goog.addDependency(
    'ui/ac/inputhandler_test.js',
    ['goog.ui.ac.InputHandlerTest'],
    [
        'goog.dom.selection',
        'goog.events.BrowserEvent',
        'goog.events.Event',
...
goog.addDependency(
    'ui/ac/remotearraymatcher_test.js',
    ['goog.ui.ac.RemoteArrayMatcherTest'],
    [
        'goog.json',
        'goog.net.XhrIo',
        'goog.testing.MockControl',
...
goog.addDependency(
    'ui/ac/renderer.js',
    ['goog.ui.ac.Renderer', 'goog.ui.ac.Renderer.CustomRenderer'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.a11y.aria.State',
...
goog.addDependency(
    'ui/ac/renderer_test.js',
    ['goog.ui.ac.RendererTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.a11y.aria.State',
...
goog.addDependency(
    'ui/ac/renderoptions.js',
    ['goog.ui.ac.RenderOptions'],
    [],
    false,
);
goog.addDependency(
    'ui/ac/richinputhandler.js',
...
goog.addDependency(
    'ui/ac/richremotearraymatcher.js',
    ['goog.ui.ac.RichRemoteArrayMatcher'],
    [
        'goog.dom.safe',
        'goog.html.legacyconversions',
...
goog.addDependency(
    'ui/activitymonitor_test.js',
    ['goog.ui.ActivityMonitorTest'],
    [
        'goog.dom',
        'goog.events',
        'goog.events.Event',
...
goog.addDependency(
    'ui/advancedtooltip_test.js',
    ['goog.ui.AdvancedTooltipTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.events.Event',
...
goog.addDependency(
    'ui/animatedzippy_test.js',
    ['goog.ui.AnimatedZippyTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.State',
        'goog.asserts',
...
goog.addDependency(
    'ui/bidiinput_test.js',
    ['goog.ui.BidiInputTest'],
    ['goog.dom', 'goog.testing.jsunit', 'goog.ui.BidiInput'],
    false,
);
goog.addDependency(
    'ui/bubble.js',
...
goog.addDependency(
    'ui/button.js',
    ['goog.ui.Button', 'goog.ui.Button.Side'],
    [
        'goog.events.EventType',
        'goog.events.KeyCodes',
        'goog.events.KeyHandler',
...
goog.addDependency(
    'ui/buttonrenderer_test.js',
    ['goog.ui.ButtonRendererTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.a11y.aria.State',
...
goog.addDependency(
    'ui/charcounter.js',
    ['goog.ui.CharCounter', 'goog.ui.CharCounter.Display'],
    [
        'goog.dom',
        'goog.events',
        'goog.events.EventTarget',
...
goog.addDependency(
    'ui/charcounter_test.js',
    ['goog.ui.CharCounterTest'],
    [
        'goog.dom',
        'goog.testing.asserts',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/charpicker_test.js',
    ['goog.ui.CharPickerTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.State',
        'goog.dispose',
...
goog.addDependency(
    'ui/checkbox.js',
    ['goog.ui.Checkbox', 'goog.ui.Checkbox.State'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.State',
        'goog.events.EventType',
...
goog.addDependency(
    'ui/colorbutton.js',
    ['goog.ui.ColorButton'],
    ['goog.ui.Button', 'goog.ui.ColorButtonRenderer', 'goog.ui.registry'],
    false,
);
goog.addDependency(
    'ui/colorbutton_test.js',
    ['goog.ui.ColorButtonTest'],
    [
        'goog.array',
        'goog.asserts',
        'goog.dom',
...
goog.addDependency(
    'ui/colormenubuttonrenderer_test.js',
    ['goog.ui.ColorMenuButtonTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/colorpalette_test.js',
    ['goog.ui.ColorPaletteTest'],
    [
        'goog.color',
        'goog.dom.TagName',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/colorpicker.js',
    ['goog.ui.ColorPicker', 'goog.ui.ColorPicker.EventType'],
    ['goog.ui.ColorPalette', 'goog.ui.Component'],
    false,
);
goog.addDependency(
    'ui/colorsplitbehavior.js',
    ['goog.ui.ColorSplitBehavior'],
    ['goog.ui.ColorMenuButton', 'goog.ui.SplitBehavior'],
    false,
);
goog.addDependency(
    'ui/combobox.js',
    ['goog.ui.ComboBox', 'goog.ui.ComboBoxItem'],
    [
        'goog.Timer',
        'goog.asserts',
        'goog.dom',
...
goog.addDependency(
    'ui/component_test.js',
    ['goog.ui.ComponentTest'],
    [
        'goog.dom',
        'goog.dom.DomHelper',
        'goog.dom.NodeType',
...
goog.addDependency(
    'ui/container_test.js',
    ['goog.ui.ContainerTest'],
    [
        'goog.a11y.aria',
        'goog.dom',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/containerscroller_test.js',
    ['goog.ui.ContainerScrollerTest'],
    [
        'goog.dom',
        'goog.testing.MockClock',
        'goog.testing.events',
...
goog.addDependency(
    'ui/controlrenderer_test.js',
    ['goog.ui.ControlRendererTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.a11y.aria.State',
...
goog.addDependency(
    'ui/cookieeditor_test.js',
    ['goog.ui.CookieEditorTest'],
    [
        'goog.dom',
        'goog.events.Event',
        'goog.events.EventType',
...
goog.addDependency(
    ...
    ['goog.ui.Button', 'goog.ui.CustomButtonRenderer', 'goog.ui.registry'],
    false,
);
goog.addDependency(
    'ui/custombuttonrenderer.js',
...
goog.addDependency(
    'ui/customcolorpalette_test.js',
    ['goog.ui.CustomColorPaletteTest'],
    [
        'goog.dom.TagName',
        'goog.dom.classlist',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/datepicker_test.js',
    ['goog.ui.DatePickerTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.date.Date',
...
goog.addDependency(
    'ui/decorate_test.js',
    ['goog.ui.decorateTest'],
    ['goog.testing.jsunit', 'goog.ui.decorate', 'goog.ui.registry'],
    false,
);
goog.addDependency(
    'ui/defaultdatepickerrenderer.js',
    ['goog.ui.DefaultDatePickerRenderer'],
    ['goog.dom', 'goog.dom.TagName', 'goog.ui.DatePickerRenderer'],
    false,
);
goog.addDependency(
    'ui/dialog.js',
...
goog.addDependency(
    'ui/dimensionpicker_test.js',
    ['goog.ui.DimensionPickerTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.events.KeyCodes',
...
goog.addDependency(
    'ui/dimensionpickerrenderer_test.js',
    ['goog.ui.DimensionPickerRendererTest'],
    [
        'goog.a11y.aria.LivePriority',
        'goog.array',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/drilldownrow_test.js',
    ['goog.ui.DrilldownRowTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.html.SafeHtml',
...
goog.addDependency(
    'ui/editor/abstractdialog_test.js',
    ['goog.ui.editor.AbstractDialogTest'],
    [
        'goog.dom',
        'goog.dom.DomHelper',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/editor/bubble_test.js',
    ['goog.ui.editor.BubbleTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.events',
...
goog.addDependency(
    'ui/editor/defaulttoolbar.js',
    ['goog.ui.editor.ButtonDescriptor', 'goog.ui.editor.DefaultToolbar'],
    [
        'goog.asserts',
        'goog.dom',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/editor/messages.js',
    ['goog.ui.editor.messages'],
    ['goog.html.uncheckedconversions', 'goog.string.Const'],
    false,
);
goog.addDependency(
    'ui/editor/tabpane.js',
    ['goog.ui.editor.TabPane'],
    [
        'goog.asserts',
        'goog.dom.InputType',
...
goog.addDependency(
    'ui/editor/toolbarfactory_test.js',
    ['goog.ui.editor.ToolbarFactoryTest'],
    [
        'goog.dom',
        'goog.testing.ExpectedFailures',
        'goog.testing.editor.TestHelper',
...
goog.addDependency(
    'ui/emoji/emojipaletterenderer.js',
    ['goog.ui.emoji.EmojiPaletteRenderer'],
    [
        'goog.a11y.aria',
        'goog.asserts',
...
goog.addDependency(
    'ui/emoji/emojipicker_test.js',
    ['goog.ui.emoji.EmojiPickerTest'],
    [
        'goog.dom.TagName',
        'goog.dom.classlist',
        'goog.events.EventHandler',
...
goog.addDependency(
    'ui/emoji/fast_nonprogressive_emojipicker_test.js',
    ['goog.ui.emoji.FastNonProgressiveEmojiPickerTest'],
    [
        'goog.Promise',
        'goog.dom.classlist',
        'goog.events',
...
goog.addDependency(
    'ui/emoji/fast_progressive_emojipicker_test.js',
    ['goog.ui.emoji.FastProgressiveEmojiPickerTest'],
    [
        'goog.Promise',
        'goog.dom.classlist',
        'goog.events',
...
goog.addDependency(
    'ui/emoji/popupemojipicker_test.js',
    ['goog.ui.emoji.PopupEmojiPickerTest'],
    ['goog.dom', 'goog.testing.jsunit', 'goog.ui.emoji.PopupEmojiPicker'],
    false,
);
goog.addDependency(
    'ui/emoji/progressiveemojipaletterenderer.js',
    ['goog.ui.emoji.ProgressiveEmojiPaletteRenderer'],
    ['goog.dom.TagName', 'goog.style', 'goog.ui.emoji.EmojiPaletteRenderer'],
    false,
);
goog.addDependency(
    'ui/emoji/spriteinfo.js',
    ['goog.ui.emoji.SpriteInfo'],
    [],
    false,
);
goog.addDependency(
    'ui/emoji/spriteinfo_test.js',
    ['goog.ui.emoji.SpriteInfoTest'],
    ['goog.testing.jsunit', 'goog.ui.emoji.SpriteInfo'],
    false,
);
goog.addDependency(
    'ui/filteredmenu.js',
...
goog.addDependency(
    'ui/filteredmenu_test.js',
    ['goog.ui.FilteredMenuTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.AutoCompleteValues',
        'goog.a11y.aria.State',
...
goog.addDependency(
    'ui/filterobservingmenuitemrenderer.js',
    ['goog.ui.FilterObservingMenuItemRenderer'],
    ['goog.ui.MenuItemRenderer'],
    false,
);
goog.addDependency(
    'ui/flatbuttonrenderer.js',
    ['goog.ui.FlatButtonRenderer'],
    [
        'goog.a11y.aria.Role',
        'goog.asserts',
...
goog.addDependency(
    'ui/gauge.js',
    ['goog.ui.Gauge', 'goog.ui.GaugeColoredRange'],
    [
        'goog.a11y.aria',
        'goog.asserts',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/hovercard_test.js',
    ['goog.ui.HoverCardTest'],
    [
        'goog.dom',
        'goog.events',
        'goog.math.Coordinate',
...
goog.addDependency(
    'ui/hsvapalette_test.js',
    ['goog.ui.HsvaPaletteTest'],
    [
        'goog.color.alpha',
        'goog.dom.TagName',
        'goog.dom.classlist',
...
goog.addDependency(
    'ui/hsvpalette_test.js',
    ['goog.ui.HsvPaletteTest'],
    [
        'goog.color',
        'goog.dom.TagName',
        'goog.dom.classlist',
...
goog.addDependency(
    'ui/idletimer_test.js',
    ['goog.ui.IdleTimerTest'],
    [
        'goog.events',
        'goog.testing.MockClock',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/iframemask_test.js',
    ['goog.ui.IframeMaskTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.dom.iframe',
...
goog.addDependency(
    'ui/imagelessmenubuttonrenderer.js',
...
goog.addDependency(
    'ui/inputdatepicker_test.js',
    ['goog.ui.InputDatePickerTest'],
    [
        'goog.dom',
        'goog.i18n.DateTimeFormat',
        'goog.i18n.DateTimeParse',
...
goog.addDependency(
    'ui/keyboardshortcuthandler_test.js',
    ['goog.ui.KeyboardShortcutHandlerTest'],
    [
        'goog.dom',
        'goog.events',
        'goog.events.BrowserEvent',
...
goog.addDependency(
    'ui/labelinput_test.js',
    ['goog.ui.LabelInputTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.State',
        'goog.dom',
...
goog.addDependency(
    'ui/linkbuttonrenderer.js',
    ['goog.ui.LinkButtonRenderer'],
    ['goog.ui.Button', 'goog.ui.FlatButtonRenderer', 'goog.ui.registry'],
    false,
);
goog.addDependency(
    'ui/media/flashobject.js',
    [
...
goog.addDependency(
    'ui/media/flashobject_test.js',
    ['goog.ui.media.FlashObjectTest'],
    [
        'goog.dom',
        'goog.dom.DomHelper',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/media/flickr.js',
    ['goog.ui.media.FlickrSet', 'goog.ui.media.FlickrSetModel'],
    [
        'goog.html.TrustedResourceUrl',
        'goog.string.Const',
        'goog.ui.media.FlashObject',
...
goog.addDependency(
    'ui/media/flickr_test.js',
    ['goog.ui.media.FlickrSetTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.html.testing',
...
goog.addDependency(
    'ui/media/googlevideo.js',
    ['goog.ui.media.GoogleVideo', 'goog.ui.media.GoogleVideoModel'],
    [
        'goog.string',
        'goog.ui.media.FlashObject',
        'goog.ui.media.Media',
...
goog.addDependency(
    'ui/media/googlevideo_test.js',
    ['goog.ui.media.GoogleVideoTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/media/media_test.js',
    ['goog.ui.media.MediaTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.math.Size',
...
goog.addDependency(
    'ui/media/mediamodel_test.js',
    ['goog.ui.media.MediaModelTest'],
    ['goog.testing.jsunit', 'goog.ui.media.MediaModel'],
    false,
);
goog.addDependency(
    'ui/media/mp3.js',
...
goog.addDependency(
    'ui/media/mp3_test.js',
    ['goog.ui.media.Mp3Test'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/media/photo.js',
    ['goog.ui.media.Photo'],
    ['goog.dom.TagName', 'goog.ui.media.Media', 'goog.ui.media.MediaRenderer'],
    false,
);
goog.addDependency(
    'ui/media/photo_test.js',
    ['goog.ui.media.PhotoTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/media/picasa.js',
    ['goog.ui.media.PicasaAlbum', 'goog.ui.media.PicasaAlbumModel'],
    [
        'goog.html.TrustedResourceUrl',
        'goog.string.Const',
        'goog.ui.media.FlashObject',
...
goog.addDependency(
    'ui/media/picasa_test.js',
    ['goog.ui.media.PicasaTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/media/vimeo.js',
    ['goog.ui.media.Vimeo', 'goog.ui.media.VimeoModel'],
    [
        'goog.string',
        'goog.ui.media.FlashObject',
        'goog.ui.media.Media',
...
goog.addDependency(
    'ui/media/vimeo_test.js',
    ['goog.ui.media.VimeoTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/media/youtube.js',
    ['goog.ui.media.Youtube', 'goog.ui.media.YoutubeModel'],
    [
        'goog.dom.TagName',
        'goog.string',
        'goog.ui.Component',
...
goog.addDependency(
    'ui/media/youtube_test.js',
    ['goog.ui.media.YoutubeTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/menu.js',
    ['goog.ui.Menu', 'goog.ui.Menu.EventType'],
    [
        'goog.dom.TagName',
        'goog.math.Coordinate',
        'goog.string',
...
goog.addDependency(
    'ui/menubar.js',
    ['goog.ui.menuBar'],
    ['goog.ui.Container', 'goog.ui.MenuBarRenderer'],
    false,
);
goog.addDependency(
    'ui/menubardecorator.js',
    ['goog.ui.menuBarDecorator'],
    ['goog.ui.MenuBarRenderer', 'goog.ui.menuBar', 'goog.ui.registry'],
    false,
);
goog.addDependency(
    'ui/menubarrenderer.js',
    ['goog.ui.MenuBarRenderer'],
    ['goog.a11y.aria.Role', 'goog.ui.Container', 'goog.ui.ContainerRenderer'],
    false,
);
goog.addDependency(
    'ui/menubase.js',
...
goog.addDependency(
    'ui/menubutton_test.js',
    ['goog.ui.MenuButtonTest'],
    [
        'goog.Timer',
        'goog.a11y.aria',
        'goog.a11y.aria.State',
...
goog.addDependency(
    'ui/menubuttonrenderer_test.js',
    ['goog.ui.MenuButtonRendererTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.State',
        'goog.dom',
...
goog.addDependency(
    'ui/menuitemrenderer_test.js',
    ['goog.ui.MenuItemRendererTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.a11y.aria.State',
...
goog.addDependency(
    'ui/menuseparator.js',
    ['goog.ui.MenuSeparator'],
    ['goog.ui.MenuSeparatorRenderer', 'goog.ui.Separator', 'goog.ui.registry'],
    false,
);
goog.addDependency(
...
goog.addDependency(
    'ui/menuseparatorrenderer_test.js',
    ['goog.ui.MenuSeparatorRendererTest'],
    [
        'goog.dom',
        'goog.testing.jsunit',
        'goog.ui.MenuSeparator',
...
goog.addDependency(
    'ui/mockactivitymonitor.js',
    ['goog.ui.MockActivityMonitor'],
    ['goog.events.EventType', 'goog.ui.ActivityMonitor'],
    false,
);
goog.addDependency(
    'ui/mockactivitymonitor_test.js',
...
goog.addDependency(
    ...
    ['goog.a11y.aria', 'goog.a11y.aria.State'],
    false,
);
goog.addDependency(
    'ui/modalariavisibilityhelper_test.js',
    ['goog.ui.ModalAriaVisibilityHelperTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.State',
        'goog.dom',
...
goog.addDependency(
    'ui/modalpopup_test.js',
    ['goog.ui.ModalPopupTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.State',
        'goog.dispose',
...
goog.addDependency(
    'ui/nativebuttonrenderer_test.js',
    ['goog.ui.NativeButtonRendererTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.dom.classlist',
...
goog.addDependency(
    'ui/option.js',
    ['goog.ui.Option'],
    ['goog.ui.Component', 'goog.ui.MenuItem', 'goog.ui.registry'],
    false,
);
goog.addDependency(
    'ui/palette.js',
...
goog.addDependency(
    'ui/paletterenderer_test.js',
    ['goog.ui.PaletteRendererTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.a11y.aria.State',
...
goog.addDependency(
    'ui/plaintextspellchecker_test.js',
    ['goog.ui.PlainTextSpellCheckerTest'],
    [
        'goog.Timer',
        'goog.dom',
        'goog.events.KeyCodes',
...
goog.addDependency(
    'ui/popupbase_test.js',
    ['goog.ui.PopupBaseTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.events',
...
goog.addDependency(
    'ui/popupcolorpicker_test.js',
    ['goog.ui.PopupColorPickerTest'],
    [
        'goog.dom',
        'goog.events',
        'goog.testing.events',
...
goog.addDependency(
    'ui/popupdatepicker_test.js',
    ['goog.ui.PopupDatePickerTest'],
    [
        'goog.date.Date',
        'goog.events',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/popupmenu_test.js',
    ['goog.ui.PopupMenuTest'],
    [
        'goog.dom',
        'goog.events.EventHandler',
        'goog.events.EventType',
...
goog.addDependency(
    'ui/progressbar.js',
    ['goog.ui.ProgressBar', 'goog.ui.ProgressBar.Orientation'],
    [
        'goog.a11y.aria',
        'goog.asserts',
        'goog.dom',
...
goog.addDependency(
    'ui/rangemodel.js',
    ['goog.ui.RangeModel'],
    ['goog.events.EventTarget', 'goog.ui.Component'],
    false,
);
goog.addDependency(
    'ui/rangemodel_test.js',
    ['goog.ui.RangeModelTest'],
    ['goog.testing.jsunit', 'goog.ui.RangeModel'],
    false,
);
goog.addDependency(
    'ui/ratings.js',
    ['goog.ui.Ratings', 'goog.ui.Ratings.EventType'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.a11y.aria.State',
...
goog.addDependency(
    'ui/registry.js',
    ['goog.ui.registry'],
    ['goog.asserts', 'goog.dom.classlist'],
    false,
);
goog.addDependency(
    'ui/registry_test.js',
    ['goog.ui.registryTest'],
    ['goog.object', 'goog.testing.jsunit', 'goog.ui.registry'],
    false,
);
goog.addDependency(
    'ui/richtextspellchecker.js',
...
goog.addDependency(
    'ui/richtextspellchecker_test.js',
    ['goog.ui.RichTextSpellCheckerTest'],
    [
        'goog.dom.Range',
        'goog.dom.TagName',
        'goog.dom.classlist',
...
goog.addDependency(
    'ui/roundedpanel_test.js',
    ['goog.ui.RoundedPanelTest'],
    [
        'goog.testing.jsunit',
        'goog.ui.CssRoundedPanel',
        'goog.ui.GraphicsRoundedPanel',
...
goog.addDependency(
    'ui/scrollfloater.js',
    ['goog.ui.ScrollFloater', 'goog.ui.ScrollFloater.EventType'],
    [
        'goog.array',
        'goog.asserts',
        'goog.dom',
...
goog.addDependency(
    'ui/scrollfloater_test.js',
    ['goog.ui.ScrollFloaterTest'],
    [
        'goog.dom',
        'goog.events',
        'goog.style',
...
goog.addDependency(
    'ui/selectionmenubutton_test.js',
    ['goog.ui.SelectionMenuButtonTest'],
    [
        'goog.dom',
        'goog.events',
        'goog.testing.events',
...
goog.addDependency(
    ...
    ['goog.ui.SelectionModel'],
    ['goog.array', 'goog.events.EventTarget', 'goog.events.EventType'],
    false,
);
goog.addDependency(
    'ui/selectionmodel_test.js',
    ['goog.ui.SelectionModelTest'],
    [
        'goog.array',
        'goog.testing.jsunit',
        'goog.testing.recordFunction',
...
goog.addDependency(
    'ui/serverchart_test.js',
    ['goog.ui.ServerChartTest'],
    ['goog.Uri', 'goog.events', 'goog.testing.jsunit', 'goog.ui.ServerChart'],
    false,
);
goog.addDependency(
    'ui/slider.js',
    ['goog.ui.Slider', 'goog.ui.Slider.Orientation'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.dom',
...
goog.addDependency(
    'ui/sliderbase_test.js',
    ['goog.ui.SliderBaseTest'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.State',
        'goog.dom',
...
goog.addDependency(
    'ui/splitbehavior.js',
    ['goog.ui.SplitBehavior', 'goog.ui.SplitBehavior.DefaultHandlers'],
    [
        'goog.Disposable',
        'goog.asserts',
        'goog.dispose',
...
goog.addDependency(
    'ui/splitbehavior_test.js',
    ['goog.ui.SplitBehaviorTest'],
    [
        'goog.array',
        'goog.dom',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/splitpane.js',
    ['goog.ui.SplitPane', 'goog.ui.SplitPane.Orientation'],
    [
        'goog.asserts',
        'goog.dom',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/splitpane_test.js',
    ['goog.ui.SplitPaneTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.dom.classlist',
...
goog.addDependency(
    'ui/style/app/buttonrenderer.js',
...
goog.addDependency(
    'ui/style/app/buttonrenderer_test.js',
    ['goog.ui.style.app.ButtonRendererTest'],
    [
        'goog.dom',
        'goog.testing.jsunit',
        'goog.testing.ui.style',
...
goog.addDependency(
    'ui/style/app/menubuttonrenderer.js',
...
goog.addDependency(
    'ui/style/app/menubuttonrenderer_test.js',
    ['goog.ui.style.app.MenuButtonRendererTest'],
    [
        'goog.dom',
        'goog.testing.jsunit',
        'goog.testing.ui.style',
...
goog.addDependency(
    'ui/style/app/primaryactionbuttonrenderer.js',
    ['goog.ui.style.app.PrimaryActionButtonRenderer'],
    ['goog.ui.Button', 'goog.ui.registry', 'goog.ui.style.app.ButtonRenderer'],
    false,
);
goog.addDependency(
    'ui/style/app/primaryactionbuttonrenderer_test.js',
    ['goog.ui.style.app.PrimaryActionButtonRendererTest'],
    [
        'goog.dom',
        'goog.testing.jsunit',
        'goog.testing.ui.style',
...
goog.addDependency(
    'ui/tabbar.js',
    ['goog.ui.TabBar', 'goog.ui.TabBar.Location'],
    [
        'goog.ui.Component.EventType',
        'goog.ui.Container',
        'goog.ui.Container.Orientation',
...
goog.addDependency(
    'ui/tabbarrenderer.js',
    ['goog.ui.TabBarRenderer'],
    ['goog.a11y.aria.Role', 'goog.object', 'goog.ui.ContainerRenderer'],
    false,
);
goog.addDependency(
    'ui/tabbarrenderer_test.js',
    ['goog.ui.TabBarRendererTest'],
    [
        'goog.a11y.aria.Role',
        'goog.dom',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/tablesorter.js',
    ['goog.ui.TableSorter', 'goog.ui.TableSorter.EventType'],
    [
        'goog.array',
        'goog.dom',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/tablesorter_test.js',
    ['goog.ui.TableSorterTest'],
    [
        'goog.array',
        'goog.dom',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/tabpane_test.js',
    ['goog.ui.TabPaneTest'],
    ['goog.dom', 'goog.testing.jsunit', 'goog.ui.TabPane'],
    false,
);
goog.addDependency(
    'ui/tabrenderer.js',
    ['goog.ui.TabRenderer'],
    ['goog.a11y.aria.Role', 'goog.ui.Component', 'goog.ui.ControlRenderer'],
    false,
);
goog.addDependency(
    'ui/tabrenderer_test.js',
    ['goog.ui.TabRendererTest'],
    [
        'goog.a11y.aria.Role',
        'goog.dom',
        'goog.dom.classlist',
...
goog.addDependency(
    'ui/textarea.js',
    ['goog.ui.Textarea', 'goog.ui.Textarea.EventType'],
    [
        'goog.asserts',
        'goog.dom',
        'goog.dom.classlist',
...
goog.addDependency(
    'ui/textarearenderer.js',
    ['goog.ui.TextareaRenderer'],
    ['goog.dom.TagName', 'goog.ui.Component', 'goog.ui.ControlRenderer'],
    false,
);
goog.addDependency(
    'ui/togglebutton.js',
...
goog.addDependency(
    'ui/toolbar.js',
    ['goog.ui.Toolbar'],
    ['goog.ui.Container', 'goog.ui.ToolbarRenderer'],
    false,
);
goog.addDependency(
    'ui/toolbar_test.js',
...
goog.addDependency(
    'ui/toolbarbutton.js',
    ['goog.ui.ToolbarButton'],
    ['goog.ui.Button', 'goog.ui.ToolbarButtonRenderer', 'goog.ui.registry'],
    false,
);
goog.addDependency(
    'ui/toolbarbuttonrenderer.js',
    ['goog.ui.ToolbarButtonRenderer'],
    ['goog.ui.CustomButtonRenderer'],
    false,
);
goog.addDependency(
    'ui/toolbarcolormenubutton.js',
    ['goog.ui.ToolbarColorMenuButton'],
    [
        'goog.ui.ColorMenuButton',
...
goog.addDependency(
    'ui/toolbarcolormenubuttonrenderer.js',
    ['goog.ui.ToolbarColorMenuButtonRenderer'],
    [
        'goog.asserts',
        'goog.dom.classlist',
...
goog.addDependency(
    'ui/toolbarcolormenubuttonrenderer_test.js',
    ['goog.ui.ToolbarColorMenuButtonRendererTest'],
    [
        'goog.dom',
        'goog.testing.jsunit',
        'goog.testing.ui.RendererHarness',
...
goog.addDependency(
    'ui/toolbarmenubuttonrenderer.js',
    ['goog.ui.ToolbarMenuButtonRenderer'],
    ['goog.ui.MenuButtonRenderer'],
    false,
);
goog.addDependency(
    'ui/toolbarrenderer.js',
    ['goog.ui.ToolbarRenderer'],
    [
        'goog.a11y.aria.Role',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/toolbarseparatorrenderer.js',
    ['goog.ui.ToolbarSeparatorRenderer'],
    [
        'goog.asserts',
        'goog.dom.TagName',
...
goog.addDependency(
    'ui/toolbarseparatorrenderer_test.js',
    ['goog.ui.ToolbarSeparatorRendererTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.dom.classlist',
...
goog.addDependency(
    'ui/tree/basenode.js',
    ['goog.ui.tree.BaseNode', 'goog.ui.tree.BaseNode.EventType'],
    [
        'goog.Timer',
        'goog.a11y.aria',
        'goog.asserts',
...
goog.addDependency(
    'ui/tree/basenode_test.js',
    ['goog.ui.tree.BaseNodeTest'],
    [
        'goog.dom',
        'goog.dom.TagName',
        'goog.dom.classlist',
...
goog.addDependency(
    'ui/tree/treecontrol_test.js',
    ['goog.ui.tree.TreeControlTest'],
    ['goog.dom', 'goog.testing.jsunit', 'goog.ui.tree.TreeControl'],
    false,
);
goog.addDependency(
    'ui/tree/treenode.js',
...
goog.addDependency(
    ...
    ['goog.ui.tree.TypeAhead', 'goog.ui.tree.TypeAhead.Offset'],
    ['goog.array', 'goog.events.KeyCodes', 'goog.string', 'goog.structs.Trie'],
    false,
);
goog.addDependency(
    'ui/tree/typeahead_test.js',
    ['goog.ui.tree.TypeAheadTest'],
    [
        'goog.dom',
        'goog.events.KeyCodes',
        'goog.testing.jsunit',
...
goog.addDependency(
    'ui/tristatemenuitem.js',
    ['goog.ui.TriStateMenuItem', 'goog.ui.TriStateMenuItem.State'],
    [
        'goog.dom.classlist',
        'goog.ui.Component',
        'goog.ui.MenuItem',
...
goog.addDependency(
    'ui/tristatemenuitemrenderer.js',
    ['goog.ui.TriStateMenuItemRenderer'],
    ['goog.asserts', 'goog.dom.classlist', 'goog.ui.MenuItemRenderer'],
    false,
);
goog.addDependency(
    'ui/twothumbslider.js',
...
goog.addDependency(
    'ui/twothumbslider_test.js',
    ['goog.ui.TwoThumbSliderTest'],
    ['goog.testing.jsunit', 'goog.ui.SliderBase', 'goog.ui.TwoThumbSlider'],
    false,
);
goog.addDependency(
    'ui/zippy.js',
    ['goog.ui.Zippy', 'goog.ui.Zippy.Events', 'goog.ui.ZippyEvent'],
    [
        'goog.a11y.aria',
        'goog.a11y.aria.Role',
        'goog.a11y.aria.State',
...
goog.addDependency(
    'useragent/adobereader.js',
    ['goog.userAgent.adobeReader'],
    ['goog.string', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'useragent/adobereader_test.js',
    ['goog.userAgent.adobeReaderTest'],
    ['goog.testing.jsunit', 'goog.userAgent.adobeReader'],
    false,
);
goog.addDependency(
    'useragent/flash.js',
...
goog.addDependency(
    'useragent/flash_test.js',
    ['goog.userAgent.flashTest'],
    ['goog.testing.jsunit', 'goog.userAgent.flash'],
    false,
);
goog.addDependency(
    'useragent/iphoto.js',
...
goog.addDependency(
    'useragent/jscript_test.js',
    ['goog.userAgent.jscriptTest'],
    ['goog.testing.jsunit', 'goog.userAgent.jscript'],
    false,
);
goog.addDependency(
    'useragent/keyboard.js',
    ['goog.userAgent.keyboard'],
    ['goog.labs.userAgent.platform'],
    false,
);
goog.addDependency(
    'useragent/keyboard_test.js',
...
goog.addDependency(
    'useragent/useragent_quirks_test.js',
    ['goog.userAgentQuirksTest'],
    ['goog.testing.jsunit', 'goog.userAgent'],
    false,
);
goog.addDependency(
    'useragent/useragent_test.js',
    ['goog.userAgentTest'],
    [
        'goog.array',
        'goog.labs.userAgent.platform',
...
goog.addDependency(
    ...
    ['goog.userAgentTestUtil', 'goog.userAgentTestUtil.UserAgents'],
    [
        'goog.labs.userAgent.browser',
        'goog.labs.userAgent.engine',
        'goog.labs.userAgent.platform',
...
goog.addDependency(
    'vec/mat3d.js',
    ['goog.vec.mat3d', 'goog.vec.mat3d.Type'],
    ['goog.vec'],
    false,
);
goog.addDependency(
    'vec/mat3f.js',
    ['goog.vec.mat3f', 'goog.vec.mat3f.Type'],
    ['goog.vec'],
    false,
);
goog.addDependency(
    'vec/mat4.js',
    ['goog.vec.Mat4'],
    ['goog.vec', 'goog.vec.Vec3', 'goog.vec.Vec4'],
    false,
);
goog.addDependency(
    'vec/mat4d.js',
    ['goog.vec.mat4d', 'goog.vec.mat4d.Type'],
    ['goog.vec', 'goog.vec.vec3d', 'goog.vec.vec4d'],
    false,
);
goog.addDependency(
    'vec/mat4f.js',
    ['goog.vec.mat4f', 'goog.vec.mat4f.Type'],
    ['goog.vec', 'goog.vec.vec3f', 'goog.vec.vec4f'],
    false,
);
...
goog.addDependency(
    ...
    ['goog.vec.Float32Array', 'goog.vec.Float64Array'],
    false,
);
goog.addDependency('vec/vec2.js', ['goog.vec.Vec2'], ['goog.vec'], false);
goog.addDependency(
    'vec/vec2d.js',
    ['goog.vec.vec2d', 'goog.vec.vec2d.Type'],
    ['goog.vec'],
    false,
);
goog.addDependency(
    'vec/vec2f.js',
    ['goog.vec.vec2f', 'goog.vec.vec2f.Type'],
    ['goog.vec'],
    false,
);
...
goog.addDependency(
    'vec/vec3d.js',
    ['goog.vec.vec3d', 'goog.vec.vec3d.Type'],
    ['goog.vec'],
    false,
);
goog.addDependency(
    'vec/vec3f.js',
    ['goog.vec.vec3f', 'goog.vec.vec3f.Type'],
    ['goog.vec'],
    false,
);
...
goog.addDependency(
    'vec/vec4d.js',
    ['goog.vec.vec4d', 'goog.vec.vec4d.Type'],
    ['goog.vec'],
    false,
);
goog.addDependency(
    'vec/vec4f.js',
    ['goog.vec.vec4f', 'goog.vec.vec4f.Type'],
    ['goog.vec'],
    false,
);
